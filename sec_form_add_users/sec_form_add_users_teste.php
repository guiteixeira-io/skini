<?php  
  ...
  session_start() ;
  class sec_form_add_users_form_teste
  {
   function sec_form_add_users_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_form_add_users/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_form_add_users</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sec_form_add_users"> 
</form> 
...
<?php
  ...
  $frm_teste = new sec_form_add_users_form_teste();
  $frm_teste->sec_form_add_users_teste();
?>
