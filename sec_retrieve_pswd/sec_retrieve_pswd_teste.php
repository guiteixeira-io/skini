<?php  
  ...
  session_start() ;
  class sec_retrieve_pswd_form_teste
  {
   function sec_retrieve_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_retrieve_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_retrieve_pswd</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sec_retrieve_pswd"> 
</form> 
...
<?php
  ...
  $frm_teste = new sec_retrieve_pswd_form_teste();
  $frm_teste->sec_retrieve_pswd_teste();
?>
