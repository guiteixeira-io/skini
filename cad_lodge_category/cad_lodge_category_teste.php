<?php  
  ...
  session_start() ;
  class cad_lodge_category_form_teste
  {
   function cad_lodge_category_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cad_lodge_category/img";
...
?> 
<br> 
<B><FONT SIZE="4">cad_lodge_category</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cad_lodge_category"> 
</form> 
...
<?php
  ...
  $frm_teste = new cad_lodge_category_form_teste();
  $frm_teste->cad_lodge_category_teste();
?>
