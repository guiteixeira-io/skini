  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cad_lodge_category" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_cad_lodge_category_form();
	}
...
?>
  ...
  function do_ajax_cad_lodge_category_validate_name()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_validate_name(var_name, var_script_case_init, do_ajax_cad_lodge_category_validate_name_cb);
  } // do_ajax_cad_lodge_category_validate_name

  function do_ajax_cad_lodge_category_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_validate_name_cb

  // ---------- Validate capacity
  function do_ajax_cad_lodge_category_validate_capacity()
  {
    var nomeCampo_capacity = "capacity";
    var var_capacity = scAjaxGetFieldText(nomeCampo_capacity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_validate_capacity(var_capacity, var_script_case_init, do_ajax_cad_lodge_category_validate_capacity_cb);
  } // do_ajax_cad_lodge_category_validate_capacity

  function do_ajax_cad_lodge_category_validate_capacity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_validate_capacity_cb

  // ---------- Validate color
  function do_ajax_cad_lodge_category_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldText(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_validate_color(var_color, var_script_case_init, do_ajax_cad_lodge_category_validate_color_cb);
  } // do_ajax_cad_lodge_category_validate_color

  function do_ajax_cad_lodge_category_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_validate_color_cb

  // ---------- Validate price
  function do_ajax_cad_lodge_category_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldText(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_validate_price(var_price, var_script_case_init, do_ajax_cad_lodge_category_validate_price_cb);
  } // do_ajax_cad_lodge_category_validate_price

  function do_ajax_cad_lodge_category_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "price";
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cad_lodge_category_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cad_lodge_category_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cad_lodge_category_submit_form_cb_after_alert);
  } // do_ajax_cad_lodge_category_submit_form_cb
  function do_ajax_cad_lodge_category_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cad_lodge_category_submit_form_cb_after_alert
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cad_lodge_category_navigate_form, function() {});
    } else {
      perform_ajax_cad_lodge_category_navigate_form();
    }
  }

  function perform_ajax_cad_lodge_category_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_lodge_category']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cad_lodge_category_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_sub_lodgePrice"] && "nmsc_iframe_liga_sub_lodgePrice" != scMasterDetailIframe["nmsc_iframe_liga_sub_lodgePrice"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_sub_lodgePrice"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_sub_lodgePrice').contentWindow.nm_move('apl_detalhe', true);
  ...
  } // do_ajax_cad_lodge_category_navigate_form_cb
  function do_ajax_cad_lodge_category_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cad_lodge_category_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cad_lodge_category_navigate_form_cb_after_alert

  function sc_hide_cad_lodge_category_form()
  {
