  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cad_lodge_category_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_cad_lodge_category_mob_form();
	}
...
?>
  ...
  // ---------- Validate name
  function do_ajax_cad_lodge_category_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_mob_validate_name(var_name, var_script_case_init, do_ajax_cad_lodge_category_mob_validate_name_cb);
  } // do_ajax_cad_lodge_category_mob_validate_name

  function do_ajax_cad_lodge_category_mob_validate_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_mob_validate_name_cb

  // ---------- Validate capacity
  function do_ajax_cad_lodge_category_mob_validate_capacity()
  {
    var nomeCampo_capacity = "capacity";
    var var_capacity = scAjaxGetFieldText(nomeCampo_capacity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_mob_validate_capacity(var_capacity, var_script_case_init, do_ajax_cad_lodge_category_mob_validate_capacity_cb);
  } // do_ajax_cad_lodge_category_mob_validate_capacity

  function do_ajax_cad_lodge_category_mob_validate_capacity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "capacity";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_mob_validate_capacity_cb

  // ---------- Validate color
  function do_ajax_cad_lodge_category_mob_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldText(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_mob_validate_color(var_color, var_script_case_init, do_ajax_cad_lodge_category_mob_validate_color_cb);
  } // do_ajax_cad_lodge_category_mob_validate_color

  function do_ajax_cad_lodge_category_mob_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_mob_validate_color_cb

  // ---------- Validate price
  function do_ajax_cad_lodge_category_mob_validate_price()
  {
    var nomeCampo_price = "price";
    var var_price = scAjaxGetFieldText(nomeCampo_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_mob_validate_price(var_price, var_script_case_init, do_ajax_cad_lodge_category_mob_validate_price_cb);
  } // do_ajax_cad_lodge_category_mob_validate_price

  function do_ajax_cad_lodge_category_mob_validate_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "price";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_mob_validate_price_cb

  // ---------- Validate lodge
  function do_ajax_cad_lodge_category_mob_validate_lodge()
  {
    var nomeCampo_lodge = "lodge";
    var var_lodge = scAjaxGetFieldText(nomeCampo_lodge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_category_mob_validate_lodge(var_lodge, var_script_case_init, do_ajax_cad_lodge_category_mob_validate_lodge_cb);
  } // do_ajax_cad_lodge_category_mob_validate_lodge

  function do_ajax_cad_lodge_category_mob_validate_lodge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lodge";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_mob_validate_lodge_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cad_lodge_category_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cad_lodge_category_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_idlodgecategory = scAjaxGetFieldText("idlodgecategory");
    ...
    scAjaxProcOn();
    x_ajax_cad_lodge_category_mob_submit_form(var_name, var_capacity, var_color, var_idlodgecategory, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_lodge_category_mob_submit_form_cb);
  } // do_ajax_cad_lodge_category_mob_submit_form

  function do_ajax_cad_lodge_category_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cad_lodge_category_mob_submit_form_cb_after_alert);
  } // do_ajax_cad_lodge_category_mob_submit_form_cb
  function do_ajax_cad_lodge_category_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cad_lodge_category_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["sub_lodgePrice_mob"] = "off";
  scStatusDetail["cad_lodge_mob"] = "off";

  function do_ajax_cad_lodge_category_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cad_lodge_category_mob_navigate_form, function() {});
    } else {
      perform_ajax_cad_lodge_category_mob_navigate_form();
    }
  }

  function perform_ajax_cad_lodge_category_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["sub_lodgePrice_mob"] = "on";
    scStatusDetail["cad_lodge_mob"] = "on";
    x_ajax_cad_lodge_category_mob_navigate_form(var_idlodgecategory, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cad_lodge_category_mob_navigate_form_cb);
  } // do_ajax_cad_lodge_category_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_lodge_category_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cad_lodge_category_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idlodgecategory.value = scAjaxGetKeyValue("idlodgecategory");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_sub_lodgePrice_mob"] && "nmsc_iframe_liga_sub_lodgePrice_mob" != scMasterDetailIframe["nmsc_iframe_liga_sub_lodgePrice_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_sub_lodgePrice_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_sub_lodgePrice_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_sub_lodgePrice_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_sub_lodgePrice_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_cad_lodge_mob"] && "nmsc_iframe_liga_cad_lodge_mob" != scMasterDetailIframe["nmsc_iframe_liga_cad_lodge_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_cad_lodge_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_cad_lodge_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_cad_lodge_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_cad_lodge_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cad_lodge_category_mob_navigate_form_cb_after_alert);
  } // do_ajax_cad_lodge_category_mob_navigate_form_cb
  function do_ajax_cad_lodge_category_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cad_lodge_category_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cad_lodge_category_mob_navigate_form_cb_after_alert

  function sc_hide_cad_lodge_category_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["sub_lodgePrice_mob"] && "off" == scStatusDetail["cad_lodge_mob"])
    {
      return true;
    }
    return false;
