...
?>
  ...
  function do_ajax_cad_lodge_category_mob_validate_idlodgecategory()
  {
    ...
    x_ajax_cad_lodge_category_mob_validate_idlodgecategory(var_idlodgecategory, var_script_case_init, do_ajax_cad_lodge_category_mob_validate_idlodgecategory_cb);
  } // do_ajax_cad_lodge_category_mob_validate_idlodgecategory

  function do_ajax_cad_lodge_category_mob_validate_idlodgecategory_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_category_mob_validate_idlodgecategory_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_cad_lodge_category_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_cad_lodge_category_mob_submit_form(var_idlodgecategory, var_name, var_capacity, var_color, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_lodge_category_mob_submit_form_cb);
...
?>
  ...
  {
    if ("off" == scStatusDetail["sub_lodgePrice_mob"])
    {
      return true;
    }
    return false;
