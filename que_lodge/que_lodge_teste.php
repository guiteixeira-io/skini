<?php  
  ...
  session_start() ;
  class que_lodge_form_teste
  {
  function que_lodge_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">que_lodge</FONT></B> 
<br> 
<br> 
...
<input type=submit value="que_lodge"> 
</form> 
...
<?php
  ...
  $frm_teste = new que_lodge_form_teste();
  $frm_teste->que_lodge_teste();
?>
