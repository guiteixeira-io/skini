<?php
@session_start() ;
$_SESSION['scriptcase']['que_lodge']['sc_process_barr'] = true;
require_once('../que_lodge/index.php');
unset($_SESSION['scriptcase']['que_lodge']['sc_process_barr']);
$ExportCtrl = new que_lodge_export_control;
$ExportCtrl->Export_barr();

class que_lodge_export_control
{
