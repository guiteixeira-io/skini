...
class que_lodge_res_xls
{
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['pivot_tabular'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge']['xls_res_sheet'] = $this->Xls_f;
      }
