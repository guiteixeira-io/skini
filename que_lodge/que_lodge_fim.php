...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____que_lodge"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____que_lodge"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cad_lodge'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['que_lodge']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['que_lodge']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['que_lodge']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['que_lodge']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['que_lodge']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['que_lodge']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['que_lodge']['embutida_filho'] as $ind => $sc_init)
          {
