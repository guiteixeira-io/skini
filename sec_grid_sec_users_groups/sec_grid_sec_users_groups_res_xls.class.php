...
class sec_grid_sec_users_groups_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['pivot_tabular'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users_groups']['xls_res_sheet'] = $this->Xls_f;
      }
