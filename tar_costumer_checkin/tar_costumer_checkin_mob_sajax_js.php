  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_tar_costumer_checkin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_tar_costumer_checkin_mob_form();
	}
...
?>
  ...
  // ---------- Validate idcostumer
  function do_ajax_tar_costumer_checkin_mob_validate_idcostumer()
  {
    var nomeCampo_idcostumer = "idcostumer";
    var var_idcostumer = scAjaxGetFieldHidden(nomeCampo_idcostumer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_idcostumer(var_idcostumer, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_idcostumer_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_idcostumer

  function do_ajax_tar_costumer_checkin_mob_validate_idcostumer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcostumer";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_idcostumer_cb

  // ---------- Validate docnumber
  function do_ajax_tar_costumer_checkin_mob_validate_docnumber()
  {
    var nomeCampo_docnumber = "docnumber";
    var var_docnumber = scAjaxGetFieldText(nomeCampo_docnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_docnumber(var_docnumber, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_docnumber_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_docnumber

  function do_ajax_tar_costumer_checkin_mob_validate_docnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "docnumber";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_docnumber_cb

  // ---------- Validate name
  function do_ajax_tar_costumer_checkin_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_name(var_name, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_name_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_name

  function do_ajax_tar_costumer_checkin_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_name_cb

  // ---------- Validate phonenumber
  function do_ajax_tar_costumer_checkin_mob_validate_phonenumber()
  {
    var nomeCampo_phonenumber = "phonenumber";
    var var_phonenumber = scAjaxGetFieldText(nomeCampo_phonenumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_phonenumber(var_phonenumber, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_phonenumber_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_phonenumber

  function do_ajax_tar_costumer_checkin_mob_validate_phonenumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phonenumber";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_phonenumber_cb

  // ---------- Validate zipcode
  function do_ajax_tar_costumer_checkin_mob_validate_zipcode()
  {
    var nomeCampo_zipcode = "zipcode";
    var var_zipcode = scAjaxGetFieldText(nomeCampo_zipcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_zipcode(var_zipcode, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_zipcode_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_zipcode

  function do_ajax_tar_costumer_checkin_mob_validate_zipcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_zipcode_cb

  // ---------- Validate zipstate
  function do_ajax_tar_costumer_checkin_mob_validate_zipstate()
  {
    var nomeCampo_zipstate = "zipstate";
    var var_zipstate = scAjaxGetFieldText(nomeCampo_zipstate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_zipstate(var_zipstate, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_zipstate_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_zipstate

  function do_ajax_tar_costumer_checkin_mob_validate_zipstate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipstate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_zipstate_cb

  // ---------- Validate zipcity
  function do_ajax_tar_costumer_checkin_mob_validate_zipcity()
  {
    var nomeCampo_zipcity = "zipcity";
    var var_zipcity = scAjaxGetFieldText(nomeCampo_zipcity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_zipcity(var_zipcity, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_zipcity_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_zipcity

  function do_ajax_tar_costumer_checkin_mob_validate_zipcity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcity";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_zipcity_cb

  // ---------- Validate zipdistrict
  function do_ajax_tar_costumer_checkin_mob_validate_zipdistrict()
  {
    var nomeCampo_zipdistrict = "zipdistrict";
    var var_zipdistrict = scAjaxGetFieldText(nomeCampo_zipdistrict);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_zipdistrict(var_zipdistrict, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_zipdistrict_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_zipdistrict

  function do_ajax_tar_costumer_checkin_mob_validate_zipdistrict_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipdistrict";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_zipdistrict_cb

  // ---------- Validate zipstreet
  function do_ajax_tar_costumer_checkin_mob_validate_zipstreet()
  {
    var nomeCampo_zipstreet = "zipstreet";
    var var_zipstreet = scAjaxGetFieldText(nomeCampo_zipstreet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_zipstreet(var_zipstreet, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_zipstreet_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_zipstreet

  function do_ajax_tar_costumer_checkin_mob_validate_zipstreet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipstreet";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_zipstreet_cb

  // ---------- Validate zipnumber
  function do_ajax_tar_costumer_checkin_mob_validate_zipnumber()
  {
    var nomeCampo_zipnumber = "zipnumber";
    var var_zipnumber = scAjaxGetFieldText(nomeCampo_zipnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_zipnumber(var_zipnumber, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_zipnumber_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_zipnumber

  function do_ajax_tar_costumer_checkin_mob_validate_zipnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipnumber";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_zipnumber_cb

  // ---------- Validate nationality
  function do_ajax_tar_costumer_checkin_mob_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldText(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_nationality(var_nationality, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_nationality_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_nationality

  function do_ajax_tar_costumer_checkin_mob_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_nationality_cb

  // ---------- Validate frequencytype
  function do_ajax_tar_costumer_checkin_mob_validate_frequencytype()
  {
    var nomeCampo_frequencytype = "frequencytype";
    var var_frequencytype = scAjaxGetFieldText(nomeCampo_frequencytype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_frequencytype(var_frequencytype, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_frequencytype_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_frequencytype

  function do_ajax_tar_costumer_checkin_mob_validate_frequencytype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_frequencytype_cb

  // ---------- Validate holdertype
  function do_ajax_tar_costumer_checkin_mob_validate_holdertype()
  {
    var nomeCampo_holdertype = "holdertype";
    var var_holdertype = scAjaxGetFieldText(nomeCampo_holdertype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_holdertype(var_holdertype, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_holdertype_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_holdertype

  function do_ajax_tar_costumer_checkin_mob_validate_holdertype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "holdertype";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_holdertype_cb

  // ---------- Validate idholder
  function do_ajax_tar_costumer_checkin_mob_validate_idholder()
  {
    var nomeCampo_idholder = "idholder";
    var var_idholder = scAjaxGetFieldText(nomeCampo_idholder);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_mob_validate_idholder(var_idholder, var_script_case_init, do_ajax_tar_costumer_checkin_mob_validate_idholder_cb);
  } // do_ajax_tar_costumer_checkin_mob_validate_idholder

  function do_ajax_tar_costumer_checkin_mob_validate_idholder_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idholder";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_mob_validate_idholder_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_tar_costumer_checkin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_tar_costumer_checkin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcostumer = scAjaxGetFieldHidden("idcostumer");
    ...
    var var_zipdistrict = scAjaxGetFieldText("zipdistrict");
    var var_zipstreet = scAjaxGetFieldText("zipstreet");
    var var_zipnumber = scAjaxGetFieldText("zipnumber");
    var var_nationality = scAjaxGetFieldText("nationality");
    var var_frequencytype = scAjaxGetFieldText("frequencytype");
    var var_holdertype = scAjaxGetFieldText("holdertype");
    var var_idholder = scAjaxGetFieldText("idholder");
    ...
    scAjaxProcOn();
    x_ajax_tar_costumer_checkin_mob_submit_form(var_idcostumer, var_docnumber, var_name, var_phonenumber, var_zipcode, var_zipstate, var_zipcity, var_zipdistrict, var_zipstreet, var_zipnumber, var_nationality, var_frequencytype, var_holdertype, var_idholder, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_tar_costumer_checkin_mob_submit_form_cb);
  } // do_ajax_tar_costumer_checkin_mob_submit_form

  function do_ajax_tar_costumer_checkin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_tar_costumer_checkin_mob_submit_form_cb_after_alert);
  } // do_ajax_tar_costumer_checkin_mob_submit_form_cb
  function do_ajax_tar_costumer_checkin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_tar_costumer_checkin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_tar_costumer_checkin_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_tar_costumer_checkin_mob_navigate_form, function() {});
    } else {
      perform_ajax_tar_costumer_checkin_mob_navigate_form();
    }
  }

  function perform_ajax_tar_costumer_checkin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_tar_costumer_checkin_mob_navigate_form(var_idcostumer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tar_costumer_checkin_mob_navigate_form_cb);
  } // do_ajax_tar_costumer_checkin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_tar_costumer_checkin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcostumer.value = scAjaxGetKeyValue("idcostumer");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_tar_costumer_checkin_mob_navigate_form_cb_after_alert);
  } // do_ajax_tar_costumer_checkin_mob_navigate_form_cb
  function do_ajax_tar_costumer_checkin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_tar_costumer_checkin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_tar_costumer_checkin_mob_navigate_form_cb_after_alert

  function sc_hide_tar_costumer_checkin_mob_form()
  {
  ...
  ajax_field_list[0] = "idcostumer";
  ajax_field_list[1] = "docnumber";
  ajax_field_list[2] = "name";
  ajax_field_list[3] = "phonenumber";
  ajax_field_list[4] = "zipcode";
  ajax_field_list[5] = "zipstate";
  ajax_field_list[6] = "zipcity";
  ajax_field_list[7] = "zipdistrict";
  ajax_field_list[8] = "zipstreet";
  ajax_field_list[9] = "zipnumber";
  ajax_field_list[10] = "nationality";
  ajax_field_list[11] = "frequencytype";
  ajax_field_list[12] = "holdertype";
  ajax_field_list[13] = "idholder";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idcostumer": {"label": "Id Costumer", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "docnumber": {"label": "Doc Number", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "name": {"label": "Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "phonenumber": {"label": "Phone Number", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "zipcode": {"label": "Zip Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "zipstate": {"label": "Zip State", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "zipcity": {"label": "Zip City", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "zipdistrict": {"label": "Zip District", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "zipstreet": {"label": "Zip Street", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "zipnumber": {"label": "Zip Number", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nationality": {"label": "Nationality", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "frequencytype": {"label": "Frequency Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "holdertype": {"label": "Holder Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "idholder": {"label": "Id Holder", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["idcostumer"][1] = "idcostumer";
  ...
  ajax_field_mult["idholder"][1] = "idholder";

  var ajax_field_id = {
    "idcostumer": new Array("hidden_field_label_idcostumer", "hidden_field_data_idcostumer"),
    ...
    "idholder": new Array("hidden_field_label_idholder", "hidden_field_data_idholder")
  };
