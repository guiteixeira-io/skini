  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_tar_costumer_checkin" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_tar_costumer_checkin_form();
	}
...
?>
  ...
  // ---------- Validate idcostumer
  function do_ajax_tar_costumer_checkin_validate_idcostumer()
  {
    var nomeCampo_idcostumer = "idcostumer";
    var var_idcostumer = scAjaxGetFieldHidden(nomeCampo_idcostumer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_idcostumer(var_idcostumer, var_script_case_init, do_ajax_tar_costumer_checkin_validate_idcostumer_cb);
  } // do_ajax_tar_costumer_checkin_validate_idcostumer

  function do_ajax_tar_costumer_checkin_validate_idcostumer_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_idcostumer_cb

  // ---------- Validate docnumber
  function do_ajax_tar_costumer_checkin_validate_docnumber()
  {
    var nomeCampo_docnumber = "docnumber";
    var var_docnumber = scAjaxGetFieldText(nomeCampo_docnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_docnumber(var_docnumber, var_script_case_init, do_ajax_tar_costumer_checkin_validate_docnumber_cb);
  } // do_ajax_tar_costumer_checkin_validate_docnumber

  function do_ajax_tar_costumer_checkin_validate_docnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_docnumber_cb

  // ---------- Validate name
  function do_ajax_tar_costumer_checkin_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_name(var_name, var_script_case_init, do_ajax_tar_costumer_checkin_validate_name_cb);
  } // do_ajax_tar_costumer_checkin_validate_name

  function do_ajax_tar_costumer_checkin_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_name_cb

  // ---------- Validate phonenumber
  function do_ajax_tar_costumer_checkin_validate_phonenumber()
  {
    var nomeCampo_phonenumber = "phonenumber";
    var var_phonenumber = scAjaxGetFieldText(nomeCampo_phonenumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_phonenumber(var_phonenumber, var_script_case_init, do_ajax_tar_costumer_checkin_validate_phonenumber_cb);
  } // do_ajax_tar_costumer_checkin_validate_phonenumber

  function do_ajax_tar_costumer_checkin_validate_phonenumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_phonenumber_cb

  // ---------- Validate zipcode
  function do_ajax_tar_costumer_checkin_validate_zipcode()
  {
    var nomeCampo_zipcode = "zipcode";
    var var_zipcode = scAjaxGetFieldText(nomeCampo_zipcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_zipcode(var_zipcode, var_script_case_init, do_ajax_tar_costumer_checkin_validate_zipcode_cb);
  } // do_ajax_tar_costumer_checkin_validate_zipcode

  function do_ajax_tar_costumer_checkin_validate_zipcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_zipcode_cb

  // ---------- Validate zipstate
  function do_ajax_tar_costumer_checkin_validate_zipstate()
  {
    var nomeCampo_zipstate = "zipstate";
    var var_zipstate = scAjaxGetFieldText(nomeCampo_zipstate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_zipstate(var_zipstate, var_script_case_init, do_ajax_tar_costumer_checkin_validate_zipstate_cb);
  } // do_ajax_tar_costumer_checkin_validate_zipstate

  function do_ajax_tar_costumer_checkin_validate_zipstate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_zipstate_cb

  // ---------- Validate zipcity
  function do_ajax_tar_costumer_checkin_validate_zipcity()
  {
    var nomeCampo_zipcity = "zipcity";
    var var_zipcity = scAjaxGetFieldText(nomeCampo_zipcity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_zipcity(var_zipcity, var_script_case_init, do_ajax_tar_costumer_checkin_validate_zipcity_cb);
  } // do_ajax_tar_costumer_checkin_validate_zipcity

  function do_ajax_tar_costumer_checkin_validate_zipcity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcity";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_zipcity_cb

  // ---------- Validate zipdistrict
  function do_ajax_tar_costumer_checkin_validate_zipdistrict()
  {
    var nomeCampo_zipdistrict = "zipdistrict";
    var var_zipdistrict = scAjaxGetFieldText(nomeCampo_zipdistrict);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_zipdistrict(var_zipdistrict, var_script_case_init, do_ajax_tar_costumer_checkin_validate_zipdistrict_cb);
  } // do_ajax_tar_costumer_checkin_validate_zipdistrict

  function do_ajax_tar_costumer_checkin_validate_zipdistrict_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_zipdistrict_cb

  // ---------- Validate zipstreet
  function do_ajax_tar_costumer_checkin_validate_zipstreet()
  {
    var nomeCampo_zipstreet = "zipstreet";
    var var_zipstreet = scAjaxGetFieldText(nomeCampo_zipstreet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_zipstreet(var_zipstreet, var_script_case_init, do_ajax_tar_costumer_checkin_validate_zipstreet_cb);
  } // do_ajax_tar_costumer_checkin_validate_zipstreet

  function do_ajax_tar_costumer_checkin_validate_zipstreet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_zipstreet_cb

  // ---------- Validate zipnumber
  function do_ajax_tar_costumer_checkin_validate_zipnumber()
  {
    var nomeCampo_zipnumber = "zipnumber";
    var var_zipnumber = scAjaxGetFieldText(nomeCampo_zipnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_zipnumber(var_zipnumber, var_script_case_init, do_ajax_tar_costumer_checkin_validate_zipnumber_cb);
  } // do_ajax_tar_costumer_checkin_validate_zipnumber

  function do_ajax_tar_costumer_checkin_validate_zipnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_zipnumber_cb

  // ---------- Validate nationality
  function do_ajax_tar_costumer_checkin_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldText(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_nationality(var_nationality, var_script_case_init, do_ajax_tar_costumer_checkin_validate_nationality_cb);
  } // do_ajax_tar_costumer_checkin_validate_nationality

  function do_ajax_tar_costumer_checkin_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_nationality_cb

  // ---------- Validate frequencytype
  function do_ajax_tar_costumer_checkin_validate_frequencytype()
  {
    var nomeCampo_frequencytype = "frequencytype";
    var var_frequencytype = scAjaxGetFieldText(nomeCampo_frequencytype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_frequencytype(var_frequencytype, var_script_case_init, do_ajax_tar_costumer_checkin_validate_frequencytype_cb);
  } // do_ajax_tar_costumer_checkin_validate_frequencytype

  function do_ajax_tar_costumer_checkin_validate_frequencytype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_frequencytype_cb

  // ---------- Validate holdertype
  function do_ajax_tar_costumer_checkin_validate_holdertype()
  {
    var nomeCampo_holdertype = "holdertype";
    var var_holdertype = scAjaxGetFieldText(nomeCampo_holdertype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_holdertype(var_holdertype, var_script_case_init, do_ajax_tar_costumer_checkin_validate_holdertype_cb);
  } // do_ajax_tar_costumer_checkin_validate_holdertype

  function do_ajax_tar_costumer_checkin_validate_holdertype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_holdertype_cb

  // ---------- Validate idholder
  function do_ajax_tar_costumer_checkin_validate_idholder()
  {
    var nomeCampo_idholder = "idholder";
    var var_idholder = scAjaxGetFieldText(nomeCampo_idholder);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tar_costumer_checkin_validate_idholder(var_idholder, var_script_case_init, do_ajax_tar_costumer_checkin_validate_idholder_cb);
  } // do_ajax_tar_costumer_checkin_validate_idholder

  function do_ajax_tar_costumer_checkin_validate_idholder_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tar_costumer_checkin_validate_idholder_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_tar_costumer_checkin_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_tar_costumer_checkin_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_tar_costumer_checkin_submit_form(var_idcostumer, var_docnumber, var_name, var_phonenumber, var_zipcode, var_zipstate, var_zipcity, var_zipdistrict, var_zipstreet, var_zipnumber, var_nationality, var_frequencytype, var_holdertype, var_idholder, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_tar_costumer_checkin_submit_form_cb);
  } // do_ajax_tar_costumer_checkin_submit_form

  function do_ajax_tar_costumer_checkin_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_tar_costumer_checkin_submit_form_cb_after_alert);
  } // do_ajax_tar_costumer_checkin_submit_form_cb
  function do_ajax_tar_costumer_checkin_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_tar_costumer_checkin_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_tar_costumer_checkin_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_tar_costumer_checkin_navigate_form, function() {});
    } else {
      perform_ajax_tar_costumer_checkin_navigate_form();
    }
  }

  function perform_ajax_tar_costumer_checkin_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_tar_costumer_checkin_navigate_form(var_idcostumer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tar_costumer_checkin_navigate_form_cb);
  } // do_ajax_tar_costumer_checkin_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_tar_costumer_checkin_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_tar_costumer_checkin_navigate_form_cb_after_alert);
  } // do_ajax_tar_costumer_checkin_navigate_form_cb
  function do_ajax_tar_costumer_checkin_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_tar_costumer_checkin_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_tar_costumer_checkin_navigate_form_cb_after_alert

  function sc_hide_tar_costumer_checkin_form()
  {
