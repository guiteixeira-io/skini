<?php  
  ...
  session_start() ;
  class tar_costumer_checkin_form_teste
  {
   function tar_costumer_checkin_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "tar_costumer_checkin/img";
...
?> 
<br> 
<B><FONT SIZE="4">tar_costumer_checkin</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="tar_costumer_checkin"> 
</form> 
...
<?php
  ...
  $frm_teste = new tar_costumer_checkin_form_teste();
  $frm_teste->tar_costumer_checkin_teste();
?>
