...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>tar_costumer_checkin/tar_costumer_checkin_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("tar_costumer_checkin_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('tar_costumer_checkin_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['link_info']['remove_border']) {
...
<?php
 include_once("tar_costumer_checkin_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['tar_costumer_checkin'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['tar_costumer_checkin'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R")
{
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['phonenumber'] = (isset($this->nm_new_label['phonenumber'])) ? $this->nm_new_label['phonenumber'] : 'Phone Number'; 
          $SC_Label_atu['zipcode'] = (isset($this->nm_new_label['zipcode'])) ? $this->nm_new_label['zipcode'] : 'Zip Code'; 
          $SC_Label_atu['zipstate'] = (isset($this->nm_new_label['zipstate'])) ? $this->nm_new_label['zipstate'] : 'Zip State'; 
          $SC_Label_atu['zipcity'] = (isset($this->nm_new_label['zipcity'])) ? $this->nm_new_label['zipcity'] : 'Zip City'; 
          $SC_Label_atu['zipdistrict'] = (isset($this->nm_new_label['zipdistrict'])) ? $this->nm_new_label['zipdistrict'] : 'Zip District'; 
          $SC_Label_atu['zipstreet'] = (isset($this->nm_new_label['zipstreet'])) ? $this->nm_new_label['zipstreet'] : 'Zip Street'; 
          $SC_Label_atu['zipnumber'] = (isset($this->nm_new_label['zipnumber'])) ? $this->nm_new_label['zipnumber'] : 'Zip Number'; 
          $SC_Label_atu['nationality'] = (isset($this->nm_new_label['nationality'])) ? $this->nm_new_label['nationality'] : 'Nationality'; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_docnumber_line" id="hidden_field_data_docnumber" style="<?php echo $sStyleHidden_docnumber; ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['phonenumber'] = "Phone Number";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_phonenumber_label" id="hidden_field_label_phonenumber" style="<?php echo $sStyleHidden_phonenumber; ?>"><span id="id_label_phonenumber"><?php echo $this->nm_new_label['phonenumber']; ?></span></TD>
    <TD class="scFormDataOdd css_phonenumber_line" id="hidden_field_data_phonenumber" style="<?php echo $sStyleHidden_phonenumber; ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['zipcode'] = "Zip Code";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zipcode_label" id="hidden_field_label_zipcode" style="<?php echo $sStyleHidden_zipcode; ?>"><span id="id_label_zipcode"><?php echo $this->nm_new_label['zipcode']; ?></span></TD>
    <TD class="scFormDataOdd css_zipcode_line" id="hidden_field_data_zipcode" style="<?php echo $sStyleHidden_zipcode; ?>">
...
<span id="id_read_on_zipcode" class="sc-ui-readonly-zipcode css_zipcode_line" style="<?php echo $sStyleReadLab_zipcode; ?>"><?php echo $this->form_format_readonly("zipcode", $this->form_encode_input($this->zipcode)); ?></span><span id="id_read_off_zipcode" class="css_read_off_zipcode<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_zipcode; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['zipcode']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['zipcode']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['zipcode']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['zipstate'] = "Zip State";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zipstate_label" id="hidden_field_label_zipstate" style="<?php echo $sStyleHidden_zipstate; ?>"><span id="id_label_zipstate"><?php echo $this->nm_new_label['zipstate']; ?></span></TD>
    <TD class="scFormDataOdd css_zipstate_line" id="hidden_field_data_zipstate" style="<?php echo $sStyleHidden_zipstate; ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['zipcity'] = "Zip City";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zipcity_label" id="hidden_field_label_zipcity" style="<?php echo $sStyleHidden_zipcity; ?>"><span id="id_label_zipcity"><?php echo $this->nm_new_label['zipcity']; ?></span></TD>
    <TD class="scFormDataOdd css_zipcity_line" id="hidden_field_data_zipcity" style="<?php echo $sStyleHidden_zipcity; ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['zipdistrict'] = "Zip District";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zipdistrict_label" id="hidden_field_label_zipdistrict" style="<?php echo $sStyleHidden_zipdistrict; ?>"><span id="id_label_zipdistrict"><?php echo $this->nm_new_label['zipdistrict']; ?></span></TD>
    <TD class="scFormDataOdd css_zipdistrict_line" id="hidden_field_data_zipdistrict" style="<?php echo $sStyleHidden_zipdistrict; ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['zipstreet'] = "Zip Street";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zipstreet_label" id="hidden_field_label_zipstreet" style="<?php echo $sStyleHidden_zipstreet; ?>"><span id="id_label_zipstreet"><?php echo $this->nm_new_label['zipstreet']; ?></span></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['zipnumber'] = "Zip Number";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zipnumber_label" id="hidden_field_label_zipnumber" style="<?php echo $sStyleHidden_zipnumber; ?>"><span id="id_label_zipnumber"><?php echo $this->nm_new_label['zipnumber']; ?></span></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['nationality'] = "Nationality";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nationality_line" id="hidden_field_data_nationality" style="<?php echo $sStyleHidden_nationality; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_frequencytype_line" id="hidden_field_data_frequencytype" style="<?php echo $sStyleHidden_frequencytype; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_holdertype_line" id="hidden_field_data_holdertype" style="<?php echo $sStyleHidden_holdertype; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idholder_line" id="hidden_field_data_idholder" style="<?php echo $sStyleHidden_idholder; ?>">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("tar_costumer_checkin");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("tar_costumer_checkin");
 parent.scAjaxDetailHeight("tar_costumer_checkin", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['tar_costumer_checkin']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
