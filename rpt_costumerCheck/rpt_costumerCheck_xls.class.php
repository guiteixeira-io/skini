...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "rpt_costumerCheck/rpt_costumerCheck_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "rpt_costumerCheck_res_xls.class.php");
              $this->Res_xls = new rpt_costumerCheck_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_rpt_costumerCheck.zip";
          $this->Arquivo   .= "_rpt_costumerCheck" . $this->Xls_tp;
          $this->Tit_doc    = "rpt_costumerCheck" . $this->Xls_tp;
          $this->Tit_zip    = "rpt_costumerCheck.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_b_datetime()
   {
      ...
      if (!empty($this->b_datetime))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->b_datetime, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->b_datetime, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- b_idlodge
   function NM_export_b_idlodge()
   {
         ...
         if (is_numeric($this->look_b_idlodge))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_b_idlodge);
         $this->Xls_col++;
   }
   //----- a_docnumber
   function NM_export_a_docnumber()
   {
      ...
      if (!empty($this->a_docnumber))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_docnumber, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_docnumber, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- a_name
   function NM_export_a_name()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_name, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_name, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- a_phonenumber
   function NM_export_a_phonenumber()
   {
      ...
      if (!empty($this->a_phonenumber))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_phonenumber, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_phonenumber, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- a_mobilephone
   function NM_export_a_mobilephone()
   {
      ...
      if (!empty($this->a_mobilephone))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_mobilephone, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->a_mobilephone, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- b_datetime
   function NM_sub_cons_b_datetime()
   {
      if (!empty($this->b_datetime))
      {
         if (substr($this->b_datetime, 10, 1) == "-") 
         ...
         $this->b_datetime = NM_charset_to_utf8($this->b_datetime);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->b_datetime;
   ...
   //----- b_idlodge
   function NM_sub_cons_b_idlodge()
   {
         $this->look_b_idlodge = NM_charset_to_utf8($this->look_b_idlodge);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_b_idlodge;
   ...
   //----- a_docnumber
   function NM_sub_cons_a_docnumber()
   {
      if (!empty($this->a_docnumber))
      {
         if (strlen($conteudo) < 11) 
         ...
         $this->a_docnumber = NM_charset_to_utf8($this->a_docnumber);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->a_docnumber;
   ...
   //----- a_name
   function NM_sub_cons_a_name()
   {
         $this->a_name = html_entity_decode($this->a_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->a_name = strip_tags($this->a_name);
         $this->a_name = NM_charset_to_utf8($this->a_name);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->a_name;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- a_phonenumber
   function NM_sub_cons_a_phonenumber()
   {
      if (!empty($this->a_phonenumber))
      {
         $conteudo = str_replace($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['decimal_db'], "", $conteudo); 
         ...
         $this->a_phonenumber = NM_charset_to_utf8($this->a_phonenumber);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->a_phonenumber;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- a_mobilephone
   function NM_sub_cons_a_mobilephone()
   {
      if (!empty($this->a_mobilephone))
      {
         $conteudo = str_replace($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['decimal_db'], "", $conteudo); 
         ...
         $this->a_mobilephone = NM_charset_to_utf8($this->a_mobilephone);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->a_mobilephone;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> mov_costumer_check :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
