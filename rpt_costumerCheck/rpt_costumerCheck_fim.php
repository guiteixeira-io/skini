...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____rpt_costumerCheck"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____rpt_costumerCheck"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['rpt_costumerCheck']['embutida_filho'] as $ind => $sc_init)
          {
