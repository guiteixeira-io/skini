...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "rpt_costumerCheck/rpt_costumerCheck_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "rpt_costumerCheck.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "rpt_costumerCheck_res_json.class.php");
              $this->Res = new rpt_costumerCheck_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_res_grid']);
          } 
      }
   ...
   function NM_export_b_datetime()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->b_datetime;
   }
   //----- b_idlodge
   function NM_export_b_idlodge()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_b_idlodge;
   }
   //----- a_docnumber
   function NM_export_a_docnumber()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->a_docnumber;
   }
   //----- a_name
   function NM_export_a_name()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->a_name;
   }
   //----- a_phonenumber
   function NM_export_a_phonenumber()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->a_phonenumber;
   }
   //----- a_mobilephone
   function NM_export_a_mobilephone()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->a_mobilephone;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> mov_costumer_check :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
