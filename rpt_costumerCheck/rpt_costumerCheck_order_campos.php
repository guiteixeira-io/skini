...
<?php
   ...
   $Ord_Cmp = new rpt_costumerCheck_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class rpt_costumerCheck_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['b_datetime'] = "b_datetime";
   }
   else
   {
       $tab_def_campos['b_datetime'] = "b.dateTime";
   }
   $tab_labels["b_datetime"]   = (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["b_datetime"])) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["b_datetime"] : "Date e Hora";
   $tab_ger_campos['b_idlodge'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_idlodge'] = "b_idlodge";
   }
   else
   {
       $tab_def_campos['b_idlodge'] = "b.idLodge";
   }
   $tab_labels["b_idlodge"]   = (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["b_idlodge"])) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["b_idlodge"] : "Acomodação";
   $tab_ger_campos['a_docnumber'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_docnumber'] = "a_docnumber";
   }
   else
   {
       $tab_def_campos['a_docnumber'] = "a.docNumber";
   }
   $tab_labels["a_docnumber"]   = (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_docnumber"])) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_docnumber"] : "CPF";
   $tab_ger_campos['a_name'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_name'] = "a_name";
   }
   else
   {
       $tab_def_campos['a_name'] = "a.name";
   }
   $tab_labels["a_name"]   = (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_name"])) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_name"] : "Hóspede";
   $tab_ger_campos['a_phonenumber'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_phonenumber'] = "a_phonenumber";
   }
   else
   {
       $tab_def_campos['a_phonenumber'] = "a.phoneNumber";
   }
   $tab_labels["a_phonenumber"]   = (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_phonenumber"])) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_phonenumber"] : "Telefone Fixo";
   $tab_ger_campos['a_mobilephone'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_mobilephone'] = "a_mobilephone";
   }
   else
   {
       $tab_def_campos['a_mobilephone'] = "a.mobilePhone";
   }
   $tab_labels["a_mobilephone"]   = (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_mobilephone"])) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['labels']["a_mobilephone"] : "Telefone Móvel";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "rpt_costumerCheck_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['rpt_costumerCheck']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
