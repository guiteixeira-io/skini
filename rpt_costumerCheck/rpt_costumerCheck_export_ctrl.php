<?php
@session_start() ;
$_SESSION['scriptcase']['rpt_costumerCheck']['sc_process_barr'] = true;
require_once('../rpt_costumerCheck/index.php');
unset($_SESSION['scriptcase']['rpt_costumerCheck']['sc_process_barr']);
$ExportCtrl = new rpt_costumerCheck_export_control;
$ExportCtrl->Export_barr();

class rpt_costumerCheck_export_control
{
