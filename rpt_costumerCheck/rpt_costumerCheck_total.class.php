...
class rpt_costumerCheck_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['rpt_costumerCheck']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['rpt_costumerCheck']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $b_idlodge;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rpt_costumerCheck']['contr_total_geral'] = "OK";
   } 
