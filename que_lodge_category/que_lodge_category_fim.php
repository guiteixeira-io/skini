...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____que_lodge_category"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____que_lodge_category"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cad_lodge_category'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['que_lodge_category']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['que_lodge_category']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['que_lodge_category']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['que_lodge_category']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['que_lodge_category']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>que_lodge_category</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['que_lodge_category']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['que_lodge_category']['embutida_filho'] as $ind => $sc_init)
          {
