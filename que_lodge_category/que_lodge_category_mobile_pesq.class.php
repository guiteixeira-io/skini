...
class que_lodge_category_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . que_lodge_category_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . que_lodge_category_pack_protect_string($Tipo_filter[0]) . "\">.." . que_lodge_category_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "idlodgecategory";$Nm_numeric[] = "capacity";$Nm_numeric[] = "idlodgecategory";$Nm_numeric[] = "capacity";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         $nome_sum = "cad_lodge_category.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE> cad_lodge_category</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>que_lodge_category/que_lodge_category_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="que_lodge_category_ajax_search.js"></script>
 <script type="text/javascript" src="que_lodge_category_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="que_lodge_category_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['que_lodge_category']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['que_lodge_category']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idlodgecategory_cond#NMF#' + search_get_sel_txt('SC_idlodgecategory_cond') + '@NMF@';
  str_out += 'SC_idlodgecategory#NMF#' + search_get_text('SC_idlodgecategory') + '@NMF@';
  ...
  str_out += 'SC_capacity_cond#NMF#' + search_get_sel_txt('SC_capacity_cond') + '@NMF@';
  str_out += 'SC_capacity#NMF#' + search_get_text('SC_capacity') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_name").attr('class').split(' ');
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $idlodgecategory_cond, $idlodgecategory,
             $name_cond, $name, $name_autocomp,
             $capacity_cond, $capacity,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idlodgecategory = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['idlodgecategory']; 
          $idlodgecategory_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['idlodgecategory_cond']; 
          $name = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['name']; 
          $name_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['name_cond']; 
          $capacity = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['capacity']; 
          $capacity_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['capacity_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['NM_operador']; 
          if (strtoupper($idlodgecategory_cond) != "II" && strtoupper($idlodgecategory_cond) != "QP" && strtoupper($idlodgecategory_cond) != "NP" && strtoupper($idlodgecategory_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idlodgecategory, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($capacity_cond) != "II" && strtoupper($capacity_cond) != "QP" && strtoupper($capacity_cond) != "NP" && strtoupper($capacity_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($capacity, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($idlodgecategory_cond) || empty($idlodgecategory_cond))
      {
         $idlodgecategory_cond = "gt";
      }
      if (!isset($name_cond) || empty($name_cond))
      {
         $name_cond = "qp";
      }
      if (!isset($capacity_cond) || empty($capacity_cond))
      {
         $capacity_cond = "gt";
      }
      ...
      $str_hide_idlodgecategory = (in_array($idlodgecategory_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_name = (in_array($name_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_capacity = (in_array($capacity_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($idlodgecategory) || $idlodgecategory == "")
      {
          $idlodgecategory = "";
      }
      if (isset($idlodgecategory) && !empty($idlodgecategory))
      {
         $tmp_pos = (is_string($idlodgecategory)) ? strpos($idlodgecategory, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idlodgecategory = substr($idlodgecategory, 0, $tmp_pos);
         }
      }
      if (!isset($name) || $name == "")
      {
      ...
      {
         $tmp_pos = (is_string($name)) ? strpos($name, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
      ...
      {
         $tmp_pos = (is_string($capacity)) ? strpos($capacity, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $capacity = substr($capacity, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
 ...
 $nmgp_tab_label .= "idlodgecategory?#?" . $SC_Label . "?@?";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idlodgecategory_cond" name="idlodgecategory_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlodgecategory'), this, 'idlodgecategory')">
       <OPTION value="gt" <?php if ("gt" == $idlodgecategory_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idlodgecategory_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idlodgecategory_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idlodgecategory"  <?php echo $str_hide_idlodgecategory?>><INPUT  type="text" id="SC_idlodgecategory" name="idlodgecategory" value="<?php echo NM_encode_input($idlodgecategory) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_name_cond" name="name_cond" onChange="nm_campos_between(document.getElementById('id_vis_name'), this, 'name')">
       <OPTION value="qp" <?php if ("qp" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $name_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_name"  <?php echo $str_hide_name?>><?php
      if ($name != "")
      {
      $name_look = (is_string($name) ? substr($this->Db->qstr($name), 1, -1) : $name); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_capacity_cond" name="capacity_cond" onChange="nm_campos_between(document.getElementById('id_vis_capacity'), this, 'capacity')">
       <OPTION value="gt" <?php if ("gt" == $capacity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $capacity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $capacity_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_capacity"  <?php echo $str_hide_capacity?>><INPUT  type="text" id="SC_capacity" name="capacity" value="<?php echo NM_encode_input($capacity) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("que_lodge_category_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idlodgecategory_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idlodgecategory'), document.F1.idlodgecategory_cond, 'idlodgecategory');
   document.F1.idlodgecategory.value = "";
   document.F1.name_cond.value = 'qp';
   ...
   document.F1.capacity_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_capacity'), document.F1.capacity_cond, 'capacity');
   document.F1.capacity.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idlodgecategory_cond'] = 'cond';
      $tp_fields['SC_idlodgecategory'] = 'text';
      $tp_fields['SC_name_cond'] = 'cond';
      $tp_fields['SC_name'] = 'text_aut';
      $tp_fields['id_ac_name'] = 'text_aut';
      $tp_fields['SC_capacity_cond'] = 'cond';
      $tp_fields['SC_capacity'] = 'text';
   ...
   {
      global $idlodgecategory_cond, $idlodgecategory,
             $name_cond, $name, $name_autocomp,
             $capacity_cond, $capacity, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $idlodgecategory_cond_salva = $idlodgecategory_cond; 
      if (!isset($idlodgecategory_input_2) || $idlodgecategory_input_2 == "")
      {
          $idlodgecategory_input_2 = $idlodgecategory;
      }
      ...
      $capacity_cond_salva = $capacity_cond; 
      if (!isset($capacity_input_2) || $capacity_input_2 == "")
      {
          $capacity_input_2 = $capacity;
      }
      if ($idlodgecategory_cond != "in")
      {
          nm_limpa_numero($idlodgecategory, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($capacity_cond != "in")
      {
          nm_limpa_numero($capacity, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['idlodgecategory'] = $idlodgecategory; 
      if (is_array($idlodgecategory) && !empty($idlodgecategory))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['val'][0] = $idlodgecategory;
      }
      elseif ($idlodgecategory_cond_salva == "nu" || $idlodgecategory_cond_salva == "nn" || $idlodgecategory_cond_salva == "ep" || $idlodgecategory_cond_salva == "ne" || !empty($idlodgecategory))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['val'][0][0] = $idlodgecategory;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['idlodgecategory_cond'] = $idlodgecategory_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['cmp'] = "idlodgecategory"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['opc'] = $idlodgecategory_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']['idlodgecategory'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['name'] = $name; 
      if (is_array($name) && !empty($name))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['val'][0] = $name;
      }
      elseif ($name_cond_salva == "nu" || $name_cond_salva == "nn" || $name_cond_salva == "ep" || $name_cond_salva == "ne" || !empty($name))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['val'][0][0] = $name;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['name_cond'] = $name_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['cmp'] = "name"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['opc'] = $name_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']['name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['capacity'] = $capacity; 
      if (is_array($capacity) && !empty($capacity))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['val'][0] = $capacity;
      }
      elseif ($capacity_cond_salva == "nu" || $capacity_cond_salva == "nn" || $capacity_cond_salva == "ep" || $capacity_cond_salva == "ne" || !empty($capacity))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['val'][0][0] = $capacity;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['capacity_cond'] = $capacity_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['cmp'] = "capacity"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid]['opc'] = $capacity_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']['capacity'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $idlodgecategory;
      if (strtoupper($idlodgecategory_cond) != "II" && strtoupper($idlodgecategory_cond) != "QP" && strtoupper($idlodgecategory_cond) != "NP" && strtoupper($idlodgecategory_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idlodgecategory'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($name != '') {
      $name_look = (is_string($name) ? substr($this->Db->qstr($name), 1, -1) : $name); 
      $nmgp_def_dados = array(); 
      ...
      $this->cmp_formatado['capacity'] = $Conteudo;

      //----- $idlodgecategory
      $this->Date_part = false;
      if (isset($idlodgecategory) || $idlodgecategory_cond == "nu" || $idlodgecategory_cond == "nn" || $idlodgecategory_cond == "ep" || $idlodgecategory_cond == "ne")
      {
         $this->monta_condicao("idLodgeCategory", $idlodgecategory_cond, $idlodgecategory, "", "idlodgecategory", "INT", false);
      }
      ...
      {
         $this->monta_condicao("name", $name_cond, $name, "", "name", "VARCHAR", false);
      }

      //----- $capacity
      $this->Date_part = false;
      if (isset($capacity) || $capacity_cond == "nu" || $capacity_cond == "nn" || $capacity_cond == "ep" || $capacity_cond == "ne")
      {
         $this->monta_condicao("capacity", $capacity_cond, $capacity, "", "capacity", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'] .= $this->NM_operador;
