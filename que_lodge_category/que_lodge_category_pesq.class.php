...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> cad_lodge_category</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idlodgecategory_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idlodgecategory'])) ? $this->New_label['idlodgecategory'] : "Id Lodge Category"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idlodgecategory_cond" name="idlodgecategory_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlodgecategory'), this, 'idlodgecategory')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idlodgecategory" <?php echo $str_hide_idlodgecategory?> valign="top">
...
?>
<INPUT  type="text" id="SC_idlodgecategory" name="idlodgecategory" value="<?php echo NM_encode_input($idlodgecategory) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<INPUT  type="text" id="SC_capacity" name="capacity" value="<?php echo NM_encode_input($capacity) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
