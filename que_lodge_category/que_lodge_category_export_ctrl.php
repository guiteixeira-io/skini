<?php
@session_start() ;
$_SESSION['scriptcase']['que_lodge_category']['sc_process_barr'] = true;
require_once('../que_lodge_category/index.php');
unset($_SESSION['scriptcase']['que_lodge_category']['sc_process_barr']);
$ExportCtrl = new que_lodge_category_export_control;
$ExportCtrl->Export_barr();

class que_lodge_category_export_control
{
