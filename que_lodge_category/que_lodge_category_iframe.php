...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['que_lodge_category']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"))
    {
?>
<html>
 <body>
...
$oExportPdf = new que_lodge_category_export_pdf;
$oExportPdf->exportPdf();

class que_lodge_category_export_pdf {
...
$STR_lang           = '';
$str_google_fonts   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']))
{
    $STR_schema         = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']['str_schema'];
    $STR_tmp            = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']['str_tmp'];
    $STR_prod           = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']['str_prod'];
    $STR_btn            = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']['str_btn'];
    $STR_lang           = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']['str_lang'];
    $str_google_fonts   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['que_lodge_category_iframe_params']['str_google_fonts'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['que_lodge_category']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['opc_pdf']['label_group'] = (isset($aParams['pdf_label_group'])) ? $aParams['pdf_label_group'] : "N";
$_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['opc_pdf']['pdf_zip']     = (isset($aParams['pdf_zip']))         ? $aParams['pdf_zip']         : "N";
$Nm_lang     = array();
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_title'] ?> cad_lodge_category :: PDF</title>
...
<?php
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'])) {
    $Pos = strrpos($_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'], ".");
    if ($Pos === false) {
        $_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'] .= ".pdf";
    }
}
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'] : 'sc_pdf_' . md5(date('Ymd') . '_' . session_id()) . '_que_lodge_category.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['pdf_name'] : "que_lodge_category.pdf";
$NM_pdf_output = $NM_pdfbase;
if (isset($_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['opc_pdf']['pdf_zip']) && $_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category']['opc_pdf']['pdf_zip'] == "S")
 {
...
$_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category'][$path_doc_md5][0] = $_SESSION['scriptcase']['que_lodge_category']['glo_nm_path_imag_temp'] . "/" . $NM_tit_doc;
$_SESSION['sc_session'][$aParams['script_case_init']]['que_lodge_category'][$path_doc_md5][1] = $NM_tit_doc;
$NM_volta   = "volta_grid";
