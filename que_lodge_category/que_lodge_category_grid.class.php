...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'] = array();
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "que_lodge_category/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new que_lodge_category_resumo();
       $this->Res->Db     = $this->Db;
       $this->Res->Erro   = $this->Erro;
       $this->Res->Ini    = $this->Ini;
       $this->Res->Lookup = $this->Lookup;
      }
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['que_lodge_category'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new que_lodge_category_grafico();
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'];
 }
...
//
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['orig_pesq'] = "grid";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("pt_br");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_pdf']['all_label'] : "S";
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['fix_top'])) {
       $this->Fix_bar_top = ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['fix_top'] == "S") ? true : false;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['fix_bot'])) {
       $this->Fix_bar_bottom = ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['fix_bot'] == "S") ? true : false;
   }
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "que_lodge_category/que_lodge_category_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pesq_tab_label']))
   {
   ...
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] || $this->Ini->Embutida_iframe)
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['lig_edit'] = "N";}
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['mostra_edit'] = "N";
   }
   $this->NM_cont_body   = 0; 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['print_all'];
   if ($this->Print_All)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'];
       if ($_SESSION['scriptcase']['charset'] != "UTF-8")
       {
           $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
       }
       $this->idlodgecategory = (isset($Busca_temp['idlodgecategory'])) ? $Busca_temp['idlodgecategory'] : ""; 
       $tmp_pos = (is_string($this->idlodgecategory)) ? strpos($this->idlodgecategory, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->idlodgecategory))
       {
           $this->idlodgecategory = substr($this->idlodgecategory, 0, $tmp_pos);
       }
       ...
       $this->capacity = (isset($Busca_temp['capacity'])) ? $Busca_temp['capacity'] : ""; 
       $tmp_pos = (is_string($this->capacity)) ? strpos($this->capacity, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->capacity))
       {
           $this->capacity = substr($this->capacity, 0, $tmp_pos);
       }
   } 
   $this->nm_field_dinamico = array();
   $this->nm_order_dinamico = array();
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'];
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['que_lodge_category'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['que_lodge_category'];
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['insert'] != '')
   {
       $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['insert'];
       $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['insert'];
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['update'] != '')
   {
       $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['update'];
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['delete'] != '')
   {
       $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['cad_lodge_category']['delete'];
   }
   if ($this->Ini->Embutida_iframe) {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sub_cons_iframe_btns'] as $BTN => $BTN_opc) {
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "que_lodge_category/que_lodge_category_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "que_lodge_category_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new que_lodge_category_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['que_lodge_category']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao']       = "igual" ; 
...
// 
   $this->count_ger = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
   {
       $this->Ini->Qtd_reg_ajax_grid = $this->count_ger;
   }
   else
   {
       $this->Ini->Qtd_reg_ajax_grid = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'];
   }
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final']++ ; 
   ...
   $this->nmgp_reg_inicial  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final'] + 1;
   $this->nmgp_reg_final    = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'];
   $this->nmgp_reg_final    = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
           $this->pb = new scProgressBar();
           $this->pb->setRoot($this->Ini->root);
           $this->pb->setDir($_SESSION['scriptcase']['que_lodge_category']['glo_nm_path_imag_temp'] . "/");
           $this->pb->setProgressbarMd5($_GET['pbmd5']);
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> cad_lodge_category :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               que_lodge_category_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               que_lodge_category_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               que_lodge_category_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               que_lodge_category_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               que_lodge_category_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " cad_lodge_category</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $this->NM_opcao != "pdf") {
           $nm_saida->saida("   <link rel=\"shortcut icon\" href=\"../_lib/img/grp__NM__ico__NM__barraca-de-acampamento.ico\">\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida']) {  
        ...
        if ($this->Fix_bar_top) {
           ...
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-ui-grid-header-row-que_lodge_category-1 .sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
           ...
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-que_lodge_category-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-que_lodge_category-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-que_lodge_category-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-268dea35\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<style type=\"text/css\">\r\n");
       $nm_saida->saida("</style>\r\n");
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_que_lodge_category_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_que_lodge_category_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_que_lodge_category_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf") {
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           ...
           if ($Pos1 !== false && $Pos2 !== false) {
               ...
               $cada_css = ".que_lodge_category_" . substr(trim($Tag[0]), 1);
               if (isset($Tag[1])) {
                   $cada_css .= ", .que_lodge_category_" . substr(trim($Tag[1]), 1);
               }
               $cada_css .= $Css;
           }
           else {
               $cada_css = ".que_lodge_category_" . substr($cada_css, 1);
           }
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   $this->css_body_embutida = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['css_body_embutida'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['css_body_embutida'] : "";
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['doc_word'])
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['css_body_embutida'])) {
       $remove_border = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['css_body_embutida'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert'])
   {
   }
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print") 
       { 
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
       }
           $nm_saida->saida("    <TR>\r\n");
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['que_lodge_category']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['que_lodge_category']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['que_lodge_category']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['que_lodge_category']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['cab']))
   {
       return; 
   }
   if ($this->Ini->Embutida_iframe) {
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['exibe_titulos']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_label'])
      { 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
             ...
             foreach ($NM_css as $cada_css)
             {
                 ...
                 if ($Pos1 !== false && $Pos2 !== false) {
                     ...
                     $css_emb .= $cada_css . $Css;
                       ...
                       $css_emb .= ".que_lodge_category_" . substr($cada_css, 1);
                 }
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_idlodgecategory()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . $this->css_sep . $this->css_idlodgecategory_label . " " . $classColFld . $classColTitle . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_idlodgecategory_label'] . "\" >\r\n");
    $label_fieldName = nl2br($SC_Label);
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '; justify-content: right';
        $fieldSortRule = $this->scGetColumnOrderRule('idLodgeCategory');
        $fieldSortIcon = $this->scGetColumnOrderIcon('idLodgeCategory', $fieldSortRule);
        ...
        if (empty($fieldSortIcon)) {
            ...
            $label_labelContent = "<div style=\"display: flex" . $divLabelStyle . "\"><div class=\"" . $this->css_idlodgecategory_label . "\" style=\"display: flex; white-space: nowrap\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
            ...
            $label_labelContent = "<div style=\"display: flex; justify-content: space-between\"><div class=\"" . $this->css_idlodgecategory_label . "\" style=\"display: flex; flex-grow: 1; white-space: nowrap" . $divLabelStyle . "\">" . $label_fieldName . "</div>" . $fieldSortIcon . "</div>";
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('idLodgeCategory')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
...
function SC_label_rightActionBar()
{
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ini_cor_grid']);
       }
   }
...
// 
   ...
   if (!empty($this->nm_grid_sem_reg))
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
       {
           ...
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cols_emb']))
               {
                   $cont_col = 0;
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cols_emb'];
               }
           ...
           {
               $nm_saida->saida("<table id=\"apl_que_lodge_category#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['cad_lodge_category']['lig_iframe_modal'] = "nmsc_iframe_liga_que_lodge_category";
           }
           $nm_saida->saida(" <TR> \r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && 
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print") 
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_que_lodge_category', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_que_lodge_category', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_que_lodge_category', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" &&
       ...
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               if (!$_SESSION['scriptcase']['proc_mobile']) {
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               }
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_que_lodge_category#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-268dea35\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Page_break_PDF'] = array();
       }
   }
   ...
   $nm_houve_quebra = "N";
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  que_lodge_category_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['mostra_edit'] != "N"){ 
              if ($this->grid_emb_form_full)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_lodge_category']['lig_iframe_modal'] = "nmsc_iframe_liga_que_lodge_category";
              }
              $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
              $linkTarget = isset($this->Ini->sc_lig_target['A_@scinf__@scinf_cad_lodge_category']) ? $this->Ini->sc_lig_target['A_@scinf__@scinf_cad_lodge_category'] : (isset($this->Ini->sc_lig_target['A_@scinf_']) ? $this->Ini->sc_lig_target['A_@scinf_'] : null);
              if (isset($this->Ini->sc_lig_md5["cad_lodge_category"]) && $this->Ini->sc_lig_md5["cad_lodge_category"] == "S")
              {
                  $Parms_Edt  = "idlodgecategory*scin" . str_replace('"', "@aspasd@", $this->idlodgecategory) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['remove_border'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@que_lodge_category@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "idlodgecategory*scin" . str_replace('"', "@aspasd@", $this->idlodgecategory) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutnmgp_opcao*scinigual*scoutNMSC_modal*scinok*scout";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_cad_lodge_category . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'cad_lodge_category', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_cad_lodge_category . "', '$this->nm_location',  '$Md5_Edt' , '". (isset($linkTarget) ? $linkTarget : '_self') . "', '', 'cad_lodge_category', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->idlodgecategory . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@que_lodge_category@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "que_lodge_category/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=que_lodge_category&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "que_lodge_category/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=que_lodge_category&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
 ...
 $this->grid_fixed_column_no++;} 
   ...
   $this->SC_grid_rightActionBar();
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
...
function SC_grid_rightActionBar()
{
 ...
 function NM_grid_name()
 {
      ...
      if (!isset($this->NM_cmp_hidden['name']) || $this->NM_cmp_hidden['name'] != "off") { 
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'name', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != 'pdf') {
 ...
 function NM_grid_capacity()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['capacity']) || $this->NM_cmp_hidden['capacity'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->capacity)); 
          $conteudo_original = NM_encode_input(sc_strip_script($this->capacity)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'capacity', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'capacity', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          $classColFld = "";
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != 'pdf') {
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
...
$nm_saida->saida("    </style>\r\n");
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on" && !$this->NM_hidden_filters)
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $this->nm_btn_exist['sel_col'][] = "selcmp_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
      }
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=pt_br&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=que_lodge_category&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=que_lodge_category&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['json'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_json_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_json_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "json_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_json_res . "&nm_ini_json_res=grid,resume&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
          {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form && !$this->NM_hidden_filters)
      {
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
           ...
           if (isset($this->Ini->sc_lig_md5["cad_lodge_category"]) && $this->Ini->sc_lig_md5["cad_lodge_category"] == "S") {
               ...
               $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@que_lodge_category@SC_par@" . md5($Parms_Lig);
               $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
           } else {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_cad_lodge_category . "', '$this->nm_location', '$Md5_Lig', '_self', 'cad_lodge_category'); return false;;", "nm_gp_submit1('" .  $this->Ini->link_cad_lodge_category . "', '$this->nm_location', '$Md5_Lig', '_self', 'cad_lodge_category'); return false;;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] != "sc_free_total")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
          ...
          if (is_file("que_lodge_category_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("que_lodge_category_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_modal'])
        {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] == '10') ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] == '20') ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] == '50') ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']))
          {
...
$nm_saida->saida("    </style>\r\n");
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
              ...
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=pt_br&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=que_lodge_category&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['xml'][] = "xml_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['csv'][] = "csv_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
...
$nm_saida->saida("    </style>\r\n");
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "idlodgecategory")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "idlodgecategory";
                           $lin_obj = $this->grid_search_idlodgecategory($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "name")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "name";
                           $lin_obj = $this->grid_search_name($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "capacity")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "capacity";
                           $lin_obj = $this->grid_search_capacity($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('idlodgecategory','name','capacity');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']) && count($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq']) < 3)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_idlodgecategory($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_idlodgecategory_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_idlodgecategory_cond_" . $ind . "' name='cond_grid_search_idlodgecategory_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"idlodgecategory\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_idlodgecategory_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
   ...
   function grid_search_name($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_name_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_name_cond_" . $ind . "' name='cond_grid_search_name_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"name\", $ind)'>";
       ...
       $lin_obj .= "       <span id=\"grid_name_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $name = $val_cmp;
       if ($name != "")
       {
       $name_look = (is_string($name) ? substr($this->Db->qstr($name), 1, -1) : $name); 
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_name_val_" . $ind . "' name='val_grid_search_name_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       ...
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_name" . $ind . "' name='val_grid_search_name_autocomp" . $ind . "' size='50' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_capacity($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_capacity_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_capacity_cond_" . $ind . "' name='cond_grid_search_capacity_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_hide_input(\"capacity\", $ind)'>";
       $selected = ($opc == "gt") ? " selected" : "";
       $lin_obj .= "        <option value='gt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_grtr'] . "</option>";
       $selected = ($opc == "lt") ? " selected" : "";
       $lin_obj .= "        <option value='lt'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_less'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_capacity_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       nmgp_Form_Num_Val($val_cmp, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_capacity_val_" . $ind . "' name='val_grid_search_capacity_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=11 alt=\"{datatype: 'decimal', maxLength: 11, precision: 0, decimalSep: '" . $_SESSION['scriptcase']['reg_conf']['dec_num'] . "', thousandsSep: '" . $_SESSION['scriptcase']['reg_conf']['grup_num'] . "', allowNegative: false, onlyNegative: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       { 
          ...
          { 
            ...
            $cmp1 = que_lodge_category_pack_protect_string($cmp1);
            $nmgp_def_dados[] = array($cmp1 => $cmp1); 
             $rs->MoveNext(); 
          } 
          $rs->Close(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "skini/que_lodge_category";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'name')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_name = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_name\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                          $(\"#grid_search_name_val_\" + x_name).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#grid_search_name_val_\" + x_name).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ] as $ind => $vals)
                        {
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ], $str_value) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ], $str_value_original) == 0)
                        {
                            $str_value = $str_html_ini. $str_value .$str_html_fim;
                        }
                        else
                        {
                            $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ], '/');
                            $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                        }
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ] as $ind => $vals)
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(is_array($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]))
                    {
                        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ] as $ind => $vals)
                    ...
                    {
                        if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]))) == 0)
                        {
                            $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campos_busca'][ $field ]));
                        }
                    }
                }
            }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][0]) &&
                (
                    (
                    ...
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
       if (!$_SESSION['scriptcase']['proc_mobile']) {
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_que_lodge_category\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_que_lodge_category\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       }
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('que_lodge_category', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"que_lodge_category\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"que_lodge_category_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"que_lodge_category_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "que_lodge_category/que_lodge_category_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"que_lodge_category_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=que_lodge_category';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_que_lodge_category');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_que_lodge_category');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_que_lodge_category');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_que_lodge_category');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['que_lodge_category_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@que_lodge_category@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   $nm_saida->saida("               document.Fpdf.action=\"que_lodge_category_iframe.php\";\r\n");
   ...
   $nm_saida->saida("               document.Fprint.action = \"que_lodge_category_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"que_lodge_category_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['que_lodge_category']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"que_lodge_category_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_lodge_category']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('que_lodge_category')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('que_lodge_category', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
