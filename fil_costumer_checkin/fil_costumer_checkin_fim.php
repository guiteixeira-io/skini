...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____fil_costumer_checkin"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____fil_costumer_checkin"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['tas_costumer_checkin'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>fil_costumer_checkin</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkin']['embutida_filho'] as $ind => $sc_init)
          {
