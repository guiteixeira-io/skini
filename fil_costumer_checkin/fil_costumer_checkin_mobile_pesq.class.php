...
class fil_costumer_checkin_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . fil_costumer_checkin_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . fil_costumer_checkin_pack_protect_string($Tipo_filter[0]) . "\">.." . fil_costumer_checkin_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "idcostumer";$Nm_numeric[] = "idlodge";$Nm_numeric[] = "idholder";$Nm_numeric[] = "idcostumer";$Nm_numeric[] = "idlodge";$Nm_numeric[] = "idholder";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         $nomeX = $nome;
         if ($nome == "idcostumer") {$nomeX = "idCostumer";}
         if ($nome == "docnumber") {$nomeX = "docNumber";}
         if ($nome == "doctype") {$nomeX = "docType";}
         if ($nome == "firstname") {$nomeX = "firstName";}
         if ($nome == "lastname") {$nomeX = "lastName";}
         if ($nome == "idlodge") {$nomeX = "idLodge";}
         if ($nome == "frequencytype") {$nomeX = "frequencyType";}
         if ($nome == "holdertype") {$nomeX = "holderType";}
         if ($nome == "idholder") {$nomeX = "idHolder";}
         if ($nome == "statuslocate") {$nomeX = "statusLocate";}
         $nome = $nomeX;
         $nome_sum = "cad_costumer.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('tas_costumer_checkin') . "/";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE> cad_costumer</TITLE>
...
<INPUT type="hidden" name="nmgp_parms" value="NM_where_filter_form?#?<?php echo NM_encode_input($this->comando_filtro); ?>?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?"/>
</FORM>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>fil_costumer_checkin/fil_costumer_checkin_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="fil_costumer_checkin_ajax_search.js"></script>
 <script type="text/javascript" src="fil_costumer_checkin_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="fil_costumer_checkin_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['fil_costumer_checkin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['fil_costumer_checkin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if ((isset($this->nm_mens_alert) && count($this->nm_mens_alert)) || (isset($this->Ini->nm_mens_alert) && count($this->Ini->nm_mens_alert))) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_idlodge#NMF#' + search_get_Dselelect('SC_idlodge_dest') + '@NMF@';
  str_out += 'SC_docnumber_cond#NMF#' + search_get_sel_txt('SC_docnumber_cond') + '@NMF@';
  str_out += 'SC_docnumber#NMF#' + search_get_text('SC_docnumber') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> cad_costumer</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fil_costumer_checkin']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['fil_costumer_checkin']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['fil_costumer_checkin']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("fil_costumer_checkin", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idlodge = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['idlodge']; 
          $idlodge_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['idlodge_cond']; 
          $docnumber = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['docnumber']; 
          $docnumber_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['docnumber_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idlodge_cond) || empty($idlodge_cond))
      {
         $idlodge_cond = "eq";
      }
      if (!isset($docnumber_cond) || empty($docnumber_cond))
      {
         $docnumber_cond = "eq";
      }
      ...
      $str_hide_docnumber = (in_array($docnumber_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (is_array($idlodge) && !empty($idlodge))
      {
         $tmp_array = array();
         $idlodge_val_str = "";
         foreach ($idlodge as $tmp_val_cmp)
         {
            if ("" != $idlodge_val_str)
            {
               $idlodge_val_str .= ",";
      ...
      if (!isset($docnumber) || $docnumber == "")
      {
          $docnumber = "";
      }
      if (isset($docnumber) && !empty($docnumber))
      {
         $tmp_pos = (is_string($docnumber)) ? strpos($docnumber, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $docnumber = substr($docnumber, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idlodge_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idlodge'])) ? $this->New_label['idlodge'] : "Alojamento"; ?></TD>
      
      <INPUT type="hidden" id="SC_idlodge_cond" name="idlodge_cond" value="eq">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idlodge" <?php echo $str_hide_idlodge?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idlodge'])) ? $this->New_label['idlodge'] : "Alojamento";
...
<?php
      $idlodge_look = (is_string($idlodge) ? substr($this->Db->qstr($idlodge), 1, -1) : $idlodge); 
      $nmgp_def_dados = "" ; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['psq_check_ret']['idlodge'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['psq_check_ret']['idlodge'][] = trim($rs->fields[0]);
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_idlodge_orig" name="idlodge_orig" size=7 multiple onDblClick="nm_add_sel('idlodge_orig', 'idlodge_dest', 'N' , '')">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $idlodge_sel = "";
               foreach ($idlodge as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $idlodge_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $idlodge_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $idlodge_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('idlodge_orig', 'idlodge_dest', 'N', '');", "nm_add_all('idlodge_orig', 'idlodge_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('idlodge_orig', 'idlodge_dest', 'N', '');", "nm_add_sel('idlodge_orig', 'idlodge_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('idlodge_dest', 'idlodge_orig', 'N', '');", "nm_del_sel('idlodge_dest', 'idlodge_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('idlodge_dest', 'idlodge_orig', 'N', '');", "nm_del_all('idlodge_dest', 'idlodge_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_idlodge_dest" name="idlodge_dest" size=7 multiple  onDblClick="nm_del_sel('idlodge_dest', 'idlodge_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_idlodge" name="idlodge" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.idlodge_dest.selectedIndex = -1;</script>
<?php
?>
      ...
      <TD id='SC_docnumber_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['docnumber'])) ? $this->New_label['docnumber'] : "Doc Number"; ?></TD>
      
      <INPUT type="hidden" id="SC_docnumber_cond" name="docnumber_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_docnumber" <?php echo $str_hide_docnumber?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['docnumber'])) ? $this->New_label['docnumber'] : "Doc Number";
 $nmgp_tab_label .= "docnumber?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_docnumber" name="docnumber" value="<?php echo NM_encode_input($docnumber) ?>" size=15 alt="{datatype: 'cpf', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("fil_costumer_checkin_help.txt"))
   {
      $Arq_WebHelp = file("fil_costumer_checkin_help.txt"); 
...
<?php
   ...
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['dashboard_info']['under_dashboard'])
   { }
   else
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idlodge_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_idlodge'), document.F1.idlodge_cond, 'idlodge');
   nm_del_all('idlodge_dest', 'idlodge_orig', 'N', '');
   document.F1.docnumber_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_docnumber'), document.F1.docnumber_cond, 'docnumber');
   document.F1.docnumber.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_docnumber').bind('change', function() {sc_fil_costumer_checkin_valida_cic(this)});
 }
 function sc_fil_costumer_checkin_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "skini/fil_costumer_checkin";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("pt_br");
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idlodge'] = 'dselect';
      $tp_fields['SC_docnumber_cond'] = 'cond';
      $tp_fields['SC_docnumber'] = 'text';
   ...
   {
      global $idlodge_cond, $idlodge,
             $docnumber_cond, $docnumber, $nmgp_tab_label;
      ...
      $docnumber_cond_salva = $docnumber_cond; 
      if (!isset($docnumber_input_2) || $docnumber_input_2 == "")
      {
          $docnumber_input_2 = $docnumber;
      }
      if (is_array($idlodge)) {
          foreach ($idlodge as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['psq_check_ret']['idlodge'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Alojamento : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['idlodge'] = $idlodge; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['idlodge_cond'] = $idlodge_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['docnumber'] = $docnumber; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['docnumber_cond'] = $docnumber_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca'] = $Temp_Busca;
      }
      nm_limpa_ciccnpj($docnumber) ; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['idlodge'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']['idlodge'];
      $this->cmp_formatado['idlodge_input_2'] = $idlodge_input_2;
      $Conteudo = $docnumber;
      if (strlen($Conteudo) == 11 || strlen($Conteudo) == 14) 
      { 
          nmgp_Form_CicCnpj($Conteudo) ; 
      } 
      $this->cmp_formatado['docnumber'] = $Conteudo;

      //----- $idlodge
      $this->Date_part = false;
      $nm_aspas = "";
      if ($idlodge_cond == "nu" || $idlodge_cond == "nn" || $idlodge_cond == "ep" || $idlodge_cond == "ne")
      {
          $idlodge = array();
      }
      if (is_array($idlodge) && count($idlodge) != 0)
      {
         foreach ($idlodge as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($idlodge_cond == "df" || $idlodge_cond == "np")
         {
             $this->comando        .= " idLodge not in (";
             $this->comando_sum    .= " cad_costumer.idLodge not in (";
             $this->comando_filtro .= " idLodge not in (";
         }
         else
         {
             $this->comando        .= " idLodge in (";
             $this->comando_sum    .= " cad_costumer.idLodge in (";
             $this->comando_filtro .= " idLodge in (";
         }
         $x                     = count($idlodge);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$idlodge_cond]) ? $Lang_descr[$idlodge_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_pesq'] .= $nmgp_tab_label['idlodge'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($idlodge) && ($idlodge_cond == "nu" || $idlodge_cond == "nn" || $idlodge_cond == "ep" || $idlodge_cond == "ne"))
      {
         $this->monta_condicao("idLodge", $idlodge_cond, "", "", "idlodge", "INT", false);
      }

      //----- $docnumber
      $this->Date_part = false;
      if (isset($docnumber) || $docnumber_cond == "nu" || $docnumber_cond == "nn" || $docnumber_cond == "ep" || $docnumber_cond == "ne")
      {
         $this->monta_condicao("docNumber", $docnumber_cond, $docnumber, "", "docnumber", "VARCHAR", false);
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkin']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkin']['where_filtro'] = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkin']['where_filter'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
