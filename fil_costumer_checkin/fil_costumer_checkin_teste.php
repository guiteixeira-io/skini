<?php  
  ...
  session_start() ;
  class fil_costumer_checkin_form_teste
  {
  function fil_costumer_checkin_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">fil_costumer_checkin</FONT></B> 
<br> 
<br> 
...
<input type=submit value="fil_costumer_checkin"> 
</form> 
...
<?php
  ...
  $frm_teste = new fil_costumer_checkin_form_teste();
  $frm_teste->fil_costumer_checkin_teste();
?>
