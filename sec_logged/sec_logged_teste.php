<?php  
  ...
  session_start() ;
  class sec_logged_form_teste
  {
   function sec_logged_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_logged/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_logged</FONT></B> 
<br> 
<br> 
...
usr_email&nbsp;&nbsp;<input type="text" name="usr_email" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="sec_logged"> 
</form> 
...
<?php
  ...
  $frm_teste = new sec_logged_form_teste();
  $frm_teste->sec_logged_teste();
?>
