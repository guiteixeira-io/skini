...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_logged']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_outra_jan'])
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['sec_logged']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['sec_logged']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   ...
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['sec_logged']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['sec_logged']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['sec_logged']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['sec_logged']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['sec_logged']['db_changed'])
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['sec_logged']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['sec_logged']['embutida_filho'] as $ind => $sc_init)
          {
