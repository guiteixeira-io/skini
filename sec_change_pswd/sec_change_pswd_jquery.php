...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["old_pswd" + iSeqRow] && scEventControl_data["old_pswd" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["old_pswd" + iSeqRow] && scEventControl_data["old_pswd" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { sc_sec_change_pswd_pswd_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_sec_change_pswd_pswd_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_confirm_pswd' + iSeqRow).bind('blur', function() { sc_sec_change_pswd_confirm_pswd_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_sec_change_pswd_confirm_pswd_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_old_pswd' + iSeqRow).bind('blur', function() { sc_sec_change_pswd_old_pswd_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_sec_change_pswd_old_pswd_onchange(this, iSeqRow) })
...
function sc_sec_change_pswd_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_change_pswd_confirm_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_change_pswd_old_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'sec_change_pswd')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
