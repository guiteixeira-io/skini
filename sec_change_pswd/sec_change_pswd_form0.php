...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>sec_change_pswd/sec_change_pswd_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("sec_change_pswd_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('sec_change_pswd_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['link_info']['remove_border']) {
...
<?php
 include_once("sec_change_pswd_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['sec_change_pswd'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['sec_change_pswd'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['where_filter']))
       {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("sec_change_pswd");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("sec_change_pswd");
 parent.scAjaxDetailHeight("sec_change_pswd", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_change_pswd']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
