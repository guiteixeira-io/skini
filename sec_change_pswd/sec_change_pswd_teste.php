<?php  
  ...
  session_start() ;
  class sec_change_pswd_form_teste
  {
   function sec_change_pswd_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_change_pswd/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_change_pswd</FONT></B> 
<br> 
<br> 
...
act_code&nbsp;&nbsp;<input type="text" name="act_code" size=20><br> 
usr_login&nbsp;&nbsp;<input type="text" name="usr_login" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="sec_change_pswd"> 
</form> 
<script language=javascript> 
 document.Fedit.act_code.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new sec_change_pswd_form_teste();
  $frm_teste->sec_change_pswd_teste();
?>
