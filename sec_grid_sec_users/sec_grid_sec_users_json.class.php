...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "sec_grid_sec_users/sec_grid_sec_users_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "sec_grid_sec_users.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "sec_grid_sec_users_res_json.class.php");
              $this->Res = new sec_grid_sec_users_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_res_grid']);
          } 
      }
   ...
   {
         $this->picture = NM_charset_to_utf8($this->picture);
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->picture;
   }
   //----- login
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_list_users'] ?> :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
