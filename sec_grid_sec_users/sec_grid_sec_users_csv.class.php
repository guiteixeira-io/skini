...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Arquivo  .= ".csv";
      $this->Tit_doc   = "sec_grid_sec_users.csv";
      ...
      if (!$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_return']);
          if ($this->Tem_csv_res) {
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_name']);
      }
      ...
      { 
          ...
          require_once($this->Ini->path_aplicacao . "sec_grid_sec_users_res_csv.class.php");
          $this->Res = new sec_grid_sec_users_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_list_users'] ?> :: CSV</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['sec_grid_sec_users']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
