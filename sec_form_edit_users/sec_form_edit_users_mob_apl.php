...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['sec_form_edit_users_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['sec_form_edit_users_mob']['opc_ant'] = "inicio";
      }
      ...
      $_SESSION['sc_session'][$script_case_init]['sec_form_edit_users_mob']['upload_field_info']['picture'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'sec_form_edit_users_mob',
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_form_edit_users_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->NM_ajax_info['param']['picture_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['upload_field_ul_name'][$this->picture_ul_name];
          }
      ...
      elseif (isset($this->picture_ul_name) && '' != $this->picture_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->picture_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['upload_field_ul_name'][$this->picture_ul_name];
          }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opc_ant'] : "";
      } 
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['sec_form_edit_users_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['sec_form_edit_users_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'sec_form_edit_users_mob_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dados_form']['picture']) && $this->picture_limpa != "S")
          {
              $this->picture = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dados_form']['picture'];
          }
      } 
   }
...
$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('Y') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("")));
...
<?php 
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Field_no_validate'] = array();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['opcao'] = '';
  ...
  if($this->pswd  != $this->confirm_pswd )
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_sec_form_edit_users_mob';
...
//---------- 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['ordem_ord'] == " desc") {
