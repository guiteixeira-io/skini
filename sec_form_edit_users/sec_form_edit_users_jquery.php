...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_login_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_sec_form_edit_users_login_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_pswd_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_sec_form_edit_users_pswd_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_name_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_sec_form_edit_users_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_email_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_sec_form_edit_users_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_active' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_active_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_sec_form_edit_users_active_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_sec_form_edit_users_active_onfocus(this, iSeqRow) });
  $('#id_sc_field_activation_code' + iSeqRow).bind('change', function() { sc_sec_form_edit_users_activation_code_onchange(this, iSeqRow) });
  $('#id_sc_field_priv_admin' + iSeqRow).bind('change', function() { sc_sec_form_edit_users_priv_admin_onchange(this, iSeqRow) });
  $('#id_sc_field_mfa' + iSeqRow).bind('change', function() { sc_sec_form_edit_users_mfa_onchange(this, iSeqRow) });
  $('#id_sc_field_picture' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_picture_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_sec_form_edit_users_picture_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_sec_form_edit_users_picture_onfocus(this, iSeqRow) });
  $('#id_sc_field_groups' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_groups_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_sec_form_edit_users_groups_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_confirm_pswd' + iSeqRow).bind('blur', function() { sc_sec_form_edit_users_confirm_pswd_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_sec_form_edit_users_confirm_pswd_onchange(this, iSeqRow) })
...
function sc_sec_form_edit_users_login_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_form_edit_users_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_form_edit_users_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_form_edit_users_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_form_edit_users_active_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_form_edit_users_activation_code_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_sec_form_edit_users_priv_admin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_sec_form_edit_users_mfa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_sec_form_edit_users_picture_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_sec_form_edit_users_picture_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_sec_form_edit_users_picture_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
...
function sc_sec_form_edit_users_groups_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_sec_form_edit_users_confirm_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_picture" + iSeqRow).fileupload({
    datatype: "json",
    url: "sec_form_edit_users_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'sec_form_edit_users')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
