<?php  
  ...
  session_start() ;
  class sec_form_edit_users_form_teste
  {
   function sec_form_edit_users_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_form_edit_users/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_form_edit_users</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sec_form_edit_users"> 
</form> 
<script language=javascript> 
 document.Fedit.login.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new sec_form_edit_users_form_teste();
  $frm_teste->sec_form_edit_users_teste();
?>
