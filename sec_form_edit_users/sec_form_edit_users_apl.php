...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['sec_form_edit_users']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['sec_form_edit_users']['opc_ant'] = "inicio";
      }
      ...
      $_SESSION['sc_session'][$script_case_init]['sec_form_edit_users']['upload_field_info']['picture'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'sec_form_edit_users',
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users']['label'] = "" . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_form_edit_users']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->NM_ajax_info['param']['picture_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['upload_field_ul_name'][$this->picture_ul_name];
          }
      ...
      elseif (isset($this->picture_ul_name) && '' != $this->picture_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->picture_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['upload_field_ul_name'][$this->picture_ul_name];
          }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['buttonStatus'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['sec_form_edit_users'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['sec_form_edit_users'];
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['opc_ant'] : "";
      } 
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['sec_form_edit_users']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['sec_form_edit_users']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "sec_form_edit_users.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="sec_form_edit_users_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="sec_form_edit_users"> 
      ...
      if ($this->groups != "")
      {
          if (is_array($this->groups))
          {
              ...
              foreach ($this->groups_1 as $ind => $dados_groups_1 ) 
              {
                  ...
                  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_groups']) && !in_array($dados_groups_1, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_groups']))
                  {
                      $hasError = true;
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'sec_form_edit_users_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dados_form']['picture']) && $this->picture_limpa != "S")
          {
              $this->picture = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dados_form']['picture'];
          }
      } 
   }
...
$aLookup[] = array(sec_form_edit_users_pack_protect_string('Y') => str_replace('<', '&lt;',sec_form_edit_users_pack_protect_string("")));
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(sec_form_edit_users_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', sec_form_edit_users_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
...
<?php 
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Field_no_validate'] = array();
  ...
  if($this->pswd  != $this->confirm_pswd )
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_sec_form_edit_users';
...
$_SESSION['scriptcase']['sec_form_edit_users']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['where_filter'])
      {
...
//---------- 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['parms'] = "login?#?$this->login?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sub_dir'][0]  = "";
          } 
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['ordem_ord'] == " desc") {
