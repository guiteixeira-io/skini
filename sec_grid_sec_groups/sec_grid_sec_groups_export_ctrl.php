<?php
@session_start() ;
$_SESSION['scriptcase']['sec_grid_sec_groups']['sc_process_barr'] = true;
require_once('../sec_grid_sec_groups/index.php');
unset($_SESSION['scriptcase']['sec_grid_sec_groups']['sc_process_barr']);
$ExportCtrl = new sec_grid_sec_groups_export_control;
$ExportCtrl->Export_barr();

class sec_grid_sec_groups_export_control
{
