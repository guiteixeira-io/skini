<?php  
  ...
  session_start() ;
  class sec_form_sec_apps_form_teste
  {
   function sec_form_sec_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_form_sec_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_form_sec_apps</FONT></B> 
<br> 
<br> 
...
app_name&nbsp;&nbsp;<input type=text name=app_name size=20><br> 
<input type="submit" value="sec_form_sec_apps"> 
</form> 
<script language=javascript> 
 document.Fedit.app_name.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new sec_form_sec_apps_form_teste();
  $frm_teste->sec_form_sec_apps_teste();
?>
