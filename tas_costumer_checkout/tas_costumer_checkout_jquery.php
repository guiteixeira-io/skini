...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["lodge_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["lodge_" + iSeqRow] && scEventControl_data["lodge_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["lodge_" + iSeqRow] && scEventControl_data["lodge_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idcostumer_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_idcostumer__onchange(this, iSeqRow) });
  $('#id_sc_field_docnumber_' + iSeqRow).bind('blur', function() { sc_tas_costumer_checkout_docnumber__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_tas_costumer_checkout_docnumber__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_tas_costumer_checkout_docnumber__onfocus(this, iSeqRow) });
  $('#id_sc_field_doctype_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_doctype__onchange(this, iSeqRow) });
  $('#id_sc_field_firstname_' + iSeqRow).bind('blur', function() { sc_tas_costumer_checkout_firstname__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_tas_costumer_checkout_firstname__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_tas_costumer_checkout_firstname__onfocus(this, iSeqRow) });
  $('#id_sc_field_lastname_' + iSeqRow).bind('blur', function() { sc_tas_costumer_checkout_lastname__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_tas_costumer_checkout_lastname__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_tas_costumer_checkout_lastname__onfocus(this, iSeqRow) });
  $('#id_sc_field_idlodge_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_idlodge__onchange(this, iSeqRow) });
  $('#id_sc_field_frequencytype_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_frequencytype__onchange(this, iSeqRow) });
  $('#id_sc_field_holdertype_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_holdertype__onchange(this, iSeqRow) });
  $('#id_sc_field_idholder_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_idholder__onchange(this, iSeqRow) });
  $('#id_sc_field_statuslocate_' + iSeqRow).bind('change', function() { sc_tas_costumer_checkout_statuslocate__onchange(this, iSeqRow) });
  $('#id_sc_field_lodge_' + iSeqRow).bind('blur', function() { sc_tas_costumer_checkout_lodge__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_tas_costumer_checkout_lodge__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_tas_costumer_checkout_lodge__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_tas_costumer_checkout_idcostumer__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_docnumber__onblur(oThis, iSeqRow) {
  do_ajax_tas_costumer_checkout_validate_docnumber_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_docnumber__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_tas_costumer_checkout_docnumber__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_doctype__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_firstname__onblur(oThis, iSeqRow) {
  do_ajax_tas_costumer_checkout_validate_firstname_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_firstname__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_tas_costumer_checkout_firstname__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_lastname__onblur(oThis, iSeqRow) {
  do_ajax_tas_costumer_checkout_validate_lastname_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_lastname__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_tas_costumer_checkout_lastname__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_idlodge__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_frequencytype__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_holdertype__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_idholder__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_statuslocate__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_tas_costumer_checkout_lodge__onblur(oThis, iSeqRow) {
  do_ajax_tas_costumer_checkout_validate_lodge_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_tas_costumer_checkout_lodge__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  lookup_lodge_(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_tas_costumer_checkout_lodge__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("lodge_", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_lodge_(row, status);
}
...
function displayChange_field_lodge_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_tas_costumer_checkout_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'tas_costumer_checkout')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
