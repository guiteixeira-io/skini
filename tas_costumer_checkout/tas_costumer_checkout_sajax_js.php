  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_tas_costumer_checkout" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_tas_costumer_checkout_form();
	}
...
?>
  ...
  // ---------- Validate docnumber_
  function do_ajax_tas_costumer_checkout_validate_docnumber_(iNumLinha)
  {
    var nomeCampo_docnumber_ = "docnumber_" + iNumLinha;
    var var_docnumber_ = scAjaxGetFieldHidden(nomeCampo_docnumber_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkout_validate_docnumber_(var_docnumber_, iNumLinha, var_script_case_init, do_ajax_tas_costumer_checkout_validate_docnumber__cb);
  } // do_ajax_tas_costumer_checkout_validate_docnumber_

  function do_ajax_tas_costumer_checkout_validate_docnumber__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkout_validate_docnumber__cb

  // ---------- Validate firstname_
  function do_ajax_tas_costumer_checkout_validate_firstname_(iNumLinha)
  {
    var nomeCampo_firstname_ = "firstname_" + iNumLinha;
    var var_firstname_ = scAjaxGetFieldHidden(nomeCampo_firstname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkout_validate_firstname_(var_firstname_, iNumLinha, var_script_case_init, do_ajax_tas_costumer_checkout_validate_firstname__cb);
  } // do_ajax_tas_costumer_checkout_validate_firstname_

  function do_ajax_tas_costumer_checkout_validate_firstname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkout_validate_firstname__cb

  // ---------- Validate lastname_
  function do_ajax_tas_costumer_checkout_validate_lastname_(iNumLinha)
  {
    var nomeCampo_lastname_ = "lastname_" + iNumLinha;
    var var_lastname_ = scAjaxGetFieldHidden(nomeCampo_lastname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkout_validate_lastname_(var_lastname_, iNumLinha, var_script_case_init, do_ajax_tas_costumer_checkout_validate_lastname__cb);
  } // do_ajax_tas_costumer_checkout_validate_lastname_

  function do_ajax_tas_costumer_checkout_validate_lastname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkout_validate_lastname__cb

  // ---------- Validate lodge_
  function do_ajax_tas_costumer_checkout_validate_lodge_(iNumLinha)
  {
    var nomeCampo_lodge_ = "lodge_" + iNumLinha;
    var var_lodge_ = scAjaxGetFieldHidden(nomeCampo_lodge_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkout_validate_lodge_(var_lodge_, iNumLinha, var_script_case_init, do_ajax_tas_costumer_checkout_validate_lodge__cb);
  } // do_ajax_tas_costumer_checkout_validate_lodge_

  function do_ajax_tas_costumer_checkout_validate_lodge__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lodge_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lodge_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lodge_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lodge_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkout_validate_lodge__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_tas_costumer_checkout_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_tas_costumer_checkout_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_tas_costumer_checkout_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_tas_costumer_checkout_add_new_line_cb);
  } // do_ajax_tas_costumer_checkout_add_new_line

  function do_ajax_tas_costumer_checkout_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_tas_costumer_checkout_add_new_line_cb

  // ---------- backup_line
  function do_ajax_tas_costumer_checkout_backup_line(iNumLinha)
  {
    var var_idcostumer_ = scAjaxGetFieldText("idcostumer_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkout_backup_line(var_idcostumer_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_tas_costumer_checkout_backup_line_cb);
  } // do_ajax_tas_costumer_checkout_backup_line

  function do_ajax_tas_costumer_checkout_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_tas_costumer_checkout_backup_line_cb

  function do_ajax_tas_costumer_checkout_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_tas_costumer_checkout_cancel_insert

  function do_ajax_tas_costumer_checkout_cancel_update(iSeqVert)
  {
    do_ajax_tas_costumer_checkout_backup_line(iSeqVert);
...
?>
  } // do_ajax_tas_costumer_checkout_cancel_update

  function do_ajax_tas_costumer_checkout_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_tas_costumer_checkout_restore_buttons

  // ---------- table_refresh
  function do_ajax_tas_costumer_checkout_table_refresh()
  {
    var var_idcostumer_ = document.F2.idcostumer_.value;
    ...
    scAjaxProcOn();
    x_ajax_tas_costumer_checkout_table_refresh(var_idcostumer_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tas_costumer_checkout_table_refresh_cb);
  } //  do_ajax_tas_costumer_checkout_table_refresh

  function do_ajax_tas_costumer_checkout_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcostumer_.value = scAjaxGetKeyValue("idcostumer_");
    ...
    scAjaxAlert(do_ajax_tas_costumer_checkout_table_refresh_cb_after_alert);
  } // do_ajax_tas_costumer_checkout_table_refresh_cb
  function do_ajax_tas_costumer_checkout_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_tas_costumer_checkout_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_tas_costumer_checkout_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_tas_costumer_checkout_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_docnumber_ = scAjaxGetFieldHidden("docnumber_" + iNumLinha);
    var var_firstname_ = scAjaxGetFieldHidden("firstname_" + iNumLinha);
    var var_lastname_ = scAjaxGetFieldHidden("lastname_" + iNumLinha);
    var var_lodge_ = scAjaxGetFieldHidden("lodge_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_tas_costumer_checkout_submit_form(var_docnumber_, var_firstname_, var_lastname_, var_lodge_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_tas_costumer_checkout_submit_form_cb);
  } // do_ajax_tas_costumer_checkout_submit_form

  function do_ajax_tas_costumer_checkout_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("lodge_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_tas_costumer_checkout_submit_form_cb_after_alert);
  } // do_ajax_tas_costumer_checkout_submit_form_cb
  function do_ajax_tas_costumer_checkout_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_tas_costumer_checkout_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_tas_costumer_checkout_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_tas_costumer_checkout_navigate_form, function() {});
    } else {
      perform_ajax_tas_costumer_checkout_navigate_form();
    }
  }

  function perform_ajax_tas_costumer_checkout_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("lodge_" + iNavForm);
    }
    var var_idcostumer_ = document.F2.idcostumer_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_tas_costumer_checkout_navigate_form(var_idcostumer_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tas_costumer_checkout_navigate_form_cb);
  } // do_ajax_tas_costumer_checkout_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkout']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_tas_costumer_checkout_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcostumer_.value = scAjaxGetKeyValue("idcostumer_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_tas_costumer_checkout_navigate_form_cb_after_alert);
  } // do_ajax_tas_costumer_checkout_navigate_form_cb
  function do_ajax_tas_costumer_checkout_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_tas_costumer_checkout_navigate_form_cb_after_alert

    function sc_tas_costumer_checkout_get_last_line_number()
    {
    ...
    } //sc_tas_costumer_checkout_get_last_line_number

  function sc_hide_tas_costumer_checkout_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lodge_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["lodge_" + iNumLinha] = {"label": "Alojamento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ...
    ajax_field_mult["lodge_"][iNumLinha] = "lodge_" + iNumLinha;
    ...
    ajax_field_id["lodge_" + iNumLinha] = new Array("hidden_field_label_lodge_", "hidden_field_data_lodge_" + iNumLinha);
    ...
    ajax_error_count["lodge_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["lodge_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["lodge_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["lodge_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["lodge_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lodge_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lodge_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lodge_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lodge_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lodge_'])) ? $this->nmgp_cmp_readonly['lodge_'] : 'off';
?>
    scAjaxFieldRead("lodge_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("lodge_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["docnumber_" + iRow] || "on" == ajax_error_count["firstname_" + iRow] || "on" == ajax_error_count["lastname_" + iRow] || "on" == ajax_error_count["lodge_" + iRow]))
    {
      ...
      $("#hidden_field_data_lodge_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["docnumber_" + iRow] && "off" == ajax_error_count["firstname_" + iRow] && "off" == ajax_error_count["lastname_" + iRow] && "off" == ajax_error_count["lodge_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["lodge_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_lodge_" + iRow).removeClass("scFormErrorLine");
    }
  }
