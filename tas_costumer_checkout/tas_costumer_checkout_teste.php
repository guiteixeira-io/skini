<?php  
  ...
  session_start() ;
  class tas_costumer_checkout_form_teste
  {
   function tas_costumer_checkout_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "tas_costumer_checkout/img";
...
<?php
  ...
  $frm_teste = new tas_costumer_checkout_form_teste();
  $frm_teste->tas_costumer_checkout_teste();
?>
