...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""); } ?></TITLE>
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['last'] : 'off'); ?>";
...
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    ...
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['link_info']['remove_border']) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['last'];
        }
?>
...
?>
    ...
    var orderFieldList = ["app_name", "priv_access", "priv_insert", "priv_delete", "priv_update", "priv_export", "priv_print"];
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['balterarsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['balterarsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['balterarsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['balterarsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['balterarsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['btn_label']['exit'];
        }
?>
