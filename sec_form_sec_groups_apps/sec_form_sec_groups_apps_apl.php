...
$_SESSION['scriptcase']['sec_form_sec_groups_apps']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_sec_groups_apps']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_sec_groups_apps']['label'] = "" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_form_sec_groups_apps']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . "") ?></TITLE>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_list_apps_x_groups'] . ""; } ?></div>
