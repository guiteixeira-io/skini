<?php  
  ...
  session_start() ;
  class sec_form_sec_groups_apps_form_teste
  {
   function sec_form_sec_groups_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_form_sec_groups_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_form_sec_groups_apps</FONT></B> 
<br> 
<br> 
...
group&nbsp;&nbsp;<input type="text" name="group" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="sec_form_sec_groups_apps"> 
</form> 
<script language=javascript> 
 document.Fedit.group.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new sec_form_sec_groups_apps_form_teste();
  $frm_teste->sec_form_sec_groups_apps_teste();
?>
