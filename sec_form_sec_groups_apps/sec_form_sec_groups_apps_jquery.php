...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_group_id_' + iSeqRow).bind('change', function() { sc_sec_form_sec_groups_apps_group_id__onchange(this, iSeqRow) });
...
function sc_sec_form_sec_groups_apps_group_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'sec_form_sec_groups_apps')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
