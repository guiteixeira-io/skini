<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idaggregate_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idaggregate_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="sub_aggregate"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_sub_aggregate_submit_form(y, z);
