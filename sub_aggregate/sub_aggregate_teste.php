<?php  
  ...
  session_start() ;
  class sub_aggregate_form_teste
  {
   function sub_aggregate_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sub_aggregate/img";
...
<?php
  ...
  $frm_teste = new sub_aggregate_form_teste();
  $frm_teste->sub_aggregate_teste();
?>
