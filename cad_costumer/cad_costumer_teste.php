<?php  
  ...
  session_start() ;
  class cad_costumer_form_teste
  {
   function cad_costumer_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cad_costumer/img";
...
?> 
<br> 
<B><FONT SIZE="4">cad_costumer</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cad_costumer"> 
</form> 
...
<?php
  ...
  $frm_teste = new cad_costumer_form_teste();
  $frm_teste->cad_costumer_teste();
?>
