<?php  
  ...
  session_start() ;
  class tas_costumerCheck_in_form_teste
  {
   function tas_costumerCheck_in_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "tas_costumerCheck_in/img";
...
?> 
<br> 
<B><FONT SIZE="4">tas_costumerCheck_in</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="tas_costumerCheck_in"> 
</form> 
...
<?php
  ...
  $frm_teste = new tas_costumerCheck_in_form_teste();
  $frm_teste->tas_costumerCheck_in_teste();
?>
