...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["accommodation"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["accommodation"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["accommodation"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($accommodation_menuData["data"]) && is_array($accommodation_menuData["data"]) && !empty($accommodation_menuData["data"]))
    {
        foreach($accommodation_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($accommodation_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
