<?php
include_once('accommodation_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['accommodation']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['accommodation']['glo_nm_conexao']        = "skini";
    $_SESSION['scriptcase']['accommodation']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['accommodation']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['accommodation']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['accommodation']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
...
class accommodation_class
{
 ...
 function accommodation_menu()
 {
    global $accommodation_menuData, $nm_data_fixa;
...
$path_libs      = $str_root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "accommodation/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('accommodation');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/accommodation_erro.php");
}
include_once(dirname(__FILE__) . "/accommodation_erro.class.php"); 
$this->Erro = new accommodation_erro();
$str_path = substr($_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['accommodation']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$accommodation_menuData         = array();
$accommodation_menuData['path'] = array();
$accommodation_menuData['url']  = array();
$accommodation_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $accommodation_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $accommodation_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $accommodation_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $accommodation_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$accommodation_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$accommodation_menuData['url']['web']   = str_replace("\\", '/', $accommodation_menuData['url']['web']);
$accommodation_menuData['path']['root'] = substr($accommodation_menuData['path']['sys'],  0, -1 * strlen($accommodation_menuData['url']['web']));
$accommodation_menuData['path']['app']  = substr($accommodation_menuData['path']['sys'],  0, strrpos($accommodation_menuData['path']['sys'],  '/'));
$accommodation_menuData['path']['link'] = substr($accommodation_menuData['path']['app'],  0, strrpos($accommodation_menuData['path']['app'],  '/'));
$accommodation_menuData['path']['link'] = substr($accommodation_menuData['path']['link'], 0, strrpos($accommodation_menuData['path']['link'], '/')) . '/';
$accommodation_menuData['path']['app'] .= '/';
$accommodation_menuData['url']['app']   = substr($accommodation_menuData['url']['web'],  0, strrpos($accommodation_menuData['url']['web'],  '/'));
$accommodation_menuData['url']['link']  = substr($accommodation_menuData['url']['app'],  0, strrpos($accommodation_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['accommodation']['glo_nm_usa_grupo'] == "S")
{
    $accommodation_menuData['url']['link']  = substr($accommodation_menuData['url']['link'], 0, strrpos($accommodation_menuData['url']['link'], '/'));
}
$accommodation_menuData['url']['link']  .= '/';
$accommodation_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['accommodation']['sc_apl_link'] = $accommodation_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['accommodation']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['accommodation']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['accommodation']['actual_lang']) || $_SESSION['scriptcase']['accommodation']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['accommodation']['actual_lang'] = $this->str_lang;
...
include_once("accommodation_toolbar.php");
...
if ($_SESSION['scriptcase']['accommodation']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "accommodation";
     $_SESSION['scriptcase']['menu_apls']['accommodation'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['accommodation']['glo_nm_conexao']) && $_SESSION['scriptcase']['accommodation']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['accommodation']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['accommodation']['glo_nm_perfil']) && $_SESSION['scriptcase']['accommodation']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['accommodation']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['accommodation']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['accommodation']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['accommodation']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['accommodation']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['accommodation']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['accommodation']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['accommodation']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['accommodation']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['accommodation']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['accommodation']['init']))
{
    $_SESSION['sc_session'][1]['accommodation']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['accommodation']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['accommodation']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_accommodation'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_accommodation'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_accommodation'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
if (!isset($_SESSION['scriptcase']['accommodation']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['accommodation']) || $_SESSION['scriptcase']['sc_apl_seg']['accommodation'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'accommodation'))
{
    $_SESSION['sc_session'][1]['accommodation']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_accommodation'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$accommodation_menuData['iframe'] = TRUE;
...
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['accommodation']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'accommodation');
    $accommodation_menuData['data'] = $str_menu_usu;
}
if (is_file("accommodation_help.txt"))
{
    $Arq_WebHelp = file("accommodation_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $accommodation_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->accommodation_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['accommodation']) && !empty($_SESSION['scriptcase']['sc_menu_del']['accommodation']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($accommodation_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['accommodation']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($accommodation_menuData['data'][$i_menu]);
       }
    ...
    $accommodation_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['accommodation']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['accommodation']))
{
    $disable_menu = false;
    foreach ($accommodation_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['accommodation']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $accommodation_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($accommodation_menuData['iframe'])
{
    $accommodation_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $accommodation_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="accommodation_message.js"></script>
...
Iframe_atual = "accommodation_iframe";
...
{
  if (str_id != "iframe_accommodation")
  {
      str_id        = str_id.replace("accommodation_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_accommodation').length)
        $('#iframe_accommodation')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $accommodation_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->accommodation_escreveMenu($accommodation_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $accommodation_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
/* Controle de Target */
function accommodation_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function accommodation_target($str_target)
{
    global $accommodation_menuData;
    ...
    elseif ($accommodation_menuData['iframe'])
    {
        return 'accommodation_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $accommodation_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "accommodation_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($accommodation_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['accommodation']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "accommodation_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($accommodation_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['accommodation']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->accommodation_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['accommodation']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['accommodation']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "accommodation") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['accommodation']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['accommodation']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['accommodation']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_skini'])) {
            $_SESSION['scriptcase']['accommodation']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_skini'];
        }
    }
}
...
$contr_accommodation = new accommodation_class;
$contr_accommodation->accommodation_menu();
