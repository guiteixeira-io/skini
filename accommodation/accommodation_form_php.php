...
class accommodation_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['accommodation']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['accommodation']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['accommodation']['sc_apl_link'];
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="accommodation"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "accommodation")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'accommodation', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new accommodation_form_php();
$controle->init();
?>
