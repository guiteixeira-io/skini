  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cad_costumer_check" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_cad_costumer_check_form();
	}
...
?>
  ...
  function do_ajax_cad_costumer_check_validate_idcostumercheck()
  {
    ...
    x_ajax_cad_costumer_check_validate_idcostumercheck(var_idcostumercheck, var_script_case_init, do_ajax_cad_costumer_check_validate_idcostumercheck_cb);
  } // do_ajax_cad_costumer_check_validate_idcostumercheck

  function do_ajax_cad_costumer_check_validate_idcostumercheck_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_check_validate_idcostumercheck_cb

  // ---------- Validate idcostumer
  function do_ajax_cad_costumer_check_validate_idcostumer()
  {
    var nomeCampo_idcostumer = "idcostumer";
    var var_idcostumer = scAjaxGetFieldSelect(nomeCampo_idcostumer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_check_validate_idcostumer(var_idcostumer, var_script_case_init, do_ajax_cad_costumer_check_validate_idcostumer_cb);
  } // do_ajax_cad_costumer_check_validate_idcostumer

  function do_ajax_cad_costumer_check_validate_idcostumer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_check_validate_idcostumer_cb

  // ---------- Validate idlodge
  function do_ajax_cad_costumer_check_validate_idlodge()
  {
    var nomeCampo_idlodge = "idlodge";
    var var_idlodge = scAjaxGetFieldSelect(nomeCampo_idlodge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_check_validate_idlodge(var_idlodge, var_script_case_init, do_ajax_cad_costumer_check_validate_idlodge_cb);
  } // do_ajax_cad_costumer_check_validate_idlodge

  function do_ajax_cad_costumer_check_validate_idlodge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idlodge";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_check_validate_idlodge_cb

  // ---------- Validate sc_field_0
  function do_ajax_cad_costumer_check_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldSelect(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_check_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_cad_costumer_check_validate_sc_field_0_cb);
  } // do_ajax_cad_costumer_check_validate_sc_field_0

  function do_ajax_cad_costumer_check_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_check_validate_sc_field_0_cb

  // ---------- Validate timecheck
  function do_ajax_cad_costumer_check_validate_timecheck()
  {
    var nomeCampo_timecheck = "timecheck";
    var var_timecheck = scAjaxGetFieldHidden(nomeCampo_timecheck);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_check_validate_timecheck(var_timecheck, var_script_case_init, do_ajax_cad_costumer_check_validate_timecheck_cb);
  } // do_ajax_cad_costumer_check_validate_timecheck

  function do_ajax_cad_costumer_check_validate_timecheck_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_check_validate_timecheck_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cad_costumer_check_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cad_costumer_check_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cad_costumer_check_submit_form(var_idcostumercheck, var_idcostumer, var_idlodge, var_sc_field_0, var_timecheck, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_costumer_check_submit_form_cb);
  } // do_ajax_cad_costumer_check_submit_form

  function do_ajax_cad_costumer_check_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cad_costumer_check_submit_form_cb_after_alert);
  } // do_ajax_cad_costumer_check_submit_form_cb
  function do_ajax_cad_costumer_check_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cad_costumer_check_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cad_costumer_check_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cad_costumer_check_navigate_form, function() {});
    } else {
      perform_ajax_cad_costumer_check_navigate_form();
    }
  }

  function perform_ajax_cad_costumer_check_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cad_costumer_check_navigate_form(var_idcostumercheck, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cad_costumer_check_navigate_form_cb);
  } // do_ajax_cad_costumer_check_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumer_check']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cad_costumer_check_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cad_costumer_check_navigate_form_cb_after_alert);
  } // do_ajax_cad_costumer_check_navigate_form_cb
  function do_ajax_cad_costumer_check_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cad_costumer_check_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cad_costumer_check_navigate_form_cb_after_alert

  function sc_hide_cad_costumer_check_form()
  {
