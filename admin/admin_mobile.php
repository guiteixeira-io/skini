...
<html>
    <head>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["admin"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["admin"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($admin_menuData["data"]) && is_array($admin_menuData["data"]) && !empty($admin_menuData["data"]))
    {
        foreach($admin_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($admin_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
