...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['admin']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['admin']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['admin']['glo_nm_conexao']        = "";
    $_SESSION['scriptcase']['admin']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['admin']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['admin']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['admin']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['admin']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
...
class admin_class
{
 ...
 function admin_menu()
 {
    global $admin_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['admin']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['admin']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['admin']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['admin']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "admin/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['admin']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('admin');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/admin_erro.php");
}
include_once(dirname(__FILE__) . "/admin_erro.class.php"); 
$this->Erro = new admin_erro();
$str_path = substr($_SESSION['scriptcase']['admin']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['admin']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['admin']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$admin_menuData         = array();
$admin_menuData['path'] = array();
$admin_menuData['url']  = array();
$admin_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $admin_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $admin_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $admin_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $admin_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$admin_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$admin_menuData['url']['web']   = str_replace("\\", '/', $admin_menuData['url']['web']);
$admin_menuData['path']['root'] = substr($admin_menuData['path']['sys'],  0, -1 * strlen($admin_menuData['url']['web']));
$admin_menuData['path']['app']  = substr($admin_menuData['path']['sys'],  0, strrpos($admin_menuData['path']['sys'],  '/'));
$admin_menuData['path']['link'] = substr($admin_menuData['path']['app'],  0, strrpos($admin_menuData['path']['app'],  '/'));
$admin_menuData['path']['link'] = substr($admin_menuData['path']['link'], 0, strrpos($admin_menuData['path']['link'], '/')) . '/';
$admin_menuData['path']['app'] .= '/';
$admin_menuData['url']['app']   = substr($admin_menuData['url']['web'],  0, strrpos($admin_menuData['url']['web'],  '/'));
$admin_menuData['url']['link']  = substr($admin_menuData['url']['app'],  0, strrpos($admin_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] == "S")
{
    $admin_menuData['url']['link']  = substr($admin_menuData['url']['link'], 0, strrpos($admin_menuData['url']['link'], '/'));
}
$admin_menuData['url']['link']  .= '/';
$admin_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['admin']['sc_apl_link'] = $admin_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['admin']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['admin']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['admin']['actual_lang']) || $_SESSION['scriptcase']['admin']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['admin']['actual_lang'] = $this->str_lang;
...
include_once("admin_toolbar.php");
...
if ($_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "admin";
     $_SESSION['scriptcase']['menu_apls']['admin'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['admin']['glo_nm_conexao']) && $_SESSION['scriptcase']['admin']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['admin']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['admin']['glo_nm_perfil']) && $_SESSION['scriptcase']['admin']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['admin']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['admin']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['admin']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['admin']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['admin']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['admin']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['admin']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['admin']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['admin']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['admin']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['admin']['init']))
{
    $_SESSION['sc_session'][1]['admin']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['admin']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['admin']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_admin'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_admin'] = $nm_url_saida;
}
else
{
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['admin']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['admin']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'admin'))
{
    $_SESSION['sc_session'][1]['admin']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_admin'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$admin_menuData['iframe'] = TRUE;
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_settings_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_settings_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_add_2fa_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_add_2fa_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_sync_apps_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_sync_apps_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_search_sec_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_search_sec_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_users_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_users_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_apps_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_apps_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_users_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_grid_sec_users_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_1&sc_apl_menu=sec_settings&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_settings']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_settings']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_2&sc_apl_menu=sec_change_pswd&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_3&sc_apl_menu=sec_add_2fa&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_add_2fa']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_add_2fa']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_4&sc_apl_menu=sec_sync_apps&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_5&sc_apl_menu=sec_search_sec_groups&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_6&sc_apl_menu=sec_grid_sec_users_groups&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_7&sc_apl_menu=sec_grid_sec_groups&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_8&sc_apl_menu=sec_grid_sec_apps&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "admin_form_php.php?sc_item_menu=item_9&sc_apl_menu=sec_grid_sec_users&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['admin']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['admin']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'admin');
    $admin_menuData['data'] = $str_menu_usu;
}
if (is_file("admin_help.txt"))
{
    $Arq_WebHelp = file("admin_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $admin_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->admin_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['admin']) && !empty($_SESSION['scriptcase']['sc_menu_del']['admin']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($admin_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['admin']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($admin_menuData['data'][$i_menu]);
       }
    ...
    $admin_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['admin']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['admin']))
{
    $disable_menu = false;
    foreach ($admin_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['admin']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $admin_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($admin_menuData['iframe'])
{
    $admin_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['admin']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $admin_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['admin']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['admin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['admin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="admin_message.js"></script>
...
{
  if (str_id != "iframe_admin")
  {
      str_id        = str_id.replace("admin_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_admin', 'admin');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_admin').length)
        $('#iframe_admin')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $admin_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->admin_escreveMenu($admin_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $admin_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_admin');\" item-href=\"admin_form_php.php?sc_item_menu=admin&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . "\"  item-target=\"admin_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "admin_pag_ini.php");
} 
?>
      <iframe id="iframe_admin" name="admin_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_admin').click()";
    echo "</script>";
}
...
/* Controle de Target */
function admin_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function admin_target($str_target)
{
    global $admin_menuData;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $admin_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "admin_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "admin_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($admin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['admin']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->admin_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['admin']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['admin']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "admin") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['admin']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['admin']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['admin']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_skini'])) {
            $_SESSION['scriptcase']['admin']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_skini'];
        }
    }
}
...
$contr_admin = new admin_class;
$contr_admin->admin_menu();
