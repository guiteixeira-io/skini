<?php  
  ...
  session_start() ;
  class sec_sync_apps_form_teste
  {
   function sec_sync_apps_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_sync_apps/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_sync_apps</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sec_sync_apps"> 
</form> 
...
<?php
  ...
  $frm_teste = new sec_sync_apps_form_teste();
  $frm_teste->sec_sync_apps_teste();
?>
