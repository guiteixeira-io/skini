<?php  
  ...
  session_start() ;
  class img_menu_form_teste
  {
  function img_menu_teste()
  {
...
<?php
  ...
  $frm_teste = new img_menu_form_teste();
  $frm_teste->img_menu_teste();
?>
