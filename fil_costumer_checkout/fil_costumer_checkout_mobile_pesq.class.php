...
class fil_costumer_checkout_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . fil_costumer_checkout_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . fil_costumer_checkout_pack_protect_string($Tipo_filter[0]) . "\">.." . fil_costumer_checkout_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('tas_costumer_checkout') . "/";
?>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>fil_costumer_checkout/fil_costumer_checkout_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="fil_costumer_checkout_ajax_search.js"></script>
 <script type="text/javascript" src="fil_costumer_checkout_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="fil_costumer_checkout_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['fil_costumer_checkout']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['fil_costumer_checkout']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if ((isset($this->nm_mens_alert) && count($this->nm_mens_alert)) || (isset($this->Ini->nm_mens_alert) && count($this->Ini->nm_mens_alert))) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_idlodge#NMF#' + search_get_select('SC_idlodge') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fil_costumer_checkout']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['fil_costumer_checkout']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['fil_costumer_checkout']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("fil_costumer_checkout", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idlodge = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']['idlodge']; 
          $idlodge_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']['idlodge_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idlodge_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idlodge'])) ? $this->New_label['idlodge'] : "Id Lodge"; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idlodge" <?php echo $str_hide_idlodge?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idlodge'])) ? $this->New_label['idlodge'] : "Id Lodge";
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['psq_check_ret']['idlodge'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['psq_check_ret']['idlodge'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_idlodge">
      <SELECT class="scFilterObjectOdd" id="SC_idlodge" name="idlodge"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $idlodge)
            {
                    $idlodge_sel = ($nm_opc_cod === $idlodge) ? "selected" : "";
            }
            else
            {
...
?>
<?php
   if (is_file("fil_costumer_checkout_help.txt"))
   {
      $Arq_WebHelp = file("fil_costumer_checkout_help.txt"); 
...
<?php
   ...
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['dashboard_info']['under_dashboard'])
   { }
   else
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "skini/fil_costumer_checkout";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("pt_br");
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "fil_costumer_checkout/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $idlodge_cond, $idlodge, $nmgp_tab_label;
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($idlodge, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['psq_check_ret']['idlodge'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Id Lodge : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']['idlodge'] = $idlodge; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']['idlodge_cond'] = $idlodge_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['cond_dyn_search'] = "";
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['fil_costumer_checkout']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkout']['where_filtro'] = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkout']['where_filter'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "idlodge" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
