<?php  
  ...
  session_start() ;
  class fil_costumer_checkout_form_teste
  {
  function fil_costumer_checkout_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">fil_costumer_checkout</FONT></B> 
<br> 
<br> 
...
<input type=submit value="fil_costumer_checkout"> 
</form> 
...
<?php
  ...
  $frm_teste = new fil_costumer_checkout_form_teste();
  $frm_teste->fil_costumer_checkout_teste();
?>
