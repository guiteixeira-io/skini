...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____fil_costumer_checkout"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____fil_costumer_checkout"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['tas_costumer_checkout'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>fil_costumer_checkout</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['fil_costumer_checkout']['embutida_filho'] as $ind => $sc_init)
          {
