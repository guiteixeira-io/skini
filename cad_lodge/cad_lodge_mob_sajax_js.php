  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cad_lodge_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idlodge
  function do_ajax_cad_lodge_mob_validate_idlodge()
  {
    var nomeCampo_idlodge = "idlodge";
    var var_idlodge = scAjaxGetFieldHidden(nomeCampo_idlodge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_mob_validate_idlodge(var_idlodge, var_script_case_init, do_ajax_cad_lodge_mob_validate_idlodge_cb);
  } // do_ajax_cad_lodge_mob_validate_idlodge

  function do_ajax_cad_lodge_mob_validate_idlodge_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_mob_validate_idlodge_cb

  // ---------- Validate idlodgecategory
  function do_ajax_cad_lodge_mob_validate_idlodgecategory()
  {
    var nomeCampo_idlodgecategory = "idlodgecategory";
    var var_idlodgecategory = scAjaxGetFieldSelect(nomeCampo_idlodgecategory);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_mob_validate_idlodgecategory(var_idlodgecategory, var_script_case_init, do_ajax_cad_lodge_mob_validate_idlodgecategory_cb);
  } // do_ajax_cad_lodge_mob_validate_idlodgecategory

  function do_ajax_cad_lodge_mob_validate_idlodgecategory_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_mob_validate_idlodgecategory_cb

  // ---------- Validate number
  function do_ajax_cad_lodge_mob_validate_number()
  {
    var nomeCampo_number = "number";
    var var_number = scAjaxGetFieldText(nomeCampo_number);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_mob_validate_number(var_number, var_script_case_init, do_ajax_cad_lodge_mob_validate_number_cb);
  } // do_ajax_cad_lodge_mob_validate_number

  function do_ajax_cad_lodge_mob_validate_number_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "number";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_mob_validate_number_cb

  // ---------- Validate name
  function do_ajax_cad_lodge_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_mob_validate_name(var_name, var_script_case_init, do_ajax_cad_lodge_mob_validate_name_cb);
  } // do_ajax_cad_lodge_mob_validate_name

  function do_ajax_cad_lodge_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_mob_validate_name_cb

  // ---------- Validate status
  function do_ajax_cad_lodge_mob_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_lodge_mob_validate_status(var_status, var_script_case_init, do_ajax_cad_lodge_mob_validate_status_cb);
  } // do_ajax_cad_lodge_mob_validate_status

  function do_ajax_cad_lodge_mob_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_lodge_mob_validate_status_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cad_lodge_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cad_lodge_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cad_lodge_mob_submit_form(var_idlodge, var_idlodgecategory, var_number, var_name, var_status, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_lodge_mob_submit_form_cb);
  } // do_ajax_cad_lodge_mob_submit_form

  function do_ajax_cad_lodge_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cad_lodge_mob_submit_form_cb_after_alert);
  } // do_ajax_cad_lodge_mob_submit_form_cb
  function do_ajax_cad_lodge_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cad_lodge_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cad_lodge_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cad_lodge_mob_navigate_form, function() {});
    } else {
      perform_ajax_cad_lodge_mob_navigate_form();
    }
  }

  function perform_ajax_cad_lodge_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cad_lodge_mob_navigate_form(var_idlodge, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cad_lodge_mob_navigate_form_cb);
  } // do_ajax_cad_lodge_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_lodge_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cad_lodge_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cad_lodge_mob_navigate_form_cb_after_alert);
  } // do_ajax_cad_lodge_mob_navigate_form_cb
  function do_ajax_cad_lodge_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cad_lodge_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cad_lodge_mob_navigate_form_cb_after_alert

  function sc_hide_cad_lodge_mob_form()
  {
