...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']))
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['cad_lodge']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cad_lodge']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cad_lodge']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['cad_lodge']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['cad_lodge']['db_changed'])
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cad_lodge']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cad_lodge']['embutida_filho'] as $ind => $sc_init)
          {
