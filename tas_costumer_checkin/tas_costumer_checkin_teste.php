<?php  
  ...
  session_start() ;
  class tas_costumer_checkin_form_teste
  {
   function tas_costumer_checkin_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "tas_costumer_checkin/img";
...
?> 
<br> 
<B><FONT SIZE="4">tas_costumer_checkin</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="tas_costumer_checkin"> 
</form> 
...
<?php
  ...
  $frm_teste = new tas_costumer_checkin_form_teste();
  $frm_teste->tas_costumer_checkin_teste();
?>
