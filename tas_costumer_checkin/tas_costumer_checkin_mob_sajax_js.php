  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_tas_costumer_checkin_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_tas_costumer_checkin_mob_form();
	}
...
?>
  ...
  // ---------- Validate docnumber
  function do_ajax_tas_costumer_checkin_mob_validate_docnumber()
  {
    var nomeCampo_docnumber = "docnumber";
    var var_docnumber = scAjaxGetFieldHidden(nomeCampo_docnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkin_mob_validate_docnumber(var_docnumber, var_script_case_init, do_ajax_tas_costumer_checkin_mob_validate_docnumber_cb);
  } // do_ajax_tas_costumer_checkin_mob_validate_docnumber

  function do_ajax_tas_costumer_checkin_mob_validate_docnumber_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkin_mob_validate_docnumber_cb

  // ---------- Validate firstname
  function do_ajax_tas_costumer_checkin_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldHidden(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkin_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_tas_costumer_checkin_mob_validate_firstname_cb);
  } // do_ajax_tas_costumer_checkin_mob_validate_firstname

  function do_ajax_tas_costumer_checkin_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkin_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_tas_costumer_checkin_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldHidden(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkin_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_tas_costumer_checkin_mob_validate_lastname_cb);
  } // do_ajax_tas_costumer_checkin_mob_validate_lastname

  function do_ajax_tas_costumer_checkin_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkin_mob_validate_lastname_cb

  // ---------- Validate lodge
  function do_ajax_tas_costumer_checkin_mob_validate_lodge()
  {
    var nomeCampo_lodge = "lodge";
    var var_lodge = scAjaxGetFieldHidden(nomeCampo_lodge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_tas_costumer_checkin_mob_validate_lodge(var_lodge, var_script_case_init, do_ajax_tas_costumer_checkin_mob_validate_lodge_cb);
  } // do_ajax_tas_costumer_checkin_mob_validate_lodge

  function do_ajax_tas_costumer_checkin_mob_validate_lodge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lodge";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_tas_costumer_checkin_mob_validate_lodge_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_tas_costumer_checkin_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_tas_costumer_checkin_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_docnumber = scAjaxGetFieldHidden("docnumber");
    var var_firstname = scAjaxGetFieldHidden("firstname");
    var var_lastname = scAjaxGetFieldHidden("lastname");
    var var_lodge = scAjaxGetFieldHidden("lodge");
    ...
    scAjaxProcOn();
    x_ajax_tas_costumer_checkin_mob_submit_form(var_docnumber, var_firstname, var_lastname, var_lodge, var_idcostumer, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_tas_costumer_checkin_mob_submit_form_cb);
  } // do_ajax_tas_costumer_checkin_mob_submit_form

  function do_ajax_tas_costumer_checkin_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_tas_costumer_checkin_mob_submit_form_cb_after_alert);
  } // do_ajax_tas_costumer_checkin_mob_submit_form_cb
  function do_ajax_tas_costumer_checkin_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_tas_costumer_checkin_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_tas_costumer_checkin_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_tas_costumer_checkin_mob_navigate_form, function() {});
    } else {
      perform_ajax_tas_costumer_checkin_mob_navigate_form();
    }
  }

  function perform_ajax_tas_costumer_checkin_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_tas_costumer_checkin_mob_navigate_form(var_idcostumer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_tas_costumer_checkin_mob_navigate_form_cb);
  } // do_ajax_tas_costumer_checkin_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkin_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_tas_costumer_checkin_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_tas_costumer_checkin_mob_navigate_form_cb_after_alert);
  } // do_ajax_tas_costumer_checkin_mob_navigate_form_cb
  function do_ajax_tas_costumer_checkin_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_tas_costumer_checkin_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_tas_costumer_checkin_mob_navigate_form_cb_after_alert

  function sc_hide_tas_costumer_checkin_mob_form()
  {
  ...
  ajax_field_list[1] = "firstname";
  ajax_field_list[2] = "lastname";
  ajax_field_list[3] = "lodge";
  ...
  var ajax_error_list = {
    ...
    "lodge": {"label": "Alojamento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
