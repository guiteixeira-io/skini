<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idcostumer" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idcostumer']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkin']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkin']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="tas_costumer_checkin"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['tas_costumer_checkin']['where_detal']))
  {
?>  
...
function lookup_lodge(campo)
{
   dados  = document.F1.idlodge.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('tas_costumer_checkin')?>/tas_costumer_checkin.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_lodge, "lodge", dados, false);
}
function recebe_lodge(string)
{
   document.getElementById('id_lookup_lodge').innerHTML = string;
}
<?php 
