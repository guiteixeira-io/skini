<?php
@session_start() ;
$_SESSION['scriptcase']['que_costumers']['sc_process_barr'] = true;
require_once('../que_costumers/index.php');
unset($_SESSION['scriptcase']['que_costumers']['sc_process_barr']);
$ExportCtrl = new que_costumers_export_control;
$ExportCtrl->Export_barr();

class que_costumers_export_control
{
