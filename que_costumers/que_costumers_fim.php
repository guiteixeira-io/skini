...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____que_costumers"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____que_costumers"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cad_costumers'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['que_costumers']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['que_costumers']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['que_costumers']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['que_costumers']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['que_costumers']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['que_costumers']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['que_costumers']['embutida_filho'] as $ind => $sc_init)
          {
