...
class que_costumers_res_csv
{
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['csv_res_file'] = $this->Csv_f;
      }
