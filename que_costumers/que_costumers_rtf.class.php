...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "que_costumers.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_name']);
      }
   ...
   function NM_export_mobilephone()
   {
         ...
         $this->mobilephone = str_replace('<', '&lt;', $this->mobilephone);
         $this->mobilephone = str_replace('>', '&gt;', $this->mobilephone);
         $this->Texto_tag .= "<td>" . $this->mobilephone . "</td>\r\n";
   }
   //----- email
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['que_costumers']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> cad_costumers :: RTF</TITLE>
