<?php
@session_start() ;
$_SESSION['scriptcase']['sec_grid_sec_apps']['sc_process_barr'] = true;
require_once('../sec_grid_sec_apps/index.php');
unset($_SESSION['scriptcase']['sec_grid_sec_apps']['sc_process_barr']);
$ExportCtrl = new sec_grid_sec_apps_export_control;
$ExportCtrl->Export_barr();

class sec_grid_sec_apps_export_control
{
