...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____sec_grid_sec_apps"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____sec_grid_sec_apps"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['sec_form_sec_apps'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['sec_grid_sec_apps']['embutida_filho'] as $ind => $sc_init)
          {
