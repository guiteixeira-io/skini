...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["price_" + iNumLinha] = {"label": "Preço<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["quantitypersons_" + iNumLinha] = {"label": "Pessoas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
