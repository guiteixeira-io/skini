  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_sub_lodgePrice" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idlodgeprice_
  function do_ajax_sub_lodgePrice_validate_idlodgeprice_(iNumLinha)
  {
    var nomeCampo_idlodgeprice_ = "idlodgeprice_" + iNumLinha;
    var var_idlodgeprice_ = scAjaxGetFieldHidden(nomeCampo_idlodgeprice_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_lodgePrice_validate_idlodgeprice_(var_idlodgeprice_, iNumLinha, var_script_case_init, do_ajax_sub_lodgePrice_validate_idlodgeprice__cb);
  } // do_ajax_sub_lodgePrice_validate_idlodgeprice_

  function do_ajax_sub_lodgePrice_validate_idlodgeprice__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idlodgeprice_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idlodgeprice_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idlodgeprice_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idlodgeprice_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_lodgePrice_validate_idlodgeprice__cb

  // ---------- Validate idlodgecategory_
  function do_ajax_sub_lodgePrice_validate_idlodgecategory_(iNumLinha)
  {
    var nomeCampo_idlodgecategory_ = "idlodgecategory_" + iNumLinha;
    var var_idlodgecategory_ = scAjaxGetFieldSelect(nomeCampo_idlodgecategory_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_lodgePrice_validate_idlodgecategory_(var_idlodgecategory_, iNumLinha, var_script_case_init, do_ajax_sub_lodgePrice_validate_idlodgecategory__cb);
  } // do_ajax_sub_lodgePrice_validate_idlodgecategory_

  function do_ajax_sub_lodgePrice_validate_idlodgecategory__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idlodgecategory_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idlodgecategory_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idlodgecategory_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idlodgecategory_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_lodgePrice_validate_idlodgecategory__cb

  // ---------- Validate price_
  function do_ajax_sub_lodgePrice_validate_price_(iNumLinha)
  {
    var nomeCampo_price_ = "price_" + iNumLinha;
    var var_price_ = scAjaxGetFieldText(nomeCampo_price_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_lodgePrice_validate_price_(var_price_, iNumLinha, var_script_case_init, do_ajax_sub_lodgePrice_validate_price__cb);
  } // do_ajax_sub_lodgePrice_validate_price_

  function do_ajax_sub_lodgePrice_validate_price__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_lodgePrice_validate_price__cb

  // ---------- Validate quantitypersons_
  function do_ajax_sub_lodgePrice_validate_quantitypersons_(iNumLinha)
  {
    var nomeCampo_quantitypersons_ = "quantitypersons_" + iNumLinha;
    var var_quantitypersons_ = scAjaxGetFieldText(nomeCampo_quantitypersons_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_lodgePrice_validate_quantitypersons_(var_quantitypersons_, iNumLinha, var_script_case_init, do_ajax_sub_lodgePrice_validate_quantitypersons__cb);
  } // do_ajax_sub_lodgePrice_validate_quantitypersons_

  function do_ajax_sub_lodgePrice_validate_quantitypersons__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "quantitypersons_" + iLineNumber;
    }
    else
    {
      sFieldValid = "quantitypersons_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "quantitypersons_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "quantitypersons_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sub_lodgePrice_validate_quantitypersons__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_sub_lodgePrice_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_sub_lodgePrice_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sub_lodgePrice_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_sub_lodgePrice_add_new_line_cb);
  } // do_ajax_sub_lodgePrice_add_new_line

  function do_ajax_sub_lodgePrice_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_sub_lodgePrice_add_new_line_cb

  // ---------- backup_line
  function do_ajax_sub_lodgePrice_backup_line(iNumLinha)
  {
    var var_idlodgeprice_ = scAjaxGetFieldHidden("idlodgeprice_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sub_lodgePrice_backup_line(var_idlodgeprice_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_sub_lodgePrice_backup_line_cb);
  } // do_ajax_sub_lodgePrice_backup_line

  function do_ajax_sub_lodgePrice_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_sub_lodgePrice_backup_line_cb

  function do_ajax_sub_lodgePrice_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_sub_lodgePrice_cancel_insert

  function do_ajax_sub_lodgePrice_cancel_update(iSeqVert)
  {
    do_ajax_sub_lodgePrice_backup_line(iSeqVert);
...
?>
  } // do_ajax_sub_lodgePrice_cancel_update

  function do_ajax_sub_lodgePrice_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_sub_lodgePrice_restore_buttons

  // ---------- table_refresh
  function do_ajax_sub_lodgePrice_table_refresh()
  {
    var var_idlodgeprice_ = document.F2.idlodgeprice_.value;
    ...
    scAjaxProcOn();
    x_ajax_sub_lodgePrice_table_refresh(var_idlodgeprice_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_sub_lodgePrice_table_refresh_cb);
  } //  do_ajax_sub_lodgePrice_table_refresh

  function do_ajax_sub_lodgePrice_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idlodgeprice_.value = scAjaxGetKeyValue("idlodgeprice_");
    ...
    scAjaxAlert(do_ajax_sub_lodgePrice_table_refresh_cb_after_alert);
  } // do_ajax_sub_lodgePrice_table_refresh_cb
  function do_ajax_sub_lodgePrice_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_sub_lodgePrice_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_sub_lodgePrice_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_sub_lodgePrice_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idlodgeprice_ = scAjaxGetFieldHidden("idlodgeprice_" + iNumLinha);
    var var_idlodgecategory_ = scAjaxGetFieldSelect("idlodgecategory_" + iNumLinha);
    var var_price_ = scAjaxGetFieldText("price_" + iNumLinha);
    var var_quantitypersons_ = scAjaxGetFieldText("quantitypersons_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_sub_lodgePrice_submit_form(var_idlodgeprice_, var_idlodgecategory_, var_price_, var_quantitypersons_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sub_lodgePrice_submit_form_cb);
  } // do_ajax_sub_lodgePrice_submit_form

  function do_ajax_sub_lodgePrice_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idlodgeprice_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idlodgecategory_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("price_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("quantitypersons_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sub_lodgePrice_submit_form_cb_after_alert);
  } // do_ajax_sub_lodgePrice_submit_form_cb
  function do_ajax_sub_lodgePrice_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_sub_lodgePrice_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_sub_lodgePrice_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_sub_lodgePrice_navigate_form, function() {});
    } else {
      perform_ajax_sub_lodgePrice_navigate_form();
    }
  }

  function perform_ajax_sub_lodgePrice_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_sub_lodgePrice_cancel_insert(sc_sub_lodgePrice_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idlodgeprice_" + iNavForm);
      scAjaxHideErrorDisplay("idlodgecategory_" + iNavForm);
      scAjaxHideErrorDisplay("price_" + iNavForm);
      scAjaxHideErrorDisplay("quantitypersons_" + iNavForm);
    }
    var var_idlodgeprice_ = document.F2.idlodgeprice_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_sub_lodgePrice_navigate_form(var_idlodgeprice_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_sub_lodgePrice_navigate_form_cb);
  } // do_ajax_sub_lodgePrice_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sub_lodgePrice']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_sub_lodgePrice_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idlodgeprice_.value = scAjaxGetKeyValue("idlodgeprice_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_sub_lodgePrice_navigate_form_cb_after_alert);
  } // do_ajax_sub_lodgePrice_navigate_form_cb
  function do_ajax_sub_lodgePrice_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_sub_lodgePrice_navigate_form_cb_after_alert

    function sc_sub_lodgePrice_get_last_line_number()
    {
    ...
    } //sc_sub_lodgePrice_get_last_line_number

  function sc_hide_sub_lodgePrice_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idlodgeprice_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idlodgecategory_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "price_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quantitypersons_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idlodgeprice_" + iNumLinha] = {"label": "Id Lodge Price<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["idlodgecategory_" + iNumLinha] = {"label": "Lodge Category<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["price_" + iNumLinha] = {"label": "Price<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["quantitypersons_" + iNumLinha] = {"label": "Quantity Persons<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["idlodgeprice_"][iNumLinha] = "idlodgeprice_" + iNumLinha;
    ajax_field_mult["idlodgecategory_"][iNumLinha] = "idlodgecategory_" + iNumLinha;
    ajax_field_mult["price_"][iNumLinha] = "price_" + iNumLinha;
    ajax_field_mult["quantitypersons_"][iNumLinha] = "quantitypersons_" + iNumLinha;
    ajax_field_id["price_" + iNumLinha] = new Array("hidden_field_label_price_", "hidden_field_data_price_" + iNumLinha);
    ajax_field_id["quantitypersons_" + iNumLinha] = new Array("hidden_field_label_quantitypersons_", "hidden_field_data_quantitypersons_" + iNumLinha);
    ajax_error_count["idlodgeprice_" + iNumLinha] = "off";
    ajax_error_count["idlodgecategory_" + iNumLinha] = "off";
    ajax_error_count["price_" + iNumLinha] = "off";
    ajax_error_count["quantitypersons_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idlodgeprice_" + iNumLinha] = "on";
    ajax_read_only["idlodgecategory_" + iNumLinha] = "off";
    ajax_read_only["price_" + iNumLinha] = "off";
    ajax_read_only["quantitypersons_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idlodgeprice_" + iNumLinha] = "on";
    ajax_read_only["idlodgecategory_" + iNumLinha] = "on";
    ajax_read_only["price_" + iNumLinha] = "on";
    ajax_read_only["quantitypersons_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idlodgeprice_" + iNumLinha] = null;
    ajax_error_list["idlodgecategory_" + iNumLinha] = null;
    ajax_error_list["price_" + iNumLinha] = null;
    ajax_error_list["quantitypersons_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idlodgeprice_": new Array(),
    "idlodgecategory_": new Array(),
    "price_": new Array(),
    "quantitypersons_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idlodgeprice_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idlodgeprice_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idlodgeprice_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idlodgeprice_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idlodgeprice_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idlodgecategory_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idlodgecategory_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idlodgecategory_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idlodgecategory_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idlodgecategory_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["quantitypersons_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["quantitypersons_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["quantitypersons_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["quantitypersons_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["quantitypersons_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idlodgeprice_'])) ? $this->nmgp_cmp_readonly['idlodgeprice_'] : 'on';
?>
    scAjaxFieldRead("idlodgeprice_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idlodgecategory_'])) ? $this->nmgp_cmp_readonly['idlodgecategory_'] : 'off';
?>
    scAjaxFieldRead("idlodgecategory_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['quantitypersons_'])) ? $this->nmgp_cmp_readonly['quantitypersons_'] : 'off';
?>
    scAjaxFieldRead("quantitypersons_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idlodgeprice_" + iSeq, "on");
    scAjaxFieldRead("idlodgecategory_" + iSeq, "on");
    scAjaxFieldRead("price_" + iSeq, "on");
    scAjaxFieldRead("quantitypersons_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idlodgeprice_" + iRow] || "on" == ajax_error_count["idlodgecategory_" + iRow] || "on" == ajax_error_count["price_" + iRow] || "on" == ajax_error_count["quantitypersons_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idlodgeprice_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idlodgecategory_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_price_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quantitypersons_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idlodgeprice_" + iRow] && "off" == ajax_error_count["idlodgecategory_" + iRow] && "off" == ajax_error_count["price_" + iRow] && "off" == ajax_error_count["quantitypersons_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idlodgeprice_" + iRow] = "off";
        ajax_error_count["idlodgecategory_" + iRow] = "off";
        ajax_error_count["price_" + iRow] = "off";
        ajax_error_count["quantitypersons_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idlodgeprice_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idlodgecategory_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_price_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quantitypersons_" + iRow).removeClass("scFormErrorLine");
    }
  }
