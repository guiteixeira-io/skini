<?php  
  ...
  session_start() ;
  class sub_lodgePrice_form_teste
  {
   function sub_lodgePrice_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sub_lodgePrice/img";
...
<?php
  ...
  $frm_teste = new sub_lodgePrice_form_teste();
  $frm_teste->sub_lodgePrice_teste();
?>
