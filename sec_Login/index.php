...
//
   ...
   $_SESSION['scriptcase']['sec_Login']['glo_nm_path_cache']  = "C:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['sec_Login']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php81/wwwrootC:/Program Files/NetMake/v9-php81/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['sec_Login']['glo_nm_conexao']         = "skini";
   $NM_dir_atual = getcwd();
...
';
      ...
      if (!isset($_SESSION['sc_session'][$script_case_init]['sec_Login']['iframe_menu'])) {
          $_SESSION['sc_session'][$script_case_init]['sec_Login']['iframe_menu'] = "";
      }
      if (!isset($_SESSION['sc_session'][$script_case_init]['sec_Login']['run_iframe'])) {
          $_SESSION['sc_session'][$script_case_init]['sec_Login']['run_iframe'] = "";
      }
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['sec_Login']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['sec_Login']['link_info']['remove_border'] = true;
        }
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'skini', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'skini', 1, $this->force_db_utf8);
    }
    else {
...
;
	...
	if($this->sc_logged($this->sc_temp_usr_login)):
        ...
        if($this->sc_temp_sett_session_expire != 'N'){
            if (is_file($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_skini.txt")) {
    unlink($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_skini.txt");
}
if (is_file("../_lib/_app_data/sec_Login_ini.php")) {
    $SC_arq_def = fopen($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_skini.txt", "w");
    fwrite ($SC_arq_def, 'sec_Login, $this->sc_temp_sett_session_expire');
    fclose ($SC_arq_def);
    setcookie('sc_apl_default_skini','sec_Login, $this->sc_temp_sett_session_expire','0','/');
}
;
        }
     if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->path_link . "" . SC_dir_app_name('home') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };	
	endif;
}
if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
...
;
            $_SESSION['scriptcase']['sc_apl_seg']['sec_logged'] = "on";;
			 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->path_link . "" . SC_dir_app_name('sec_logged') . "/", $this->nm_location, "user?#?" . NM_encode_input($user) . "?@?", "modal", "ret_self", 440, 630);
 };
            return false;
        }
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off';
...
if (!isset($this->sc_temp_logged_user)) {$this->sc_temp_logged_user = (isset($_SESSION['logged_user'])) ? $_SESSION['logged_user'] : "";}
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->path_link . "" . SC_dir_app_name('sec_Login') . "/", $this->nm_location, "", "_parent", "ret_self", 440, 630);
 };
        }
if (isset($this->sc_temp_logged_user)) { $_SESSION['logged_user'] = $this->sc_temp_logged_user;}
if (isset($this->sc_temp_logged_date_login)) { $_SESSION['logged_date_login'] = $this->sc_temp_logged_date_login;}
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_skini'])) {
                $_SESSION['scriptcase']['sec_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_skini'];
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['sec_Login']['session_timeout']['redir']))
    {
        ...
        if ('ajax_sec_Login_validate_new_user' == $_POST['rs'])
        {
            $new_user = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_sec_Login_validate_retrieve_pswd' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (isset($_POST["remember_me"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['remember_me']);
        }
        ...
        if (isset($_POST["sett_remember_me"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_remember_me']);
        }
        ...
        if (isset($_POST["sett_enable_2fa"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_enable_2fa']);
        }
        ...
        if (isset($_POST["sett_cookie_expiration_time"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_cookie_expiration_time']);
        }
        ...
        if (isset($_POST["sett_session_expire"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_session_expire']);
        }
        ...
        if (isset($_POST["sett_new_users"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_new_users']);
        }
        ...
        if (isset($_POST["sett_retrieve_password"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_retrieve_password']);
        }
        ...
        if (isset($_POST["sett_brute_force"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_brute_force']);
        }
        ...
        if (isset($_POST["sett_brute_force_time_block"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_brute_force_time_block']);
        }
        ...
        if (isset($_POST["sett_brute_force_attempts"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_brute_force_attempts']);
        }
        ...
        if (isset($_POST["sett_enable_2fa_expiration_time"])) 
        {
            ...
            nm_limpa_str_sec_Login($_SESSION['sett_enable_2fa_expiration_time']);
        }
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['sec_Login']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['sec_Login']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['sec_Login']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['sec_Login']['volta_dep'] = (isset($nm_apl_dependente)) ? $nm_apl_dependente : "";
        ...
        $nm_url_saida      = (isset($_SESSION['sc_session'][$script_case_init]['sec_Login']['volta_php'])) ? $_SESSION['sc_session'][$script_case_init]['sec_Login']['volta_php'] : "";
        $nm_apl_dependente = (isset($_SESSION['sc_session'][$script_case_init]['sec_Login']['volta_dep'])) ? $_SESSION['sc_session'][$script_case_init]['sec_Login']['volta_dep'] : "";
        $nm_saida_global   = $nm_url_saida;
    ...
    sajax_export("ajax_sec_Login_validate_new_user");
    sajax_export("ajax_sec_Login_validate_retrieve_pswd");
...
//
    ...
    function ajax_sec_Login_validate_new_user($new_user, $script_case_init)
    {
        global $inicial_sec_Login;
        //register_shutdown_function("sec_Login_pack_ajax_response");
        $inicial_sec_Login->contr_sec_Login->NM_ajax_flag          = true;
        $inicial_sec_Login->contr_sec_Login->NM_ajax_opcao         = 'validate_new_user';
        $inicial_sec_Login->contr_sec_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_sec_Login_validate_retrieve_pswd($retrieve_pswd, $script_case_init)
    {
        global $inicial_sec_Login;
        //register_shutdown_function("sec_Login_pack_ajax_response");
        $inicial_sec_Login->contr_sec_Login->NM_ajax_flag          = true;
        $inicial_sec_Login->contr_sec_Login->NM_ajax_opcao         = 'validate_retrieve_pswd';
        $inicial_sec_Login->contr_sec_Login->NM_ajax_info['param'] = array(
    ...
    function ajax_sec_Login_submit_form($login, $pswd, $remember_me, $new_user, $retrieve_pswd, $new_user_sc_target_name, $retrieve_pswd_sc_target_name, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_sec_Login;
        //register_shutdown_function("sec_Login_pack_ajax_response");
        $inicial_sec_Login->contr_sec_Login->NM_ajax_flag          = true;
...
//-----
      {
         ...
         {
/* mantis 0021191 */            $inicial_sec_Login->contr_sec_Login->NM_ajax_info['buttonDisplay'] = $inicial_sec_Login->contr_sec_Login->nmgp_botoes;
