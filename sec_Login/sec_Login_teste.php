<?php  
  ...
  session_start() ;
  class sec_Login_form_teste
  {
   function sec_Login_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_Login/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_Login</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sec_Login"> 
</form> 
...
<?php
  ...
  $frm_teste = new sec_Login_form_teste();
  $frm_teste->sec_Login_teste();
?>
