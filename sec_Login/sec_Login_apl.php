...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->sett_brute_force_time_block) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['sett_brute_force_time_block'] = $this->sett_brute_force_time_block;
      }
      if (isset($this->sett_brute_force_attempts) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['sett_brute_force_attempts'] = $this->sett_brute_force_attempts;
      }
      ...
      if (isset($_POST["sett_brute_force_time_block"]) && isset($this->sett_brute_force_time_block)) 
      {
          $_SESSION['sett_brute_force_time_block'] = $this->sett_brute_force_time_block;
      }
      if (isset($_POST["sett_brute_force_attempts"]) && isset($this->sett_brute_force_attempts)) 
      {
          $_SESSION['sett_brute_force_attempts'] = $this->sett_brute_force_attempts;
      }
      ...
      if (isset($_GET["sett_brute_force_time_block"]) && isset($this->sett_brute_force_time_block)) 
      {
          $_SESSION['sett_brute_force_time_block'] = $this->sett_brute_force_time_block;
      }
      if (isset($_GET["sett_brute_force_attempts"]) && isset($this->sett_brute_force_attempts)) 
      {
          $_SESSION['sett_brute_force_attempts'] = $this->sett_brute_force_attempts;
      }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['sec_Login']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['sec_Login']['opc_ant'] = "inicio";
      }
      ...
      { 
          ...
          if (isset($this->sett_brute_force_time_block)) 
          {
              $_SESSION['sett_brute_force_time_block'] = $this->sett_brute_force_time_block;
          }
          if (isset($this->sett_brute_force_attempts)) 
          {
              $_SESSION['sett_brute_force_attempts'] = $this->sett_brute_force_attempts;
          }
...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off';
      ...
      $_SESSION['scriptcase']['error_icon']['sec_Login']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['sec_Login'] = "";
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['opc_ant'] : "";
      } 
...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  ...
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][2]; 
                  $new_user = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][3]; 
                  $retrieve_pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][4]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][2] = $this->remember_me; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][3] = $this->new_user; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][4] = $this->retrieve_pswd; 
          if (!empty($this->new_user))
          {
              ...
              else
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['redir_target_name'] = $this->new_user_sc_target_name;
          ...
          if (!empty($this->retrieve_pswd))
          {
              ...
              else
              {
                  ...
                  $path_retorno_aplicacao .=  $trab_saida;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['redir_target_name'] = $this->retrieve_pswd_sc_target_name;
                  $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $path_retorno_aplicacao;
                  $nm_apl_dependente = 1; 
               }
               $this->NM_close_db(); 
...
else if($this->rs[0][1] == 'Y')
{
    ...
    if( $this->sc_temp_sett_enable_2fa == 'Y' && !empty($this->rs[0][4])){  if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('sec_control_2fa') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 }; }
...
$aLookup[] = array(sec_Login_pack_protect_string('1') => str_replace('<', '&lt;',sec_Login_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_remember_me'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_remember_me'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['remember_me']['valList'][$i] = sec_Login_pack_protect_string($v);
          }
...
;
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('home') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
 };	
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['opc_ant'] = "";
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['ordem_ord'] == " desc") {
