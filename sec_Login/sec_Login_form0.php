...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>sec_Login/sec_Login_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['last'] : 'off'); ?>";
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['recarga']))
{
...
else
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['link_info']['remove_border']) {
...
$_SESSION['scriptcase']['error_icon_title']['sec_Login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['where_filter']))
       {
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_format_readonly("login", $this->form_encode_input($this->login)); ?></span><span id="id_read_off_login" class="css_read_off_login<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '<?php echo $this->Ini->Nm_lang['lang_sec_users_fild_login'] ?>', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_remember_me'][] = '1'; ?>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['new_user'] = "new_user";
    }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_new_user_line" id="hidden_field_data_new_user" style="<?php echo $sStyleHidden_new_user; ?>"> 
<?php
$new_user_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($new_user));
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["new_user"]) &&  $this->nmgp_cmp_readonly["new_user"] == "on") { 
 ...
 ?>
<input type="hidden" name="new_user" value="<?php echo $this->form_encode_input($new_user) . "\">" . $new_user_val . ""; ?>
<?php } else { ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['retrieve_pswd'] = "retrieve_pswd";
    }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_retrieve_pswd_line" id="hidden_field_data_retrieve_pswd" style="<?php echo $sStyleHidden_retrieve_pswd; ?>"> 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['ok'];
        }
?>
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("sec_Login");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("sec_Login");
 parent.scAjaxDetailHeight("sec_Login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
