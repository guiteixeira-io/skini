...
class sec_logged_users_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_logged_users']['csv_res_file'] = $this->Csv_f;
      }
