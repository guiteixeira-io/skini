...
<?php
   ...
   $Ord_Cmp = new sec_logged_users_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class sec_logged_users_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['sec_logged_users']['labels']["login"] : "" . $this->Nm_lang['lang_sec_logged_fild_login'] . "";
   $tab_ger_campos['date_login'] = "on";
   $tab_def_campos['date_login'] = "date_login";
   $tab_labels["date_login"]   = (isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['labels']["date_login"])) ? $_SESSION['sc_session'][$sc_init]['sec_logged_users']['labels']["date_login"] : "" . $this->Nm_lang['lang_sec_logged_fild_date_login'] . "";
   $tab_ger_campos['ip'] = "on";
   $tab_def_campos['ip'] = "ip";
   $tab_labels["ip"]   = (isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['labels']["ip"])) ? $_SESSION['sc_session'][$sc_init]['sec_logged_users']['labels']["ip"] : "" . $this->Nm_lang['lang_sec_logged_fild_ip'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['sec_logged_users']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['sec_logged_users']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "sec_logged_users_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['sec_logged_users']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
