<?php
@session_start() ;
$_SESSION['scriptcase']['sec_logged_users']['sc_process_barr'] = true;
require_once('../sec_logged_users/index.php');
unset($_SESSION['scriptcase']['sec_logged_users']['sc_process_barr']);
$ExportCtrl = new sec_logged_users_export_control;
$ExportCtrl->Export_barr();

class sec_logged_users_export_control
{
