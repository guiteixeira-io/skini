...
class men_accommodation_form_php
{
      var $sc_script_name;
      var $nm_location;
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['men_accommodation']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['men_accommodation']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['men_accommodation']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['men_accommodation']['sc_apl_link'];
...
<?php
    exit;
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "men_accommodation")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("img_menu") . "/?nm_run_menu=1&nm_apl_menu=men_accommodation&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['men_accommodation']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['men_accommodation'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("que_lodge") . "/?nm_run_menu=1&nm_apl_menu=men_accommodation&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("que_lodge_category") . "/?nmgp_outra_jan=true&nm_apl_menu=men_accommodation";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="men_accommodation"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "men_accommodation")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'men_accommodation', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new men_accommodation_form_php();
$controle->init();
?>
