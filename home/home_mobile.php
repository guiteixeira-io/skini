...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["home"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["home"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["home"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($home_menuData["data"]) && is_array($home_menuData["data"]) && !empty($home_menuData["data"]))
    {
        foreach($home_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($home_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
