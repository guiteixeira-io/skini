  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cad_costumer_holder_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_cad_costumer_holder_mob_form();
	}
...
?>
  ...
  // ---------- Validate idcostumer
  function do_ajax_cad_costumer_holder_mob_validate_idcostumer()
  {
    var nomeCampo_idcostumer = "idcostumer";
    var var_idcostumer = scAjaxGetFieldHidden(nomeCampo_idcostumer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_idcostumer(var_idcostumer, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_idcostumer_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_idcostumer

  function do_ajax_cad_costumer_holder_mob_validate_idcostumer_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_idcostumer_cb

  // ---------- Validate docnumber
  function do_ajax_cad_costumer_holder_mob_validate_docnumber()
  {
    var nomeCampo_docnumber = "docnumber";
    var var_docnumber = scAjaxGetFieldText(nomeCampo_docnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_docnumber(var_docnumber, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_docnumber_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_docnumber

  function do_ajax_cad_costumer_holder_mob_validate_docnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_docnumber_cb

  // ---------- Validate doctype
  function do_ajax_cad_costumer_holder_mob_validate_doctype()
  {
    var nomeCampo_doctype = "doctype";
    var var_doctype = scAjaxGetFieldText(nomeCampo_doctype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_doctype(var_doctype, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_doctype_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_doctype

  function do_ajax_cad_costumer_holder_mob_validate_doctype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doctype";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_doctype_cb

  // ---------- Validate firstname
  function do_ajax_cad_costumer_holder_mob_validate_firstname()
  {
    var nomeCampo_firstname = "firstname";
    var var_firstname = scAjaxGetFieldText(nomeCampo_firstname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_firstname(var_firstname, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_firstname_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_firstname

  function do_ajax_cad_costumer_holder_mob_validate_firstname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_firstname_cb

  // ---------- Validate lastname
  function do_ajax_cad_costumer_holder_mob_validate_lastname()
  {
    var nomeCampo_lastname = "lastname";
    var var_lastname = scAjaxGetFieldText(nomeCampo_lastname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_lastname(var_lastname, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_lastname_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_lastname

  function do_ajax_cad_costumer_holder_mob_validate_lastname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_lastname_cb

  // ---------- Validate idlodge
  function do_ajax_cad_costumer_holder_mob_validate_idlodge()
  {
    var nomeCampo_idlodge = "idlodge";
    var var_idlodge = scAjaxGetFieldSelect(nomeCampo_idlodge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_idlodge(var_idlodge, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_idlodge_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_idlodge

  function do_ajax_cad_costumer_holder_mob_validate_idlodge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idlodge";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_idlodge_cb

  // ---------- Validate frequencytype
  function do_ajax_cad_costumer_holder_mob_validate_frequencytype()
  {
    var nomeCampo_frequencytype = "frequencytype";
    var var_frequencytype = scAjaxGetFieldText(nomeCampo_frequencytype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_frequencytype(var_frequencytype, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_frequencytype_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_frequencytype

  function do_ajax_cad_costumer_holder_mob_validate_frequencytype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_frequencytype_cb

  // ---------- Validate holdertype
  function do_ajax_cad_costumer_holder_mob_validate_holdertype()
  {
    var nomeCampo_holdertype = "holdertype";
    var var_holdertype = scAjaxGetFieldText(nomeCampo_holdertype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_holdertype(var_holdertype, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_holdertype_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_holdertype

  function do_ajax_cad_costumer_holder_mob_validate_holdertype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_holdertype_cb

  // ---------- Validate idholder
  function do_ajax_cad_costumer_holder_mob_validate_idholder()
  {
    var nomeCampo_idholder = "idholder";
    var var_idholder = scAjaxGetFieldText(nomeCampo_idholder);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumer_holder_mob_validate_idholder(var_idholder, var_script_case_init, do_ajax_cad_costumer_holder_mob_validate_idholder_cb);
  } // do_ajax_cad_costumer_holder_mob_validate_idholder

  function do_ajax_cad_costumer_holder_mob_validate_idholder_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumer_holder_mob_validate_idholder_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cad_costumer_holder_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cad_costumer_holder_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcostumer = scAjaxGetFieldHidden("idcostumer");
    var var_docnumber = scAjaxGetFieldText("docnumber");
    var var_doctype = scAjaxGetFieldText("doctype");
    var var_firstname = scAjaxGetFieldText("firstname");
    var var_lastname = scAjaxGetFieldText("lastname");
    var var_idlodge = scAjaxGetFieldSelect("idlodge");
    ...
    scAjaxProcOn();
    x_ajax_cad_costumer_holder_mob_submit_form(var_idcostumer, var_docnumber, var_doctype, var_firstname, var_lastname, var_idlodge, var_frequencytype, var_holdertype, var_idholder, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_costumer_holder_mob_submit_form_cb);
  } // do_ajax_cad_costumer_holder_mob_submit_form

  function do_ajax_cad_costumer_holder_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcostumer");
      scAjaxHideErrorDisplay("docnumber");
      scAjaxHideErrorDisplay("doctype");
      ...
      scAjaxHideErrorDisplay("idholder");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cad_costumer_holder_mob_submit_form_cb_after_alert);
  } // do_ajax_cad_costumer_holder_mob_submit_form_cb
  function do_ajax_cad_costumer_holder_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cad_costumer_holder_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cad_costumer_holder_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cad_costumer_holder_mob_navigate_form, function() {});
    } else {
      perform_ajax_cad_costumer_holder_mob_navigate_form();
    }
  }

  function perform_ajax_cad_costumer_holder_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cad_costumer_holder_mob_navigate_form(var_idcostumer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cad_costumer_holder_mob_navigate_form_cb);
  } // do_ajax_cad_costumer_holder_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumer_holder_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cad_costumer_holder_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cad_costumer_holder_mob_navigate_form_cb_after_alert);
  } // do_ajax_cad_costumer_holder_mob_navigate_form_cb
  function do_ajax_cad_costumer_holder_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cad_costumer_holder_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cad_costumer_holder_mob_navigate_form_cb_after_alert

  function sc_hide_cad_costumer_holder_mob_form()
  {
  ...
  ajax_field_list[2] = "doctype";
  ajax_field_list[3] = "firstname";
  ajax_field_list[4] = "lastname";
  ajax_field_list[5] = "idlodge";
  ajax_field_list[6] = "frequencytype";
  ajax_field_list[7] = "holdertype";
  ajax_field_list[8] = "idholder";
  ...
  var ajax_error_list = {
    ...
    "doctype": {"label": "Doc Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "idlodge": {"label": "Id Lodge", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["doctype"][1] = "doctype";
  ...
  var ajax_field_id = {
    ...
    "doctype": new Array("hidden_field_label_doctype", "hidden_field_data_doctype"),
