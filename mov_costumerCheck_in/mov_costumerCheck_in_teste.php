<?php  
  ...
  session_start() ;
  class mov_costumerCheck_in_form_teste
  {
   function mov_costumerCheck_in_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "mov_costumerCheck_in/img";
...
<?php
  ...
  $frm_teste = new mov_costumerCheck_in_form_teste();
  $frm_teste->mov_costumerCheck_in_teste();
?>
