  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_mov_costumerCheck_in" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_mov_costumerCheck_in_form();
	}
...
?>
  ...
  // ---------- Validate idcostumercheck_
  function do_ajax_mov_costumerCheck_in_validate_idcostumercheck_(iNumLinha)
  {
    var nomeCampo_idcostumercheck_ = "idcostumercheck_" + iNumLinha;
    var var_idcostumercheck_ = scAjaxGetFieldHidden(nomeCampo_idcostumercheck_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mov_costumerCheck_in_validate_idcostumercheck_(var_idcostumercheck_, iNumLinha, var_script_case_init, do_ajax_mov_costumerCheck_in_validate_idcostumercheck__cb);
  } // do_ajax_mov_costumerCheck_in_validate_idcostumercheck_

  function do_ajax_mov_costumerCheck_in_validate_idcostumercheck__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idcostumercheck_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcostumercheck_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idcostumercheck_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcostumercheck_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mov_costumerCheck_in_validate_idcostumercheck__cb

  // ---------- Validate idcostumer_
  function do_ajax_mov_costumerCheck_in_validate_idcostumer_(iNumLinha)
  {
    var nomeCampo_idcostumer_ = "idcostumer_" + iNumLinha;
    var var_idcostumer_ = scAjaxGetFieldSelect(nomeCampo_idcostumer_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mov_costumerCheck_in_validate_idcostumer_(var_idcostumer_, iNumLinha, var_script_case_init, do_ajax_mov_costumerCheck_in_validate_idcostumer__cb);
  } // do_ajax_mov_costumerCheck_in_validate_idcostumer_

  function do_ajax_mov_costumerCheck_in_validate_idcostumer__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mov_costumerCheck_in_validate_idcostumer__cb

  // ---------- Validate idlodge_
  function do_ajax_mov_costumerCheck_in_validate_idlodge_(iNumLinha)
  {
    var nomeCampo_idlodge_ = "idlodge_" + iNumLinha;
    var var_idlodge_ = scAjaxGetFieldSelect(nomeCampo_idlodge_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mov_costumerCheck_in_validate_idlodge_(var_idlodge_, iNumLinha, var_script_case_init, do_ajax_mov_costumerCheck_in_validate_idlodge__cb);
  } // do_ajax_mov_costumerCheck_in_validate_idlodge_

  function do_ajax_mov_costumerCheck_in_validate_idlodge__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idlodge_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idlodge_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idlodge_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idlodge_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mov_costumerCheck_in_validate_idlodge__cb

  // ---------- Validate sc_field_0_
  function do_ajax_mov_costumerCheck_in_validate_sc_field_0_(iNumLinha)
  {
    var nomeCampo_sc_field_0_ = "sc_field_0_" + iNumLinha;
    var var_sc_field_0_ = scAjaxGetFieldText(nomeCampo_sc_field_0_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mov_costumerCheck_in_validate_sc_field_0_(var_sc_field_0_, iNumLinha, var_script_case_init, do_ajax_mov_costumerCheck_in_validate_sc_field_0__cb);
  } // do_ajax_mov_costumerCheck_in_validate_sc_field_0_

  function do_ajax_mov_costumerCheck_in_validate_sc_field_0__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_mov_costumerCheck_in_validate_sc_field_0__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_mov_costumerCheck_in_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_mov_costumerCheck_in_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_mov_costumerCheck_in_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_mov_costumerCheck_in_add_new_line_cb);
  } // do_ajax_mov_costumerCheck_in_add_new_line

  function do_ajax_mov_costumerCheck_in_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_mov_costumerCheck_in_add_new_line_cb

  // ---------- backup_line
  function do_ajax_mov_costumerCheck_in_backup_line(iNumLinha)
  {
    var var_idcostumercheck_ = scAjaxGetFieldHidden("idcostumercheck_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_mov_costumerCheck_in_backup_line(var_idcostumercheck_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_mov_costumerCheck_in_backup_line_cb);
  } // do_ajax_mov_costumerCheck_in_backup_line

  function do_ajax_mov_costumerCheck_in_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_mov_costumerCheck_in_backup_line_cb

  function do_ajax_mov_costumerCheck_in_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_mov_costumerCheck_in_cancel_insert

  function do_ajax_mov_costumerCheck_in_cancel_update(iSeqVert)
  {
    do_ajax_mov_costumerCheck_in_backup_line(iSeqVert);
...
?>
  } // do_ajax_mov_costumerCheck_in_cancel_update

  function do_ajax_mov_costumerCheck_in_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_mov_costumerCheck_in_restore_buttons

  // ---------- table_refresh
  function do_ajax_mov_costumerCheck_in_table_refresh()
  {
    var var_idcostumercheck_ = document.F2.idcostumercheck_.value;
    ...
    scAjaxProcOn();
    x_ajax_mov_costumerCheck_in_table_refresh(var_idcostumercheck_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_mov_costumerCheck_in_table_refresh_cb);
  } //  do_ajax_mov_costumerCheck_in_table_refresh

  function do_ajax_mov_costumerCheck_in_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcostumercheck_.value = scAjaxGetKeyValue("idcostumercheck_");
    ...
    scAjaxAlert(do_ajax_mov_costumerCheck_in_table_refresh_cb_after_alert);
  } // do_ajax_mov_costumerCheck_in_table_refresh_cb
  function do_ajax_mov_costumerCheck_in_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_mov_costumerCheck_in_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_mov_costumerCheck_in_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_mov_costumerCheck_in_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idlodge_ = scAjaxGetFieldSelect("idlodge_" + iNumLinha);
...
?>
    x_ajax_mov_costumerCheck_in_submit_form(var_idcostumercheck_, var_idcostumer_, var_idlodge_, var_sc_field_0_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_mov_costumerCheck_in_submit_form_cb);
  } // do_ajax_mov_costumerCheck_in_submit_form

  function do_ajax_mov_costumerCheck_in_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcostumercheck_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idcostumer_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idlodge_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_mov_costumerCheck_in_submit_form_cb_after_alert);
  } // do_ajax_mov_costumerCheck_in_submit_form_cb
  function do_ajax_mov_costumerCheck_in_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_mov_costumerCheck_in_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_mov_costumerCheck_in_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_mov_costumerCheck_in_navigate_form, function() {});
    } else {
      perform_ajax_mov_costumerCheck_in_navigate_form();
    }
  }

  function perform_ajax_mov_costumerCheck_in_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idcostumercheck_" + iNavForm);
      scAjaxHideErrorDisplay("idcostumer_" + iNavForm);
      scAjaxHideErrorDisplay("idlodge_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_mov_costumerCheck_in_navigate_form(var_idcostumercheck_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_mov_costumerCheck_in_navigate_form_cb);
  } // do_ajax_mov_costumerCheck_in_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['mov_costumerCheck_in']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_mov_costumerCheck_in_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcostumercheck_.value = scAjaxGetKeyValue("idcostumercheck_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_mov_costumerCheck_in_navigate_form_cb_after_alert);
  } // do_ajax_mov_costumerCheck_in_navigate_form_cb
  function do_ajax_mov_costumerCheck_in_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_mov_costumerCheck_in_navigate_form_cb_after_alert

    function sc_mov_costumerCheck_in_get_last_line_number()
    {
    ...
    } //sc_mov_costumerCheck_in_get_last_line_number

  function sc_hide_mov_costumerCheck_in_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idcostumercheck_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcostumer_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idlodge_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sc_field_0_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idcostumercheck_" + iNumLinha] = {"label": "Id Costumer Check<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["idcostumer_" + iNumLinha] = {"label": "Id Costumer<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["idlodge_" + iNumLinha] = {"label": "Id Lodge<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["sc_field_0_" + iNumLinha] = {"label": "Action<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["idcostumercheck_"][iNumLinha] = "idcostumercheck_" + iNumLinha;
    ajax_field_mult["idcostumer_"][iNumLinha] = "idcostumer_" + iNumLinha;
    ajax_field_mult["idlodge_"][iNumLinha] = "idlodge_" + iNumLinha;
    ajax_field_mult["sc_field_0_"][iNumLinha] = "sc_field_0_" + iNumLinha;
    ajax_field_id["idcostumercheck_" + iNumLinha] = new Array("hidden_field_label_idcostumercheck_", "hidden_field_data_idcostumercheck_" + iNumLinha);
    ajax_field_id["idcostumer_" + iNumLinha] = new Array("hidden_field_label_idcostumer_", "hidden_field_data_idcostumer_" + iNumLinha);
    ajax_field_id["idlodge_" + iNumLinha] = new Array("hidden_field_label_idlodge_", "hidden_field_data_idlodge_" + iNumLinha);
    ajax_field_id["sc_field_0_" + iNumLinha] = new Array("hidden_field_label_sc_field_0_", "hidden_field_data_sc_field_0_" + iNumLinha);
    ajax_error_count["idcostumercheck_" + iNumLinha] = "off";
    ajax_error_count["idcostumer_" + iNumLinha] = "off";
    ajax_error_count["idlodge_" + iNumLinha] = "off";
    ajax_error_count["sc_field_0_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idcostumercheck_" + iNumLinha] = "on";
    ajax_read_only["idcostumer_" + iNumLinha] = "off";
    ajax_read_only["idlodge_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["idlodge_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idcostumercheck_" + iNumLinha] = null;
    ajax_error_list["idcostumer_" + iNumLinha] = null;
    ajax_error_list["idlodge_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idcostumercheck_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcostumercheck_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcostumercheck_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcostumercheck_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcostumercheck_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idlodge_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idlodge_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idlodge_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idlodge_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idlodge_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcostumercheck_'])) ? $this->nmgp_cmp_readonly['idcostumercheck_'] : 'on';
?>
    scAjaxFieldRead("idcostumercheck_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idlodge_'])) ? $this->nmgp_cmp_readonly['idlodge_'] : 'off';
?>
    scAjaxFieldRead("idlodge_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idcostumercheck_" + iSeq, "on");
    scAjaxFieldRead("idcostumer_" + iSeq, "on");
    scAjaxFieldRead("idlodge_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idcostumercheck_" + iRow] || "on" == ajax_error_count["idcostumer_" + iRow] || "on" == ajax_error_count["idlodge_" + iRow] || "on" == ajax_error_count["sc_field_0_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcostumercheck_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcostumer_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idlodge_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_0_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idcostumercheck_" + iRow] && "off" == ajax_error_count["idcostumer_" + iRow] && "off" == ajax_error_count["idlodge_" + iRow] && "off" == ajax_error_count["sc_field_0_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idcostumercheck_" + iRow] = "off";
        ajax_error_count["idcostumer_" + iRow] = "off";
        ajax_error_count["idlodge_" + iRow] = "off";
      ...
      $("#hidden_field_data_idcostumercheck_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idcostumer_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idlodge_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sc_field_0_" + iRow).removeClass("scFormErrorLine");
    }
  }
