...
if (!isset($_SESSION['scriptcase']['men_checkin']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['men_checkin']) || $_SESSION['scriptcase']['sc_apl_seg']['men_checkin'] != "on"))
{ 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/tas_costumerCheck_in_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/tas_costumerCheck_in_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['tas_costumerCheck_in']))
        {
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['tas_costumerCheck_in']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['tas_costumerCheck_in']) == "on")
{
    $men_checkin_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "|men_checkin_form_php.php?sc_item_menu=item_2&sc_apl_menu=tas_costumerCheck_in&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->men_checkin_target('_self') . "|" . "\n";
}
else
{
    $men_checkin_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
...
$str_disabled = "N";
$str_link = "men_checkin_form_php.php?sc_item_menu=item_2&sc_apl_menu=tas_costumerCheck_in&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['tas_costumerCheck_in']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['tas_costumerCheck_in']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $men_checkin_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->men_checkin_target('_self') . "\"",
        'sc_id'    => "item_2",
...
function nm_show_toolbarmenu($col_span, $saida_apl, $men_checkin_menuData, $path_imag_cab)
{
   ...
   {
        $_SESSION['scriptcase']['men_checkin']['sc_init'][$apl_menu] = 1;
        return  1;
   }
