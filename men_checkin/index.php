<?php
include_once('men_checkin_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['men_checkin']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['men_checkin']['glo_nm_conexao']        = "";
    $_SESSION['scriptcase']['men_checkin']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['men_checkin']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['men_checkin']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class men_checkin_class
{
  var $Db;
 ...
 function men_checkin_menu()
 {
    global $men_checkin_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['men_checkin']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "men_checkin/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('men_checkin');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/men_checkin_erro.php");
}
include_once(dirname(__FILE__) . "/men_checkin_erro.class.php"); 
$this->Erro = new men_checkin_erro();
$str_path = substr($_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['men_checkin']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$men_checkin_menuData         = array();
$men_checkin_menuData['path'] = array();
$men_checkin_menuData['url']  = array();
$men_checkin_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $men_checkin_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $men_checkin_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $men_checkin_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $men_checkin_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$men_checkin_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$men_checkin_menuData['url']['web']   = str_replace("\\", '/', $men_checkin_menuData['url']['web']);
$men_checkin_menuData['path']['root'] = substr($men_checkin_menuData['path']['sys'],  0, -1 * strlen($men_checkin_menuData['url']['web']));
$men_checkin_menuData['path']['app']  = substr($men_checkin_menuData['path']['sys'],  0, strrpos($men_checkin_menuData['path']['sys'],  '/'));
$men_checkin_menuData['path']['link'] = substr($men_checkin_menuData['path']['app'],  0, strrpos($men_checkin_menuData['path']['app'],  '/'));
$men_checkin_menuData['path']['link'] = substr($men_checkin_menuData['path']['link'], 0, strrpos($men_checkin_menuData['path']['link'], '/')) . '/';
$men_checkin_menuData['path']['app'] .= '/';
$men_checkin_menuData['url']['app']   = substr($men_checkin_menuData['url']['web'],  0, strrpos($men_checkin_menuData['url']['web'],  '/'));
$men_checkin_menuData['url']['link']  = substr($men_checkin_menuData['url']['app'],  0, strrpos($men_checkin_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] == "S")
{
    $men_checkin_menuData['url']['link']  = substr($men_checkin_menuData['url']['link'], 0, strrpos($men_checkin_menuData['url']['link'], '/'));
}
$men_checkin_menuData['url']['link']  .= '/';
$men_checkin_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['men_checkin']['sc_apl_link'] = $men_checkin_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['men_checkin']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['men_checkin']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['men_checkin']['actual_lang']) || $_SESSION['scriptcase']['men_checkin']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['men_checkin']['actual_lang'] = $this->str_lang;
...
include_once("men_checkin_toolbar.php");
...
if ($_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "men_checkin";
     $_SESSION['scriptcase']['menu_apls']['men_checkin'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['men_checkin']['glo_nm_conexao']) && $_SESSION['scriptcase']['men_checkin']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['men_checkin']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['men_checkin']['glo_nm_perfil']) && $_SESSION['scriptcase']['men_checkin']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['men_checkin']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['men_checkin']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['men_checkin']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['men_checkin']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['men_checkin']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['men_checkin']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['men_checkin']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['men_checkin']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['men_checkin']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['men_checkin']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['men_checkin']['init']))
{
    $_SESSION['sc_session'][1]['men_checkin']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['men_checkin']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['men_checkin']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_men_checkin'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_men_checkin'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_men_checkin'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'men_checkin'))
{
    $_SESSION['sc_session'][1]['men_checkin']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_men_checkin'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$men_checkin_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_men_checkin'];
...
{
    $men_checkin_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "|men_checkin_form_php.php?sc_item_menu=item_2&sc_apl_menu=fil_costumer_checkin&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->men_checkin_target('_parent') . "|" . "\n";
}
else
{
    $men_checkin_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "||||_parent|disabled\n";
}
...
$men_checkin_menuData['data'] = array();
$str_disabled = "N";
$str_link = "men_checkin_form_php.php?sc_item_menu=item_2&sc_apl_menu=fil_costumer_checkin&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['fil_costumer_checkin']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['fil_costumer_checkin']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $men_checkin_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->men_checkin_target('_parent') . "\"",
        'sc_id'    => "item_2",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['men_checkin']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['men_checkin']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'men_checkin');
    $men_checkin_menuData['data'] = $str_menu_usu;
}
if (is_file("men_checkin_help.txt"))
{
    $Arq_WebHelp = file("men_checkin_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $men_checkin_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->men_checkin_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['men_checkin']) && !empty($_SESSION['scriptcase']['sc_menu_del']['men_checkin']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($men_checkin_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['men_checkin']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($men_checkin_menuData['data'][$i_menu]);
       }
    ...
    $men_checkin_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['men_checkin']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['men_checkin']))
{
    $disable_menu = false;
    foreach ($men_checkin_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['men_checkin']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $men_checkin_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($men_checkin_menuData['iframe'])
{
    $men_checkin_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $men_checkin_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['men_checkin']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="men_checkin_message.js"></script>
...
Iframe_atual = "men_checkin_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"men_checkin\";\r\n";
echo "Tab_labels['men_checkin'] = \"\";\r\n";
echo "Tab_hints['men_checkin'] = \"\";\r\n";
echo "Tab_abas['men_checkin']   = \"none\";\r\n";
echo "Tab_refresh['men_checkin']   = \"\";\r\n";
echo "Tab_icons['men_checkin'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['men_checkin'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['men_checkin']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['men_checkin']   = \"\";\r\n";
echo "Tab_display['men_checkin']   = \"\";\r\n";
echo "Tab_display_position['men_checkin']   = \"\";\r\n";
echo "Tab_links['men_checkin']   = \"\";\r\n";
         $seq++;
 if(isset($men_checkin_menuData['data']) && !empty($men_checkin_menuData['data']))
 {
   foreach ($men_checkin_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($men_checkin_menuData['data_vertical']) && !empty($men_checkin_menuData['data_vertical']))
 {
   foreach ($men_checkin_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'men_checkin_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'men_checkin'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_men_checkin').hide();
    if (str_id == "")
    {
        $('#iframe_men_checkin').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="men_checkin_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            if (Tab_iframes[i] != 'men_checkin') 
            {
                Iframe_atual = "men_checkin_" + Tab_iframes[i] + '_iframe';
            }
...
{
  str_target_sv = "";
  if (str_id != "iframe_men_checkin")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("men_checkin_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_men_checkin', 'men_checkin');
    if (str_target == "men_checkin_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "men_checkin")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "men_checkin" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_men_checkin').length)
        $('#iframe_men_checkin')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $men_checkin_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->men_checkin_escreveMenu($men_checkin_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $men_checkin_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_men_checkin');\" item-href=\"men_checkin_form_php.php?sc_item_menu=men_checkin&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . "\"  item-target=\"men_checkin_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "men_checkin_pag_ini.php");
} 
?>
      <iframe id="iframe_men_checkin" name="men_checkin_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_men_checkin').click()";
    echo "</script>";
}
...
/* Controle de Target */
function men_checkin_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function men_checkin_target($str_target)
{
    global $men_checkin_menuData;
    ...
    elseif ($men_checkin_menuData['iframe'])
    {
        return 'men_checkin_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $men_checkin_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "men_checkin_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "men_checkin_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($men_checkin_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkin']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->men_checkin_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['men_checkin']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['men_checkin']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['men_checkin']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['men_checkin']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "men_checkin") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['men_checkin']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['men_checkin']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['men_checkin']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_skini'])) {
            $_SESSION['scriptcase']['men_checkin']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_skini'];
        }
    }
}
...
$contr_men_checkin = new men_checkin_class;
$contr_men_checkin->men_checkin_menu();
