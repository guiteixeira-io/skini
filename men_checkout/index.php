<?php
include_once('men_checkout_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod']      = "/scriptcase/prod";
    $_SESSION['scriptcase']['men_checkout']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['men_checkout']['glo_nm_conexao']        = "";
    $_SESSION['scriptcase']['men_checkout']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['men_checkout']['glo_nm_usa_grupo']      = "S";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['men_checkout']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['men_checkout']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class men_checkout_class
{
  var $Db;
 ...
 function men_checkout_menu()
 {
    global $men_checkout_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['men_checkout']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "men_checkout/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('men_checkout');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/men_checkout_erro.php");
}
include_once(dirname(__FILE__) . "/men_checkout_erro.class.php"); 
$this->Erro = new men_checkout_erro();
$str_path = substr($_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['men_checkout']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$men_checkout_menuData         = array();
$men_checkout_menuData['path'] = array();
$men_checkout_menuData['url']  = array();
$men_checkout_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $men_checkout_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $men_checkout_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $men_checkout_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $men_checkout_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$men_checkout_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$men_checkout_menuData['url']['web']   = str_replace("\\", '/', $men_checkout_menuData['url']['web']);
$men_checkout_menuData['path']['root'] = substr($men_checkout_menuData['path']['sys'],  0, -1 * strlen($men_checkout_menuData['url']['web']));
$men_checkout_menuData['path']['app']  = substr($men_checkout_menuData['path']['sys'],  0, strrpos($men_checkout_menuData['path']['sys'],  '/'));
$men_checkout_menuData['path']['link'] = substr($men_checkout_menuData['path']['app'],  0, strrpos($men_checkout_menuData['path']['app'],  '/'));
$men_checkout_menuData['path']['link'] = substr($men_checkout_menuData['path']['link'], 0, strrpos($men_checkout_menuData['path']['link'], '/')) . '/';
$men_checkout_menuData['path']['app'] .= '/';
$men_checkout_menuData['url']['app']   = substr($men_checkout_menuData['url']['web'],  0, strrpos($men_checkout_menuData['url']['web'],  '/'));
$men_checkout_menuData['url']['link']  = substr($men_checkout_menuData['url']['app'],  0, strrpos($men_checkout_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['men_checkout']['glo_nm_usa_grupo'] == "S")
{
    $men_checkout_menuData['url']['link']  = substr($men_checkout_menuData['url']['link'], 0, strrpos($men_checkout_menuData['url']['link'], '/'));
}
$men_checkout_menuData['url']['link']  .= '/';
$men_checkout_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['men_checkout']['sc_apl_link'] = $men_checkout_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['men_checkout']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['men_checkout']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['men_checkout']['actual_lang']) || $_SESSION['scriptcase']['men_checkout']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['men_checkout']['actual_lang'] = $this->str_lang;
...
include_once("men_checkout_toolbar.php");
...
if ($_SESSION['scriptcase']['men_checkout']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "men_checkout";
     $_SESSION['scriptcase']['menu_apls']['men_checkout'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['men_checkout']['glo_nm_conexao']) && $_SESSION['scriptcase']['men_checkout']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['men_checkout']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['men_checkout']['glo_nm_perfil']) && $_SESSION['scriptcase']['men_checkout']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['men_checkout']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['men_checkout']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['men_checkout']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['men_checkout']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['men_checkout']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['men_checkout']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['men_checkout']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['men_checkout']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['men_checkout']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['men_checkout']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['men_checkout']['init']))
{
    $_SESSION['sc_session'][1]['men_checkout']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['men_checkout']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['men_checkout']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_men_checkout'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_men_checkout'] = $nm_url_saida;
}
else
{
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['men_checkout']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'men_checkout'))
{
    $_SESSION['sc_session'][1]['men_checkout']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_men_checkout'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$men_checkout_menuData['iframe'] = TRUE;
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['men_checkout']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['men_checkout']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'men_checkout');
    $men_checkout_menuData['data'] = $str_menu_usu;
}
if (is_file("men_checkout_help.txt"))
{
    $Arq_WebHelp = file("men_checkout_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $men_checkout_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->men_checkout_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['men_checkout']) && !empty($_SESSION['scriptcase']['sc_menu_del']['men_checkout']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($men_checkout_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['men_checkout']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($men_checkout_menuData['data'][$i_menu]);
       }
    ...
    $men_checkout_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['men_checkout']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['men_checkout']))
{
    $disable_menu = false;
    foreach ($men_checkout_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['men_checkout']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $men_checkout_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($men_checkout_menuData['iframe'])
{
    $men_checkout_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
{
    $men_checkout_menuData['height'] = '30px';
}
...
<script type="text/javascript" src="men_checkout_message.js"></script>
...
Iframe_atual = "men_checkout_iframe";
        ...
        }function openMenuItem(str_id)
{
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_men_checkout').length)
        $('#iframe_men_checkout')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $men_checkout_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->men_checkout_escreveMenu($men_checkout_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_men_checkout');\" item-href=\"men_checkout_form_php.php?sc_item_menu=men_checkout&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($men_checkout_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkout']['glo_nm_usa_grupo'] . "\"  item-target=\"men_checkout_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "men_checkout_pag_ini.php");
} 
?>
      <iframe id="iframe_men_checkout" name="men_checkout_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_men_checkout').click()";
    echo "</script>";
}
...
/* Controle de Target */
function men_checkout_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function men_checkout_target($str_target)
{
    global $men_checkout_menuData;
    ...
    elseif ($men_checkout_menuData['iframe'])
    {
        return 'men_checkout_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $men_checkout_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "men_checkout_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($men_checkout_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkout']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "men_checkout_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($men_checkout_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['men_checkout']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->men_checkout_target( $arr_item['target']) : "_self"; 
           }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['men_checkout']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "men_checkout") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['men_checkout']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['men_checkout']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['men_checkout']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_skini'])) {
            $_SESSION['scriptcase']['men_checkout']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_skini'];
        }
    }
}
...
$contr_men_checkout = new men_checkout_class;
$contr_men_checkout->men_checkout_menu();
