...
class men_inicio_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['men_inicio']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['men_inicio']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['men_inicio']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['men_inicio']['sc_apl_link'];
...
<?php
    exit;
      ...
      $_SESSION['scriptcase']['men_inicio']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['men_inicio']['contr_erro'] = 'off';
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "men_inicio")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("img_menu") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['men_inicio']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['men_inicio'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("men_costumer") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("men_lodge") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_2")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("men_checkin") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("men_checkout") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("men_schedule") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("admin") . "/?nm_run_menu=1&nm_apl_menu=men_inicio&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="men_inicio"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "men_inicio")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'men_inicio', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new men_inicio_form_php();
$controle->init();
?>
