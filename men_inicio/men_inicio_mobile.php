...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["men_inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["men_inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["men_inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($men_inicio_menuData["data"]) && is_array($men_inicio_menuData["data"]) && !empty($men_inicio_menuData["data"]))
    {
        foreach($men_inicio_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($men_inicio_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
