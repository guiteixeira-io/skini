...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " cal_lodge"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " cal_lodge"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>cal_lodge/cal_lodge_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("cal_lodge_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('cal_lodge_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['link_info']['remove_border']) {
...
<?php
 include_once("cal_lodge_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['cal_lodge'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['cal_lodge'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_title_line" id="hidden_field_data_title" style="<?php echo $sStyleHidden_title; ?>"> <span class="scFormLabelOddFormat css_title_label" style=""><span id="id_label_title"><?php echo $this->nm_new_label['title']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['php_cmp_required']['title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['php_cmp_required']['title'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
$(function() {
        ...
        $(".sc-cal-categ-item-category").on("click", function() {
                ...
                if (oldValue != $(this).data("value") && "function" == typeof do_ajax_cal_lodge_event_category_onchange) {
                        do_ajax_cal_lodge_event_category_onchange();
                }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_event_color_line" id="hidden_field_data_event_color" style="<?php echo $sStyleHidden_event_color; ?>"> <span class="scFormLabelOddFormat css_event_color_label" style=""><span id="id_label_event_color"><?php echo $this->nm_new_label['event_color']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_end_date_line" id="hidden_field_data_end_date" style="<?php echo $sStyleHidden_end_date; ?>"> <span class="scFormLabelOddFormat css_end_date_label" style=""><span id="id_label_end_date"><?php echo $this->nm_new_label['end_date']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_start_date_dumb = ('' == $sStyleHidden_start_date) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_start_date_dumb" style="<?php echo $sStyleHidden_start_date_dumb; ?>"></TD>
<?php $sStyleHidden_end_date_dumb = ('' == $sStyleHidden_end_date) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_end_date_dumb" style="<?php echo $sStyleHidden_end_date_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_start_time_line" id="hidden_field_data_start_time" style="<?php echo $sStyleHidden_start_time; ?>"> <span class="scFormLabelOddFormat css_start_time_label" style=""><span id="id_label_start_time"><?php echo $this->nm_new_label['start_time']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_end_time_line" id="hidden_field_data_end_time" style="<?php echo $sStyleHidden_end_time; ?>"> <span class="scFormLabelOddFormat css_end_time_label" style=""><span id="id_label_end_time"><?php echo $this->nm_new_label['end_time']; ?></span></span><br>
...
<?php } 
?> 
<?php $sStyleHidden_start_time_dumb = ('' == $sStyleHidden_start_time) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_start_time_dumb" style="<?php echo $sStyleHidden_start_time_dumb; ?>"></TD>
<?php $sStyleHidden_end_time_dumb = ('' == $sStyleHidden_end_time) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_end_time_dumb" style="<?php echo $sStyleHidden_end_time_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css___calend_all_day___line" id="hidden_field_data___calend_all_day__" style="<?php echo $sStyleHidden___calend_all_day__; ?>"> <span class="scFormLabelOddFormat css___calend_all_day___label" style=""><span id="id_label___calend_all_day__"><?php echo $this->nm_new_label['__calend_all_day__']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['Lookup___calend_all_day__'][] = 'Y'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_recurrence_line" id="hidden_field_data_recurrence" style="<?php echo $sStyleHidden_recurrence; ?>"> <span class="scFormLabelOddFormat css_recurrence_label" style=""><span id="id_label_recurrence"><?php echo $this->nm_new_label['recurrence']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['Lookup_recurrence'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['Lookup_recurrence'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_period_line" id="hidden_field_data_period" style="<?php echo $sStyleHidden_period; ?>"> <span class="scFormLabelOddFormat css_period_label" style=""><span id="id_label_period"><?php echo $this->nm_new_label['period']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call || $this->form_3versions_single) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("cal_lodge");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("cal_lodge");
 parent.scAjaxDetailHeight("cal_lodge", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
