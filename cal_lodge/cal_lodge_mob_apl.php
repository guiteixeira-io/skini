...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_cal_lodge_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new cal_lodge_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['cal_lodge_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cal_lodge_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cal_lodge_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cal_lodge_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cal_lodge_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('cal_lodge_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cal_lodge_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " cal_lodge";
      ...
      $_SESSION['scriptcase']['error_icon']['cal_lodge_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['cal_lodge_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cal_lodge_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cal_lodge_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cal_lodge_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dados_form'];
          if (!isset($this->id)){$this->id = $this->nmgp_dados_form['id'];} 
          if (!isset($this->description)){$this->description = $this->nmgp_dados_form['description'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("cal_lodge_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'cal_lodge/cal_lodge_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'cal_lodge_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'cal_lodge_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'cal_lodge_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'cal_lodge/cal_lodge_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "cal_lodge_mob_erro.class.php"); 
      }
      $this->Erro      = new cal_lodge_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['cal_lodge_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['cal_lodge_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['cal_lodge_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          cal_lodge_mob_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['cal_lodge_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "cal_lodge_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " cal_lodge") ?></TITLE>
...
<form name="Fdown" method="get" action="cal_lodge_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="cal_lodge_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="cal_lodge_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_cal_lodge_mob']) || !is_array($this->NM_ajax_info['errList']['geral_cal_lodge_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_cal_lodge_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_cal_lodge_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['bypass_required_time']['start_time'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['bypass_required_time']['end_time'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['bypass_required_time']['start_time'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['bypass_required_time']['end_time'] = false;
...
//---
    ...
    function ValidateField_title(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if (isset($this->Field_no_validate['title'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['php_cmp_required']['title']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['php_cmp_required']['title'] == "on")) 
      { 
          if ($this->title == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_category(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['category'])) {
       return;
   }
               if (!empty($this->category) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category']) && !in_array($this->category, $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['category']))
                   {
                       $Campos_Erros['category'] = array();
                   }
                   $Campos_Erros['category'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['category']) || !is_array($this->NM_ajax_info['errList']['category']))
                   {
                       $this->NM_ajax_info['errList']['category'] = array();
                   }
                   $this->NM_ajax_info['errList']['category'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'category';
    ...
    function ValidateField_id_api(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['id_api'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
    ...
    function ValidateField_event_color(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['event_color'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
    ...
    function ValidateField_start_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['start_date'])) {
          return;
      }
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['php_cmp_required']['start_date']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['php_cmp_required']['start_date'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_end_date(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['end_date'])) {
          return;
      }
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
    ...
    function ValidateField_start_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['start_time'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      {
    ...
    function ValidateField_end_time(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if (isset($this->Field_no_validate['end_time'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      {
    ...
    function ValidateField___calend_all_day__(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['__calend_all_day__'])) {
       return;
   }
    ...
    function ValidateField_recurrence(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['recurrence'])) {
       return;
   }
    ...
    function ValidateField_period(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['period'])) {
       return;
   }
    ...
    function ValidateField_recur_info(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['recur_info'])) {
          return;
      }
      $tmpRecurInfo = null;
      if ($this->nmgp_opcao != "excluir")
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = cal_lodge_mob_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category'] = array(); 
}
$aLookup[] = array(cal_lodge_mob_pack_protect_string('') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category'][] = '';
   ...
   $nm_comando = "SELECT idLodgeCategory, name, color FROM cad_lodge_category  ORDER BY name";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(cal_lodge_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', cal_lodge_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_category'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['category']['valList'][$i] = cal_lodge_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(cal_lodge_mob_pack_protect_string('Y') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup___calend_all_day__'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['__calend_all_day__']['valList'][$i] = cal_lodge_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(cal_lodge_mob_pack_protect_string('Y') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_yes'] . "")));
$aLookup[] = array(cal_lodge_mob_pack_protect_string('N') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_peri_no'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_recurrence'][] = 'Y';
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_recurrence'][] = 'N';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['recurrence']['valList'][$i] = cal_lodge_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(cal_lodge_mob_pack_protect_string('D') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_daily'] . "")));
$aLookup[] = array(cal_lodge_mob_pack_protect_string('W') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_weekly'] . "")));
$aLookup[] = array(cal_lodge_mob_pack_protect_string('M') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_monthly'] . "")));
$aLookup[] = array(cal_lodge_mob_pack_protect_string('A') => str_replace('<', '&lt;',cal_lodge_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_recu_annual'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_period'][] = 'D';
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_period'][] = 'W';
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_period'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Lookup_period'][] = 'A';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['period']['valList'][$i] = cal_lodge_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opcao'] = '';
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->recurrence = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->recurrence);
          }
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->id_event_google = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->id_event_google);
          }
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->recur_info = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->recur_info);
          }
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->event_color = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->event_color);
          }
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->creator = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->creator);
          }
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->reminder = str_replace(array("\\r\\n", "\\n", "\r\n"), array("\r\n", "\n", "\n"), $this->reminder);
          }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "title = '$this->title', start_date = #$this->start_date#, start_time = #$this->start_time#, end_date = #$this->end_date#, end_time = #$this->end_time#, recurrence = '$this->recurrence', period = '$this->period', category = $this->category, id_api = '$this->id_api', recur_info = '$this->recur_info', event_color = '$this->event_color'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['description']) && $NM_val_form['description'] != $this->nmgp_dados_select['description']) 
              { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('title', 'category', 'id_api', 'event_color', 'start_date', 'end_date', 'start_time', 'end_time', '__calend_all_day__', 'recurrence', 'period', 'recur_info'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
                  $aWhere[] = "id = $this->id"; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("cal_lodge_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("title", "category", "id_api", "event_color", "start_date", "end_date", "start_time", "end_time", "recurrence", "period", "recur_info"))) {
            $searchOk = true;
        }
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("title", "category", "id_api", "event_color", "start_date", "end_date", "start_time", "end_time", "recurrence", "period", "recur_info"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['table_refresh'])
        {
    ...
    function calendarGetFullCalendarLocale($scLocale, $calendarType)
    {
        switch ($scLocale) {
            case 'cz':
                return 'cs';
            case 'pt_pt':
                if ('mini' == $calendarType) {
                    return 'pt-br';
                } else {
                    return 'pt-pt';
                }
            case 'thai':
                return 'th';
            default:
                return str_replace('_', '-', $scLocale);
        }
    }

    function calendarGetFullCalendarFirstDay($scFirstDay, $calendarType)
    {
        return $scFirstDay;
    }
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_outra_jan'] != 'cal_lodge_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
?>
 ...
 <script type="text/javascript" src="<?php echo $this->Ini->path_prod; ?>/third/jquery_plugin/fullcalendar/packages/core/index.global.min.js"></script>
 <script type="text/javascript" src="<?php echo $this->Ini->path_prod; ?>/third/jquery_plugin/fullcalendar/packages/core/locales-all.global.min.js"></script>
 <script type="text/javascript" src="<?php echo $this->Ini->path_prod; ?>/third/jquery_plugin/fullcalendar/packages/moment/moment.js"></script>
 <script type="text/javascript" src="<?php echo $this->Ini->path_prod; ?>/third/jquery_plugin/fullcalendar/dist/index.global.min.js"></script>
 <script type="text/javascript" src="<?php echo $this->Ini->path_prod; ?>/third/jquery_plugin/fullcalendar/packages/moment/index.global.min.js"></script>
 <script type="text/javascript" src="<?php echo $this->Ini->path_prod; ?>/third/jquery_plugin/fullcalendar/packages/google-calendar/index.global.min.js"></script>
<?php
...
@media (max-width: 1200px) {
    div.fc .fc-toolbar .fc-toolbar-title{
        display:none !important;
    }
}
@media (max-width: 1150px) {
    div.fc .fc-toolbar .fc-center{
        display:inline-block !important;
    }
    div.fc#calendar_mini button.fc-today-button,
    div.fc button.fc-today-button,
    div.fc button.fc-print-button,
    div.fc button.fc-importGoogle-button,
    div.fc button.fc-exportGoogle-button,
    div.fc button.fc-dayGridMonth-button,
    div.fc button.fc-timeGridWeek-button,
    div.fc button.fc-timeGridDay-button,
    div.fc button.fc-listMonth-button {
...
.fc-timegrid-col-events .fc-event-title {
    white-space: normal;
    word-break: break-word;
}
...
.fc-timegrid-event-harness .scCalendarEventPast {
    padding: 1px 3px !important;
}
.fc-timegrid-event-harness .scCalendarEventOnDay {
    padding: 1px 3px !important;
}
.fc-timegrid-event-harness .scCalendarEventFuture {
    padding: 1px 3px !important;
}
.fc-timegrid-event-harness .scCalendarEventPastFont:after {
    content: "";
}
.fc-timegrid-event-harness .scCalendarEventOnDayFont:after {
    content: "";
}
.fc-timegrid-event-harness .scCalendarEventFutureFont:after {
    content: "";
}
...
<?php
        ...
        $this->calendarOutput_javascript_mainCalendar($javascriptParams);
        if (!isset($_SESSION['scriptcase']['device_mobile']) || !$_SESSION['scriptcase']['device_mobile'] || !$_SESSION['scriptcase']['display_mobile']) {
            $this->calendarOutput_javascript_miniCalendar($javascriptParams);
        }
?>
$(function() {
<?php
...
var scMainCalendar, scMiniCalendar, firstDateOfWeek, firstMonthOfWeek;
...
{
    scMainCalendar.refetchEvents();
}
function calendar_print()
{
    $.ajax({
        url: "cal_lodge_mob.php",
        type: "GET",
        dataType: "json",
        data: {
            nmgp_opcao: "calendar_print",
            category: getCategory(true),
            start: scMainCalendar.view.currentStart.toISOString(),
            end: scMainCalendar.view.currentEnd.toISOString()
        }
    }).done(function(data) {
...
function getEventTitle(info, fontClass)
{
    return '<div class="fc-event-title ' + fontClass + '">' + info.event._def.title + '</div>';
}
function getEventTime(info, fontClass)
{
    if (info.event._def.allDay) {
        return "";
    }
    let eventTime = getEventTime24H(info.event._instance.range.start);
    return '<div class="fc-event-time ' + fontClass + '">' + eventTime + '</div>';
}
function getEventTimeRange(info, fontClass)
{
    if (info.event._def.allDay) {
        return "";
    }
    let eventDuration = (info.event._instance.range.end - info.event._instance.range.start) / 1000 / 60,
        eventTimeStart = getEventTime24H(info.event._instance.range.start),
        eventTimeEnd = getEventTime24H(info.event._instance.range.end);
    if (eventDuration > 30) {
        return '<div class="fc-event-time ' + fontClass + '">' + eventTimeStart + ' - ' + eventTimeEnd  + '</div>' +
            '<div class="fc-event-title ' + fontClass + '">' + info.event._def.title + '</div>';
    } else {
        return '<div class="fc-event-time ' + fontClass + '">' + eventTimeStart + ' - ' + info.event._def.title  + '</div>';
    }
}
function getEventTimeAmPm(dateObj)
{
    if ("" == "<?php echo $_SESSION['scriptcase']['reg_conf']['time_simb_am'] ?>") {
        return getEventTime24H(dateObj);
    }
    let hours = dateObj.getUTCHours(), minutes = dateObj.getUTCMinutes(), suffix;
    if (hours > 12) {
        ampm = "<?php echo $_SESSION['scriptcase']['reg_conf']['time_simb_pm'] ?>";
        if (hours > 12) {
            hours -= 12;
        }
    } else {
        ampm = "<?php echo $_SESSION['scriptcase']['reg_conf']['time_simb_am'] ?>";
    }
    if (hours < 10) {
...
<?php
if ("left_with_space" == $_SESSION['scriptcase']['reg_conf']['time_pos_ampm']) {
?>
    return ampm + " " + hours + ":" + minutes;
<?php
} elseif ("left_without_space" == $_SESSION['scriptcase']['reg_conf']['time_pos_ampm']) {
?>
    return ampm + hours + ":" + minutes;
<?php
} elseif ("right_with_space" == $_SESSION['scriptcase']['reg_conf']['time_pos_ampm']) {
?>
...
function getEventTime24H(dateObj)
{
    let hours = dateObj.getUTCHours(), minutes = dateObj.getUTCMinutes();
    if (hours < 10) {
        hours = "0" + hours.toString();
    } else {
        hours = hours.toString();
...
function getEventDescription(info, fontClass)
{
    if (info.event._def.extendedProps.description && info.event._def.extendedProps.description != '') {
        return '<div class="fc-event-description ' + fontClass + '" style="overflow: hidden; text-overflow: ellipsis"><span style="font-size: 80%;">' + info.event._def.extendedProps.description + '</span></div>';
    }
    return "";
}
function getEventFontClass(info)
{
    if (info.event._def.ui.classNames.includes("scCalendarEventPast")) {
        return "scCalendarEventPastFont";
    }
    if (info.event._def.ui.classNames.includes("scCalendarEventOnDay")) {
        return "scCalendarEventOnDayFont";
    }
    if (info.event._def.ui.classNames.includes("scCalendarEventFuture")) {
        return "scCalendarEventFutureFont";
    }
    return "";
}
...
{
    var eventSource = scMainCalendar.getEventSources();
    eventSource[0].remove();
    setCategory();
    scMainCalendar.addEventSource('cal_lodge_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'cal_lodge_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'cal_lodge_mob.php?nmgp_opcao=igual_calendar&id=' + sEventId + '&__orig_id=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
...
{
    scMainCalendar.changeView('dayGridMonth');
}
function mobileMenuWeekClick()
{
    scMainCalendar.changeView('timeGridWeek');
}
function mobileMenuDayClick()
{
    scMainCalendar.changeView('timeGridDay');
}
function mobileMenuAgendaClick()
{
    scMainCalendar.changeView('listMonth');
}
...
{
    tb_show('', 'cal_lodge_mob.php?nmgp_opcao=importGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=150&width=400', '');
}
function mobileMenuExportClick()
{
    tb_show('', 'cal_lodge_mob.php?nmgp_opcao=exportGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=280&width=450', '');
}
...
{
    let calendarDate = scMainCalendar.currentData.currentDate.toISOString();
...
function monthPicker_goToDate(thisMonth)
{
    ...
    scMainCalendar.gotoDate(thisYear + "-" + thisMonth + "-01");
    history.back();
}
...
<?php
    ...
    function calendarOutput_javascript_miniCalendar($javascriptParams)
    {
?>
        document.addEventListener('DOMContentLoaded', function() {
            var miniCalendarEl = document.getElementById('calendar_mini');
            scMiniCalendar = new FullCalendar.Calendar(miniCalendarEl, {
                header: {
                    left: 'prev,next today',
                    center: 'title',
                    right: '',
                },
                locale: "<?php echo $this->calendarGetFullCalendarLocale($_SESSION['scriptcase']['str_lang'], 'mini'); ?>",
                buttonText: {
                    today: "<?php echo html_entity_decode($this->Ini->Nm_lang["lang_per_today"], ENT_COMPAT, $_SESSION["scriptcase"]["charset"]); ?>",
                },
                firstDay: <?php echo $this->calendarGetFullCalendarFirstDay($javascriptParams['first_day'], 'mini'); ?>,
                dateClick: function(info) {
                    scMainCalendar.gotoDate(info.dateStr);
                },
                aspectRatio: 1.2,
                initialView: 'dayGridMonth'
            });
            scMiniCalendar.render();
        });
<?php
    } // calendarOutput_javascript_miniCalendar

    function calendarOutput_javascript_mainCalendar($javascriptParams)
    {
        $googleButtons = '';
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
            $googleButtons = '';
...
?>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var googleButtons = '<?php echo $googleButtons ?>';
            scMainCalendar = new FullCalendar.Calendar(mainCalendarEl, {
                editable: <?php echo ($this->calendarConfigValues['update'] ? 'true' : 'false'); ?>,
                headerToolbar: {
                    left: 'prev,next today print' + googleButtons,
                    center: 'title',
                    right: 'dayGridMonth,timeGridWeek,timeGridDay,listMonth<?php if ('' != $javascriptParams['app_return']) { echo ' goBack'; } ?>'
                },
                buttonText: {
                    today: "<?php echo html_entity_decode($this->Ini->Nm_lang["lang_per_today"], ENT_COMPAT, $_SESSION["scriptcase"]["charset"]); ?>",
                ...
                locale: "<?php echo $this->calendarGetFullCalendarLocale($_SESSION['scriptcase']['str_lang'], 'main'); ?>",
                customButtons: {
                    print: {
                ...
                views: {
                    dayGridMonth: {
                        eventContent: function (arg) {
                            let eventFontClass = getEventFontClass(arg);
                            let eventHtml = getEventTime(arg, eventFontClass)
                                          + getEventTitle(arg, eventFontClass)
                                          + getEventDescription(arg, eventFontClass);
                    ...
                    timeGridWeek: {
                        eventContent: function (arg) {
                            let eventFontClass = getEventFontClass(arg);
                            let eventHtml = getEventTimeRange(arg, eventFontClass)
                                          + getEventDescription(arg, eventFontClass);
                            return {html: eventHtml};
                        },
                        slotLabelContent: function(arg) {
                            let timeString = '';
                            timeString += arg.date.getHours() + ':';
                            if (10 > arg.date.getMinutes()) {
                                timeString += '0' + arg.date.getMinutes();
                            } else {
                                timeString += arg.date.getMinutes();
                            }
                            return timeString;
                        }
                    },
                ...
                firstDay: <?php echo $this->calendarGetFullCalendarFirstDay($javascriptParams['first_day'], 'main'); ?>,
                weekNumberCalculation: "ISO",
                nextDayThreshold: "00:00:00",
                eventStartEditable: true,
                allDaySlot: true,
                allDayContent: "<?php echo html_entity_decode($this->Ini->Nm_lang["lang_per_allday"], ENT_COMPAT, $_SESSION["scriptcase"]["charset"]); ?>",
                events: 'cal_lodge_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
                ...
                eventDidMount: function (arg) {
                    if ("" != arg.backgroundColor) {
                        $(arg.el).css({
                            ...
                            borderColor: arg.backgroundColor
                        });
                    }
                },
                eventDrop: function(info) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            'sc_event_id': info.event.id,
                            'sc_day_delta': info.delta.days,
                            'sc_time_delta': (info.delta.milliseconds / 1000) / 60,
                            'sc_all_day': info.event.allDay,
                            'sc_fullcal_start': (info.event._start && info.event._start._d ? info.event._start._d.toISOString() : ''),
                            'sc_fullcal_end': (info.event._end && info.event._end._d ? info.event._end._d.toISOString() : '')
                        },
                        success: function(data) {
                            ...
                            if (typeof data['status'] !== "undefined" && false == data['status']) {
                                ...
                                if (typeof data['backgroundColor'] !== "undefined" && '' != data['backgroundColor']) {
                                    if (!info.event._def.ui.classNames.includes(data['backgroundColor'])) {
                                        bChanged = true;
                                    }
                                }
                                if (info.event._def.allDay || bChanged) {
                                    scMainCalendar.refetchEvents();
                                }
                            }
                ...
                eventResize: function(info) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            'sc_event_id': info.event.id,
                            'sc_day_delta': info.endDelta.days,
                            'sc_time_delta': (info.endDelta.milliseconds / 1000) / 60,
                            'sc_fullcal_start': (info.event._start && info.event._start._d ? info.event._start._d.toISOString() : ''),
                            'sc_fullcal_end': (info.event._end && info.event._end._d ? info.event._end._d.toISOString() : '')
                        },
                        success: function(data) {
...
?>
                    var sDate = info.dateStr, sTime = '00:00:00', allDay = false;
                    if (sDate.indexOf('T') > 0) {
                        dateParts = info.dateStr.split('T');
                        sDate = dateParts[0], sTime = dateParts[1];
                        if (sTime.indexOf('-') > 0) {
                            sTime = sTime.split('-');
                            sTime = sTime[0];
                        }
                    } else if ('dayGridMonth' == info.view.type) {
                        sTime = '06:00:00';
                    } else {
                        allDay = true;
                    }
...
?>
            ...
            scMainCalendar.render();
        });
<?php
    } // calendarOutput_javascript_mainCalendar
...
<?php
    ...
    {
?>
<div class="sc-cal-calendar-container" style="flex-grow: 1">
    <div id="calendar" style="min-width: 260px; display:inline-block; margin-left:4px; vertical-align: top; flex-grow: 1;"></div>
</div>
<?php
    ...
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['under_dashboard']) {
?>
<style type="text/css">
...
<?php
    ...
    function calendarOutput_formMobile()
    {
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
<form name="F1" id="sc-ui-form" method="post" action="cal_lodge.php" target="_self">
...
<SCRIPT LANGUAGE="Javascript">
   ...
   if (typeof self.parent.calendar_reload == "function")
   {
...
<?php
       ...
       if (null === $filter) {
           ...
           if (!$bRecur) {
               if ('' != $sStart && '' != $sEnd)
               {
                   if (!$bPrintCalendar)
                   {
                       $s_Ini_StartFormat = date('Y-m-d', $this->calendarFullcalendarToTimestamp($sStart));
                       $s_Ini_EndFormat   = date('Y-m-d', $this->calendarFullcalendarToTimestamp($sEnd));
                   }
                   else
                   {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp" || $field == "category") 
          {
              ...
              {
                  $this->SC_monta_condicao($comando, "category", $arg_search, $data_lookup, "INT", false);
              }
          }
          if ($field == "SC_all_Cmp" || $field == "id_api") 
          {
              $this->SC_monta_condicao($comando, "id_api", $arg_search, $data_search, "VARCHAR", false);
          }
          if ($field == "SC_all_Cmp" || $field == "event_color") 
          {
              $this->SC_monta_condicao($comando, "event_color", $arg_search, $data_search, "VARCHAR", false);
          }
          ...
          if ($field == "SC_all_Cmp" || $field == "recurrence") 
          {
              ...
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "recurrence", $arg_search, $data_lookup, "VARCHAR", false);
              }
          }
          if ($field == "SC_all_Cmp" || $field == "period") 
          {
              ...
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "period", $arg_search, $data_lookup, "VARCHAR", false);
              }
          }
          if ($field == "SC_all_Cmp" || $field == "recur_info") 
          {
              $this->SC_monta_condicao($comando, "recur_info", $arg_search, $data_search, "VARCHAR", false);
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_cal_lodge_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['total'] = $qt_geral_reg_cal_lodge_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          cal_lodge_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_category($condicao, $campo)
   {
       ...
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT color, name, idLodgeCategory FROM cad_lodge_category WHERE (#cmp_icolor#cmp_f#cmp_apos LIKE '%#arg_i" . $campo . "#arg_f%'#arg_apos)" ; 
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "cal_lodge_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "cal_lodge_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['ordem_ord'] == " desc") {
