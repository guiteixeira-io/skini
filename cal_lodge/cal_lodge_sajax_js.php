...
?>
  ...
  // ---------- Validate title
  function do_ajax_cal_lodge_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_title(var_title, var_script_case_init, do_ajax_cal_lodge_validate_title_cb);
  } // do_ajax_cal_lodge_validate_title

  function do_ajax_cal_lodge_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_title_cb

  // ---------- Validate category
  function do_ajax_cal_lodge_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldSelect(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_category(var_category, var_script_case_init, do_ajax_cal_lodge_validate_category_cb);
  } // do_ajax_cal_lodge_validate_category

  function do_ajax_cal_lodge_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_category_cb

  // ---------- Validate id_api
  function do_ajax_cal_lodge_validate_id_api()
  {
    var nomeCampo_id_api = "id_api";
    var var_id_api = scAjaxGetFieldText(nomeCampo_id_api);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_id_api(var_id_api, var_script_case_init, do_ajax_cal_lodge_validate_id_api_cb);
  } // do_ajax_cal_lodge_validate_id_api

  function do_ajax_cal_lodge_validate_id_api_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_api";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_id_api_cb

  // ---------- Validate event_color
  function do_ajax_cal_lodge_validate_event_color()
  {
    var nomeCampo_event_color = "event_color";
    var var_event_color = scAjaxGetFieldText(nomeCampo_event_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_event_color(var_event_color, var_script_case_init, do_ajax_cal_lodge_validate_event_color_cb);
  } // do_ajax_cal_lodge_validate_event_color

  function do_ajax_cal_lodge_validate_event_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_event_color_cb

  // ---------- Validate start_date
  function do_ajax_cal_lodge_validate_start_date()
  {
    ...
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_cal_lodge_validate_start_date(var_start_date, var_script_case_init, do_ajax_cal_lodge_validate_start_date_cb);
    }, 200);
  } // do_ajax_cal_lodge_validate_start_date

  function do_ajax_cal_lodge_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_cal_lodge_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_end_date(var_end_date, var_script_case_init, do_ajax_cal_lodge_validate_end_date_cb);
  } // do_ajax_cal_lodge_validate_end_date

  function do_ajax_cal_lodge_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_cal_lodge_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_start_time(var_start_time, var_script_case_init, do_ajax_cal_lodge_validate_start_time_cb);
  } // do_ajax_cal_lodge_validate_start_time

  function do_ajax_cal_lodge_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_cal_lodge_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_end_time(var_end_time, var_script_case_init, do_ajax_cal_lodge_validate_end_time_cb);
  } // do_ajax_cal_lodge_validate_end_time

  function do_ajax_cal_lodge_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_end_time_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_cal_lodge_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_cal_lodge_validate___calend_all_day___cb);
  } // do_ajax_cal_lodge_validate___calend_all_day__

  function do_ajax_cal_lodge_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate___calend_all_day___cb

  // ---------- Validate recurrence
  function do_ajax_cal_lodge_validate_recurrence()
  {
    var nomeCampo_recurrence = "recurrence";
    var var_recurrence = scAjaxGetFieldSelect(nomeCampo_recurrence);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_recurrence(var_recurrence, var_script_case_init, do_ajax_cal_lodge_validate_recurrence_cb);
  } // do_ajax_cal_lodge_validate_recurrence

  function do_ajax_cal_lodge_validate_recurrence_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_recurrence_cb

  // ---------- Validate period
  function do_ajax_cal_lodge_validate_period()
  {
    var nomeCampo_period = "period";
    var var_period = scAjaxGetFieldSelect(nomeCampo_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_period(var_period, var_script_case_init, do_ajax_cal_lodge_validate_period_cb);
  } // do_ajax_cal_lodge_validate_period

  function do_ajax_cal_lodge_validate_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "period";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_period_cb

  // ---------- Validate recur_info
  function do_ajax_cal_lodge_validate_recur_info()
  {
    var nomeCampo_recur_info = "recur_info";
    var var_recur_info = scAjaxGetFieldRecurInfo(nomeCampo_recur_info);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_validate_recur_info(var_recur_info, var_script_case_init, do_ajax_cal_lodge_validate_recur_info_cb);
  } // do_ajax_cal_lodge_validate_recur_info

  function do_ajax_cal_lodge_validate_recur_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_validate_recur_info_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cal_lodge_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cal_lodge_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cal_lodge_submit_form(var_title, var_category, var_id_api, var_event_color, var_start_date, var_end_date, var_start_time, var_end_time, var___calend_all_day__, var_recurrence, var_period, var_recur_info, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cal_lodge_submit_form_cb);
  } // do_ajax_cal_lodge_submit_form

  function do_ajax_cal_lodge_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cal_lodge_submit_form_cb_after_alert);
  } // do_ajax_cal_lodge_submit_form_cb
  function do_ajax_cal_lodge_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cal_lodge_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cal_lodge_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cal_lodge_navigate_form, function() {});
    } else {
      perform_ajax_cal_lodge_navigate_form();
    }
  }

  function perform_ajax_cal_lodge_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cal_lodge_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cal_lodge_navigate_form_cb);
  } // do_ajax_cal_lodge_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cal_lodge_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cal_lodge_navigate_form_cb_after_alert);
  } // do_ajax_cal_lodge_navigate_form_cb
  function do_ajax_cal_lodge_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_cal_lodge_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cal_lodge_navigate_form_cb_after_alert

  function sc_hide_cal_lodge_form()
  {
