  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cal_lodge_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate title
  function do_ajax_cal_lodge_mob_validate_title()
  {
    var nomeCampo_title = "title";
    var var_title = scAjaxGetFieldText(nomeCampo_title);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_title(var_title, var_script_case_init, do_ajax_cal_lodge_mob_validate_title_cb);
  } // do_ajax_cal_lodge_mob_validate_title

  function do_ajax_cal_lodge_mob_validate_title_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_title_cb

  // ---------- Validate category
  function do_ajax_cal_lodge_mob_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldSelect(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_category(var_category, var_script_case_init, do_ajax_cal_lodge_mob_validate_category_cb);
  } // do_ajax_cal_lodge_mob_validate_category

  function do_ajax_cal_lodge_mob_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "category";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_category_cb

  // ---------- Validate id_api
  function do_ajax_cal_lodge_mob_validate_id_api()
  {
    var nomeCampo_id_api = "id_api";
    var var_id_api = scAjaxGetFieldText(nomeCampo_id_api);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_id_api(var_id_api, var_script_case_init, do_ajax_cal_lodge_mob_validate_id_api_cb);
  } // do_ajax_cal_lodge_mob_validate_id_api

  function do_ajax_cal_lodge_mob_validate_id_api_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_api";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_id_api_cb

  // ---------- Validate event_color
  function do_ajax_cal_lodge_mob_validate_event_color()
  {
    var nomeCampo_event_color = "event_color";
    var var_event_color = scAjaxGetFieldText(nomeCampo_event_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_event_color(var_event_color, var_script_case_init, do_ajax_cal_lodge_mob_validate_event_color_cb);
  } // do_ajax_cal_lodge_mob_validate_event_color

  function do_ajax_cal_lodge_mob_validate_event_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "event_color";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_event_color_cb

  // ---------- Validate start_date
  function do_ajax_cal_lodge_mob_validate_start_date()
  {
    var nomeCampo_start_date = "start_date";
    var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
      x_ajax_cal_lodge_mob_validate_start_date(var_start_date, var_script_case_init, do_ajax_cal_lodge_mob_validate_start_date_cb);
    }, 200);
  } // do_ajax_cal_lodge_mob_validate_start_date

  function do_ajax_cal_lodge_mob_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "start_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_cal_lodge_mob_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_end_date(var_end_date, var_script_case_init, do_ajax_cal_lodge_mob_validate_end_date_cb);
  } // do_ajax_cal_lodge_mob_validate_end_date

  function do_ajax_cal_lodge_mob_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "end_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_end_date_cb

  // ---------- Validate start_time
  function do_ajax_cal_lodge_mob_validate_start_time()
  {
    var nomeCampo_start_time = "start_time";
    var var_start_time = scAjaxGetFieldText(nomeCampo_start_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_start_time(var_start_time, var_script_case_init, do_ajax_cal_lodge_mob_validate_start_time_cb);
  } // do_ajax_cal_lodge_mob_validate_start_time

  function do_ajax_cal_lodge_mob_validate_start_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "start_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_start_time_cb

  // ---------- Validate end_time
  function do_ajax_cal_lodge_mob_validate_end_time()
  {
    var nomeCampo_end_time = "end_time";
    var var_end_time = scAjaxGetFieldText(nomeCampo_end_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_end_time(var_end_time, var_script_case_init, do_ajax_cal_lodge_mob_validate_end_time_cb);
  } // do_ajax_cal_lodge_mob_validate_end_time

  function do_ajax_cal_lodge_mob_validate_end_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "end_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_end_time_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_cal_lodge_mob_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_cal_lodge_mob_validate___calend_all_day___cb);
  } // do_ajax_cal_lodge_mob_validate___calend_all_day__

  function do_ajax_cal_lodge_mob_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate___calend_all_day___cb

  // ---------- Validate recurrence
  function do_ajax_cal_lodge_mob_validate_recurrence()
  {
    var nomeCampo_recurrence = "recurrence";
    var var_recurrence = scAjaxGetFieldSelect(nomeCampo_recurrence);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_recurrence(var_recurrence, var_script_case_init, do_ajax_cal_lodge_mob_validate_recurrence_cb);
  } // do_ajax_cal_lodge_mob_validate_recurrence

  function do_ajax_cal_lodge_mob_validate_recurrence_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recurrence";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_recurrence_cb

  // ---------- Validate period
  function do_ajax_cal_lodge_mob_validate_period()
  {
    var nomeCampo_period = "period";
    var var_period = scAjaxGetFieldSelect(nomeCampo_period);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_period(var_period, var_script_case_init, do_ajax_cal_lodge_mob_validate_period_cb);
  } // do_ajax_cal_lodge_mob_validate_period

  function do_ajax_cal_lodge_mob_validate_period_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "period";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_period_cb

  // ---------- Validate recur_info
  function do_ajax_cal_lodge_mob_validate_recur_info()
  {
    var nomeCampo_recur_info = "recur_info";
    var var_recur_info = scAjaxGetFieldRecurInfo(nomeCampo_recur_info);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cal_lodge_mob_validate_recur_info(var_recur_info, var_script_case_init, do_ajax_cal_lodge_mob_validate_recur_info_cb);
  } // do_ajax_cal_lodge_mob_validate_recur_info

  function do_ajax_cal_lodge_mob_validate_recur_info_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "recur_info";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cal_lodge_mob_validate_recur_info_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cal_lodge_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cal_lodge_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_title = scAjaxGetFieldText("title");
    var var_category = scAjaxGetFieldSelect("category");
    var var_id_api = scAjaxGetFieldText("id_api");
    var var_event_color = scAjaxGetFieldText("event_color");
    var var_start_date = scAjaxGetFieldText("start_date");
    var var_end_date = scAjaxGetFieldText("end_date");
    var var_start_time = scAjaxGetFieldText("start_time");
    var var_end_time = scAjaxGetFieldText("end_time");
    var var___calend_all_day__ = scAjaxGetFieldCheckbox("__calend_all_day__", ";");
    var var_recurrence = scAjaxGetFieldSelect("recurrence");
    var var_period = scAjaxGetFieldSelect("period");
    var var_recur_info = scAjaxGetFieldRecurInfo("recur_info");
    ...
    scAjaxProcOn();
    x_ajax_cal_lodge_mob_submit_form(var_title, var_category, var_id_api, var_event_color, var_start_date, var_end_date, var_start_time, var_end_time, var___calend_all_day__, var_recurrence, var_period, var_recur_info, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cal_lodge_mob_submit_form_cb);
  } // do_ajax_cal_lodge_mob_submit_form

  function do_ajax_cal_lodge_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cal_lodge_mob_submit_form_cb_after_alert);
  } // do_ajax_cal_lodge_mob_submit_form_cb
  function do_ajax_cal_lodge_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cal_lodge_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cal_lodge_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cal_lodge_mob_navigate_form, function() {});
    } else {
      perform_ajax_cal_lodge_mob_navigate_form();
    }
  }

  function perform_ajax_cal_lodge_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cal_lodge_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cal_lodge_mob_navigate_form_cb);
  } // do_ajax_cal_lodge_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cal_lodge_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cal_lodge_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cal_lodge_mob_navigate_form_cb_after_alert);
  } // do_ajax_cal_lodge_mob_navigate_form_cb
  function do_ajax_cal_lodge_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_cal_lodge_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cal_lodge_mob_navigate_form_cb_after_alert

  function sc_hide_cal_lodge_mob_form()
  {
  ...
  ajax_field_list[0] = "title";
  ajax_field_list[1] = "category";
  ajax_field_list[2] = "id_api";
  ajax_field_list[3] = "event_color";
  ajax_field_list[4] = "start_date";
  ajax_field_list[5] = "end_date";
  ajax_field_list[6] = "start_time";
  ajax_field_list[7] = "end_time";
  ajax_field_list[8] = "__calend_all_day__";
  ajax_field_list[9] = "recurrence";
  ajax_field_list[10] = "period";
  ajax_field_list[11] = "recur_info";
  ...
  var ajax_error_list = {
    "title": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_title'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "category": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_category'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "id_api": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_id_api'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "event_color": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_event_color'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "start_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_start_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "end_date": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_end_date'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "start_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_start_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "end_time": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_end_time'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "__calend_all_day__": {"label": "<?php echo $this->Ini->Nm_lang['lang_per_allday'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "recurrence": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_recurrence'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "period": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_period'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "recur_info": {"label": "<?php echo $this->Ini->Nm_lang['lang_calendar_fld_recur_info'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    ...
    "period": new Array(),
    "recur_info": new Array()
  };
  ajax_field_mult["title"][1] = "title";
  ajax_field_mult["category"][1] = "category";
  ajax_field_mult["id_api"][1] = "id_api";
  ajax_field_mult["event_color"][1] = "event_color";
  ajax_field_mult["start_date"][1] = "start_date";
  ajax_field_mult["end_date"][1] = "end_date";
  ajax_field_mult["start_time"][1] = "start_time";
  ajax_field_mult["end_time"][1] = "end_time";
  ajax_field_mult["__calend_all_day__"][1] = "__calend_all_day__";
  ajax_field_mult["recurrence"][1] = "recurrence";
  ajax_field_mult["period"][1] = "period";
  ajax_field_mult["recur_info"][1] = "recur_info";
  ...
  var ajax_field_id = {
    ...
    "id_api": new Array("hidden_field_label_id_api", "hidden_field_data_id_api"),
    "event_color": new Array("hidden_field_label_event_color", "hidden_field_data_event_color"),
    "start_date": new Array("hidden_field_label_start_date", "hidden_field_data_start_date"),
    "end_date": new Array("hidden_field_label_end_date", "hidden_field_data_end_date"),
    "start_time": new Array("hidden_field_label_start_time", "hidden_field_data_start_time"),
    "end_time": new Array("hidden_field_label_end_time", "hidden_field_data_end_time"),
    "__calend_all_day__": new Array("hidden_field_label___calend_all_day__", "hidden_field_data___calend_all_day__"),
    "recurrence": new Array("hidden_field_label_recurrence", "hidden_field_data_recurrence"),
    "period": new Array("hidden_field_label_period", "hidden_field_data_period"),
    "recur_info": new Array("hidden_field_label_recur_info", "hidden_field_data_recur_info")
  };
