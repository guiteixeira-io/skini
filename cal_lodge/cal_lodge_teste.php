<?php  
  ...
  session_start() ;
  class cal_lodge_form_teste
  {
   function cal_lodge_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cal_lodge/img";
...
?> 
<br> 
<B><FONT SIZE="4">cal_lodge</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cal_lodge"> 
</form> 
...
<?php
  ...
  $frm_teste = new cal_lodge_form_teste();
  $frm_teste->cal_lodge_teste();
?>
