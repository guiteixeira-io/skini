...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["register"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["register"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["register"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($register_menuData["data"]) && is_array($register_menuData["data"]) && !empty($register_menuData["data"]))
    {
        foreach($register_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($register_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
