...
class register_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['register']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['register']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['register']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['register']['sc_apl_link'];
...
<?php
    exit;
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "register")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("img_menu") . "/?nm_run_menu=1&nm_apl_menu=register&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['register']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['register'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("que_costumers") . "/?nm_run_menu=1&nm_apl_menu=register&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_1")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("que_lodge_category") . "/?nm_run_menu=1&nm_apl_menu=register&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_1")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("cadastro") . "/?nmgp_outra_jan=true&nm_apl_menu=register";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("home") . "/?nmgp_outra_jan=true&nm_apl_menu=register";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_9")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("admin") . "/?nmgp_outra_jan=true&nm_apl_menu=register";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_7")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sec_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=register&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "btn_8")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("sec_login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['register']['init'] . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="register"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "register")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'register', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new register_form_php();
$controle->init();
?>
