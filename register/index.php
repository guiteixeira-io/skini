...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['register']['glo_nm_conexao']        = "skini";
    $_SESSION['scriptcase']['register']['glo_nm_path_imag_temp'] = "/scriptcase/tmp";
    $_SESSION['scriptcase']['register']['glo_nm_usa_grupo']      = "S";
...
class register_class
{
 ...
 {
    global $register_menuData, $nm_data_fixa;
...
$path_libs      = $str_root . $_SESSION['scriptcase']['register']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['register']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['register']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "register/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['register']['glo_nm_path_imag_temp'];
...
include_once(dirname(__FILE__) . "/register_erro.class.php"); 
$this->Erro = new register_erro();
$str_path = substr($_SESSION['scriptcase']['register']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['register']['glo_nm_path_prod'], '/') + 1);
...
$register_menuData         = array();
$register_menuData['path'] = array();
$register_menuData['url']  = array();
$register_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $register_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $register_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $register_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $register_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$register_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$register_menuData['url']['web']   = str_replace("\\", '/', $register_menuData['url']['web']);
$register_menuData['path']['root'] = substr($register_menuData['path']['sys'],  0, -1 * strlen($register_menuData['url']['web']));
$register_menuData['path']['app']  = substr($register_menuData['path']['sys'],  0, strrpos($register_menuData['path']['sys'],  '/'));
$register_menuData['path']['link'] = substr($register_menuData['path']['app'],  0, strrpos($register_menuData['path']['app'],  '/'));
$register_menuData['path']['link'] = substr($register_menuData['path']['link'], 0, strrpos($register_menuData['path']['link'], '/')) . '/';
$register_menuData['path']['app'] .= '/';
$register_menuData['url']['app']   = substr($register_menuData['url']['web'],  0, strrpos($register_menuData['url']['web'],  '/'));
$register_menuData['url']['link']  = substr($register_menuData['url']['app'],  0, strrpos($register_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] == "S")
{
    $register_menuData['url']['link']  = substr($register_menuData['url']['link'], 0, strrpos($register_menuData['url']['link'], '/'));
}
$register_menuData['url']['link']  .= '/';
$register_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['register']['sc_apl_link'] = $register_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['register']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['register']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['register']['actual_lang']) || $_SESSION['scriptcase']['register']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['register']['actual_lang'] = $this->str_lang;
...
include_once("register_toolbar.php");
...
if ($_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "register";
     $_SESSION['scriptcase']['menu_apls']['register'] = array();
...
if (isset($_SESSION['scriptcase']['register']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['register']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['register']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['register']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['register']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['register']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['register']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['register']['init']))
{
    $_SESSION['sc_session'][1]['register']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['register']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['register']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_register'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_register'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_register'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['register'] = "on";
} 
if (!isset($_SESSION['scriptcase']['register']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['register']) || $_SESSION['scriptcase']['sc_apl_seg']['register'] != "on"))
{ 
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['register']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['register']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'register'))
{
    $_SESSION['sc_session'][1]['register']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_register'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$register_menuData['iframe'] = TRUE;
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/cadastro_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/cadastro_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cadastro']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['cadastro'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_register'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['que_costumers']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['que_costumers']) == "on")
{
    $register_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "|register_form_php.php?sc_item_menu=item_2&sc_apl_menu=que_costumers&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->register_target('_self') . "|" . "\n";
}
else
{
    $register_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
...
{
    $register_menuData['data'] .= "item_1|.|" . $nm_var_lab[1] . "|register_form_php.php?sc_item_menu=item_1&sc_apl_menu=que_lodge_category&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->register_target('_self') . "|" . "\n";
}
else
{
    $register_menuData['data'] .= "item_1|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
...
$register_menuData['data'] = array();
$str_disabled = "N";
$str_link = "register_form_php.php?sc_item_menu=item_2&sc_apl_menu=que_costumers&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['que_costumers']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['que_costumers']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $register_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->register_target('_self') . "\"",
        'sc_id'    => "item_2",
...
$str_disabled = "N";
$str_link = "register_form_php.php?sc_item_menu=item_1&sc_apl_menu=que_lodge_category&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['que_lodge_category']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['que_lodge_category']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['register']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['register']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'register');
    $register_menuData['data'] = $str_menu_usu;
}
if (is_file("register_help.txt"))
{
    $Arq_WebHelp = file("register_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $register_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->register_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['register']) && !empty($_SESSION['scriptcase']['sc_menu_del']['register']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($register_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['register']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($register_menuData['data'][$i_menu]);
       }
    ...
    $register_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['register']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['register']))
{
    $disable_menu = false;
    foreach ($register_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['register']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $register_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($register_menuData['iframe'])
{
    $register_menuData['height'] = '100%';
    header("X-XSS-Protection: 1; mode=block");
    header("X-Frame-Options: SAMEORIGIN");
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['register']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $register_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['register']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script type="text/javascript" src="../_lib/lib/js/menu_structure.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['register']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['register']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="register_message.js"></script>
...
{
  if (str_id != "iframe_register")
  {
      str_id        = str_id.replace("register_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_register', 'register');
    //test link type
    ...
    if(str_target != '_blank' && $('#iframe_register').length)
        $('#iframe_register')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $register_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->register_escreveMenu($register_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $register_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_register');\" item-href=\"register_form_php.php?sc_item_menu=register&sc_apl_menu=img_menu&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "\"  item-target=\"register_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "register_pag_ini.php");
} 
?>
      <iframe id="iframe_register" name="register_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_register').click()";
    echo "</script>";
}
...
/* Controle de Target */
function register_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function register_target($str_target)
{
    global $register_menuData;
    ...
    elseif ($register_menuData['iframe'])
    {
        return 'register_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $register_menuData, $path_imag_cab)
{
    if(!empty($this->mobile_menu_toolbar) && ($this->force_mobile || ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile'])))
    {
        return;
    ...
    <tr id="id_toolbar">
        <td class="scMenuHTableCss" align="center" style="margin:0px; padding:0px;" <?php echo $col_span; ?>>
            ...
            <?php
                ...
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_1", "register_form_php.php?sc_item_menu=btn_1&sc_apl_menu=cadastro&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "", "register_form_php.php?sc_item_menu=btn_1&sc_apl_menu=cadastro&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "", "btn_1", "", "Cadastros", "", "absmiddle", "", "0px", $this->path_botoes, "", "Cadastros", "", "", "", "text_fontawesomeicon", "text_right", "1", "" . $this->register_target('_blank') . "", "", "", "", "register", "");
                }

              ?>
              <span id='id_group_btn_3' class='scButton_default_group' style='display: inline-block;'>
              <?php
                if ($this->nmgp_botoes['btn_6'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_6", "register_form_php.php?sc_item_menu=btn_6&sc_apl_menu=home&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "", "register_form_php.php?sc_item_menu=btn_6&sc_apl_menu=home&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "", "btn_6", "", "Inicio", "", "absmiddle", "", "0px", $this->path_botoes, "", "Inicio", "", "", "", "text_fontawesomeicon", "text_right", "1", "" . $this->register_target('_blank') . "", "", "", "", "register", "");
                }

                if ($this->nmgp_botoes['btn_9'] == "on")
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_9", "register_form_php.php?sc_item_menu=btn_9&sc_apl_menu=admin&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "", "register_form_php.php?sc_item_menu=btn_9&sc_apl_menu=admin&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . "", "btn_9", "", "Admin", "", "absmiddle", "", "0px", $this->path_botoes, "", "Admin", "", "", "", "text_fontawesomeicon", "text_right", "1", "" . $this->register_target('_blank') . "", "", "", "", "register", "");
                }
              ...
              <?php
                ...
                {
                    echo nmButtonOutput($this->arr_buttons, "btn_2", "javascript:", "javascript:", "btn_2", "", "Usuário", "", "absmiddle", "", "0px", $this->path_botoes, "", "Usuário", "", "", "__sc_grp__", "only_fontawesomeicon", "text_right", "1", "" . $this->register_target('_self') . "", "", "", "", "register", "");
                    ?>
                            ...
                            <td class="scBtnGrpBackground">
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "register_form_php.php?sc_item_menu=btn_7&sc_apl_menu=sec_change_pswd&sc_apl_link=". urlencode($register_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_7']['disabled']) && strtolower($this->arr_buttons['btn_7']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_7" href="<?php echo $str_href; ?>"   class="scBtnGrpLink" title="Alterar senha" target="<?php echo $this->register_target('_self'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-key'></i> Alterar senha</a>
                                  </div>
                              <?php
                              }
                              ?>
                              ...
                              ?>
                                  <div class="scBtnGrpText">
                                    <?php
                                    $str_href = "register_form_php.php?sc_item_menu=btn_8&sc_apl_menu=sec_login&sc_apl_link=". urlencode($register_menuData['url']['link']) ."&sc_usa_grupo=". $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] ."";
                                    if(isset($this->arr_buttons['btn_8']['disabled']) && strtolower($this->arr_buttons['btn_8']['disabled']) == 'off')
                                    {
                                      $str_href = "javascript:";
                                    }
                                    ?>
                                      <a id="btn_8" href="<?php echo $str_href; ?>"   class="scBtnGrpLink" title="" target="<?php echo $this->register_target('_parent'); ?>" style="vertical-align: middle; display:inline-block;"><i class='icon_fa fas fa-sign-out-alt'></i> <?php echo $this->Nm_lang['lang_exit']; ?></a>
                                  </div>
                              <?php
                              }
                              ?>
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "register_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "register_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($register_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['register']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->register_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['register']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['register']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['register']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "register") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['register']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['register']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['register']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_skini'])) {
            $_SESSION['scriptcase']['register']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_skini'];
        }
    }
}
...
$contr_register = new register_class;
$contr_register->register_menu();
