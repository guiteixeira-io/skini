...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____con_costumer_check"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____con_costumer_check"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['cad_costumer_check'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['con_costumer_check']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['con_costumer_check']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['con_costumer_check']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['con_costumer_check']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['con_costumer_check']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>con_costumer_check</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['con_costumer_check']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['con_costumer_check']['embutida_filho'] as $ind => $sc_init)
          {
