...
class con_costumer_check_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . con_costumer_check_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . con_costumer_check_pack_protect_string($Tipo_filter[0]) . "\">.." . con_costumer_check_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> costumer_check</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>con_costumer_check/con_costumer_check_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="con_costumer_check_ajax_search.js"></script>
 <script type="text/javascript" src="con_costumer_check_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="con_costumer_check_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['con_costumer_check']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['con_costumer_check']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_action#NMF#' + search_get_text('SC_sc_field_0') + '@NMF@';
  str_out += 'id_ac_action#NMF#' + search_get_text('id_ac_sc_field_0') + '@NMF@';
  str_out += 'SC_idcostumercheck_cond#NMF#' + search_get_sel_txt('SC_idcostumercheck_cond') + '@NMF@';
  str_out += 'SC_idcostumercheck#NMF#' + search_get_text('SC_idcostumercheck') + '@NMF@';
  str_out += 'SC_idcostumer_cond#NMF#' + search_get_sel_txt('SC_idcostumer_cond') + '@NMF@';
  str_out += 'SC_idcostumer#NMF#' + search_get_text('SC_idcostumer') + '@NMF@';
  str_out += 'SC_idlodge_cond#NMF#' + search_get_sel_txt('SC_idlodge_cond') + '@NMF@';
  str_out += 'SC_idlodge#NMF#' + search_get_text('SC_idlodge') + '@NMF@';
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> costumer_check</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $idcostumercheck_cond, $idcostumercheck,
             $idcostumer_cond, $idcostumer,
             $idlodge_cond, $idlodge,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['sc_field_0']; 
          $sc_field_0_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['sc_field_0_cond']; 
          $idcostumercheck = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumercheck']; 
          $idcostumercheck_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumercheck_cond']; 
          $idcostumer = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumer']; 
          $idcostumer_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumer_cond']; 
          $idlodge = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idlodge']; 
          $idlodge_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idlodge_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['NM_operador']; 
          if (strtoupper($idcostumercheck_cond) != "II" && strtoupper($idcostumercheck_cond) != "QP" && strtoupper($idcostumercheck_cond) != "NP" && strtoupper($idcostumercheck_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idcostumercheck, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idcostumer_cond) != "II" && strtoupper($idcostumer_cond) != "QP" && strtoupper($idcostumer_cond) != "NP" && strtoupper($idcostumer_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idcostumer, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idlodge_cond) != "II" && strtoupper($idlodge_cond) != "QP" && strtoupper($idlodge_cond) != "NP" && strtoupper($idlodge_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idlodge, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($idcostumercheck_cond) || empty($idcostumercheck_cond))
      {
         $idcostumercheck_cond = "gt";
      }
      if (!isset($idcostumer_cond) || empty($idcostumer_cond))
      {
         $idcostumer_cond = "gt";
      }
      if (!isset($idlodge_cond) || empty($idlodge_cond))
      {
         $idlodge_cond = "gt";
      }
      ...
      $str_hide_idcostumercheck = (in_array($idcostumercheck_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idcostumer = (in_array($idcostumer_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idlodge = (in_array($idlodge_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($idcostumercheck) || $idcostumercheck == "")
      {
          $idcostumercheck = "";
      }
      if (isset($idcostumercheck) && !empty($idcostumercheck))
      {
         $tmp_pos = (is_string($idcostumercheck)) ? strpos($idcostumercheck, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idcostumercheck = substr($idcostumercheck, 0, $tmp_pos);
         }
      }
      if (!isset($idcostumer) || $idcostumer == "")
      {
          $idcostumer = "";
      }
      if (isset($idcostumer) && !empty($idcostumer))
      {
         $tmp_pos = (is_string($idcostumer)) ? strpos($idcostumer, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idcostumer = substr($idcostumer, 0, $tmp_pos);
         }
      }
      if (!isset($idlodge) || $idlodge == "")
      {
          $idlodge = "";
      }
      if (isset($idlodge) && !empty($idlodge))
      {
         $tmp_pos = (is_string($idlodge)) ? strpos($idlodge, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idlodge = substr($idlodge, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_sc_field_0_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sc_field_0'])) ? $this->New_label['sc_field_0'] : "Ação"; ?></TD>
...
?>
<INPUT  type="text" id="SC_sc_field_0" name="sc_field_0" value="<?php echo NM_encode_input($sc_field_0) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sc_field_0" name="sc_field_0_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idcostumercheck_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idcostumercheck'])) ? $this->New_label['idcostumercheck'] : "Id Costumer Check"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idcostumercheck_cond" name="idcostumercheck_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcostumercheck'), this, 'idcostumercheck')">
       <OPTION value="gt" <?php if ("gt" == $idcostumercheck_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcostumercheck_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcostumercheck_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcostumercheck" <?php echo $str_hide_idcostumercheck?> valign="top">
 ...
 $nmgp_tab_label .= "idcostumercheck?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idcostumercheck" name="idcostumercheck" value="<?php echo NM_encode_input($idcostumercheck) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idcostumer_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcostumer'])) ? $this->New_label['idcostumer'] : "Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcostumer_cond" name="idcostumer_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcostumer'), this, 'idcostumer')">
       <OPTION value="gt" <?php if ("gt" == $idcostumer_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcostumer_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcostumer_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcostumer" <?php echo $str_hide_idcostumer?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idcostumer'])) ? $this->New_label['idcostumer'] : "Cliente";
 $nmgp_tab_label .= "idcostumer?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idcostumer" name="idcostumer" value="<?php echo NM_encode_input($idcostumer) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_idlodge_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idlodge'])) ? $this->New_label['idlodge'] : "Quarto"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idlodge_cond" name="idlodge_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlodge'), this, 'idlodge')">
       <OPTION value="gt" <?php if ("gt" == $idlodge_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idlodge_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idlodge_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idlodge" <?php echo $str_hide_idlodge?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idlodge'])) ? $this->New_label['idlodge'] : "Quarto";
 $nmgp_tab_label .= "idlodge?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idlodge" name="idlodge" value="<?php echo NM_encode_input($idlodge) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("con_costumer_check_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['con_costumer_check']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['con_costumer_check']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idcostumercheck_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idcostumercheck'), document.F1.idcostumercheck_cond, 'idcostumercheck');
   document.F1.idcostumercheck.value = "";
   document.F1.idcostumer_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idcostumer'), document.F1.idcostumer_cond, 'idcostumer');
   document.F1.idcostumer.value = "";
   document.F1.idlodge_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idlodge'), document.F1.idlodge_cond, 'idlodge');
   document.F1.idlodge.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idcostumercheck_cond'] = 'cond';
      $tp_fields['SC_idcostumercheck'] = 'text';
      $tp_fields['SC_idcostumer_cond'] = 'cond';
      $tp_fields['SC_idcostumer'] = 'text';
      $tp_fields['SC_idlodge_cond'] = 'cond';
      $tp_fields['SC_idlodge'] = 'text';
      $tp_fields['SC_NM_operador'] = 'text';
      $tb_fields_esp['SC_action_cond'] = 'SC_sc_field_0_cond';
      $tb_fields_esp['SC_action'] = 'SC_sc_field_0';
      $tb_fields_esp['text_aut'] = 'id_ac_action';
      $tb_fields_esp['id_ac_action'] = 'id_ac_sc_field_0';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $sc_field_0_cond, $sc_field_0, $sc_field_0_autocomp,
             $idcostumercheck_cond, $idcostumercheck,
             $idcostumer_cond, $idcostumer,
             $idlodge_cond, $idlodge, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $idcostumercheck_cond_salva = $idcostumercheck_cond; 
      if (!isset($idcostumercheck_input_2) || $idcostumercheck_input_2 == "")
      {
          $idcostumercheck_input_2 = $idcostumercheck;
      }
      $idcostumer_cond_salva = $idcostumer_cond; 
      if (!isset($idcostumer_input_2) || $idcostumer_input_2 == "")
      {
          $idcostumer_input_2 = $idcostumer;
      }
      $idlodge_cond_salva = $idlodge_cond; 
      if (!isset($idlodge_input_2) || $idlodge_input_2 == "")
      {
          $idlodge_input_2 = $idlodge;
      }
      if ($idcostumercheck_cond != "in")
      {
          nm_limpa_numero($idcostumercheck, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idcostumer_cond != "in")
      {
          nm_limpa_numero($idcostumer, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idlodge_cond != "in")
      {
          nm_limpa_numero($idlodge, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['sc_field_0'] = $sc_field_0; 
      if (is_array($sc_field_0) && !empty($sc_field_0))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0] = $sc_field_0;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0][0] = $sc_field_0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['sc_field_0_cond'] = $sc_field_0_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['cmp'] = "sc_field_0"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['opc'] = $sc_field_0_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq']['sc_field_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumercheck'] = $idcostumercheck; 
      if (is_array($idcostumercheck) && !empty($idcostumercheck))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0] = $idcostumercheck;
      }
      elseif ($idcostumercheck_cond_salva == "nu" || $idcostumercheck_cond_salva == "nn" || $idcostumercheck_cond_salva == "ep" || $idcostumercheck_cond_salva == "ne" || !empty($idcostumercheck))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0][0] = $idcostumercheck;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumercheck_cond'] = $idcostumercheck_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['cmp'] = "idcostumercheck"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['opc'] = $idcostumercheck_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq']['idcostumercheck'] = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumer'] = $idcostumer; 
      if (is_array($idcostumer) && !empty($idcostumer))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0] = $idcostumer;
      }
      elseif ($idcostumer_cond_salva == "nu" || $idcostumer_cond_salva == "nn" || $idcostumer_cond_salva == "ep" || $idcostumer_cond_salva == "ne" || !empty($idcostumer))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0][0] = $idcostumer;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idcostumer_cond'] = $idcostumer_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['cmp'] = "idcostumer"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['opc'] = $idcostumer_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq']['idcostumer'] = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idlodge'] = $idlodge; 
      if (is_array($idlodge) && !empty($idlodge))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0] = $idlodge;
      }
      elseif ($idlodge_cond_salva == "nu" || $idlodge_cond_salva == "nn" || $idlodge_cond_salva == "ep" || $idlodge_cond_salva == "ne" || !empty($idlodge))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['val'][0][0] = $idlodge;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['idlodge_cond'] = $idlodge_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['cmp'] = "idlodge"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid]['opc'] = $idlodge_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['grid_pesq']['idlodge'] = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($sc_field_0 != '') {
      ...
      $this->cmp_formatado['idcostumercheck'] = $Conteudo;
      $Conteudo = $idcostumer;
      if (strtoupper($idcostumer_cond) != "II" && strtoupper($idcostumer_cond) != "QP" && strtoupper($idcostumer_cond) != "NP" && strtoupper($idcostumer_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idcostumer'] = $Conteudo;
      $Conteudo = $idlodge;
      if (strtoupper($idlodge_cond) != "II" && strtoupper($idlodge_cond) != "QP" && strtoupper($idlodge_cond) != "NP" && strtoupper($idlodge_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idlodge'] = $Conteudo;

      //----- $sc_field_0
      $this->Date_part = false;
      if (isset($sc_field_0) || $sc_field_0_cond == "nu" || $sc_field_0_cond == "nn" || $sc_field_0_cond == "ep" || $sc_field_0_cond == "ne")
      {
         $this->monta_condicao("`action`", $sc_field_0_cond, $sc_field_0, "", "sc_field_0", "VARCHAR", false);
      }

      //----- $idcostumercheck
      $this->Date_part = false;
      if (isset($idcostumercheck) || $idcostumercheck_cond == "nu" || $idcostumercheck_cond == "nn" || $idcostumercheck_cond == "ep" || $idcostumercheck_cond == "ne")
      {
         $this->monta_condicao("idCostumerCheck", $idcostumercheck_cond, $idcostumercheck, "", "idcostumercheck", "INT", false);
      }

      //----- $idcostumer
      $this->Date_part = false;
      if (isset($idcostumer) || $idcostumer_cond == "nu" || $idcostumer_cond == "nn" || $idcostumer_cond == "ep" || $idcostumer_cond == "ne")
      {
         $this->monta_condicao("idCostumer", $idcostumer_cond, $idcostumer, "", "idcostumer", "INT", false);
      }

      //----- $idlodge
      $this->Date_part = false;
      if (isset($idlodge) || $idlodge_cond == "nu" || $idlodge_cond == "nn" || $idlodge_cond == "ep" || $idlodge_cond == "ne")
      {
         $this->monta_condicao("idLodge", $idlodge_cond, $idlodge, "", "idlodge", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['con_costumer_check']['cond_pesq'] .= $this->NM_operador;
