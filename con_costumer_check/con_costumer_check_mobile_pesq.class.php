...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "timeCheck";$Nm_numeric[] = "idcostumercheck";$Nm_numeric[] = "idcostumer";$Nm_numeric[] = "idlodge";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idcostumercheck_cond" name="idcostumercheck_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcostumercheck'), this, 'idcostumercheck')">
      ...
      <br><span id="id_hide_idcostumercheck"  <?php echo $str_hide_idcostumercheck?>><INPUT  type="text" id="SC_idcostumercheck" name="idcostumercheck" value="<?php echo NM_encode_input($idcostumercheck) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcostumer_cond" name="idcostumer_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcostumer'), this, 'idcostumer')">
      ...
      <br><span id="id_hide_idcostumer"  <?php echo $str_hide_idcostumer?>><INPUT  type="text" id="SC_idcostumer" name="idcostumer" value="<?php echo NM_encode_input($idcostumer) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idlodge_cond" name="idlodge_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlodge'), this, 'idlodge')">
      ...
      <br><span id="id_hide_idlodge"  <?php echo $str_hide_idlodge?>><INPUT  type="text" id="SC_idlodge" name="idlodge" value="<?php echo NM_encode_input($idlodge) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
