<?php
@session_start() ;
$_SESSION['scriptcase']['con_costumer_check']['sc_process_barr'] = true;
require_once('../con_costumer_check/index.php');
unset($_SESSION['scriptcase']['con_costumer_check']['sc_process_barr']);
$ExportCtrl = new con_costumer_check_export_control;
$ExportCtrl->Export_barr();

class con_costumer_check_export_control
{
