<?php  
  ...
  session_start() ;
  class tas_costumerCheck_out_form_teste
  {
   function tas_costumerCheck_out_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "tas_costumerCheck_out/img";
...
?> 
<br> 
<B><FONT SIZE="4">tas_costumerCheck_out</FONT></B> 
<br> 
<br> 
...
idCostumerCheck&nbsp;&nbsp;<input type=text name=idcostumercheck size=20><br> 
<input type="submit" value="tas_costumerCheck_out"> 
</form> 
<script language=javascript> 
 document.Fedit.idcostumercheck.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new tas_costumerCheck_out_form_teste();
  $frm_teste->tas_costumerCheck_out_teste();
?>
