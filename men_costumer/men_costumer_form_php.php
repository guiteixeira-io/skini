...
class men_costumer_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['men_costumer']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['men_costumer']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['men_costumer']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['men_costumer']['sc_apl_link'];
...
$_SESSION['scriptcase']['men_costumer']['contr_erro'] = 'off';
      ...
      if ($_SESSION['scriptcase']['sc_item_menu'] == "men_costumer")
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("img_menu") . "/?nm_run_menu=1&nm_apl_menu=men_costumer&script_case_init=1";
      }
      elseif (isset($_SESSION['scriptcase']['sc_def_menu']['men_costumer']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['men_costumer'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("que_costumers") . "/?script_case_init=" . $_SESSION['sc_session'][1]['men_costumer']['init'] . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="men_costumer"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "men_costumer")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'men_costumer', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['men_costumer']['sc_init'][$apl_menu];
...
$controle = new men_costumer_form_php();
$controle->init();
?>
