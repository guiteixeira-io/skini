...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["men_costumer"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["men_costumer"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["men_costumer"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile.min.js"></script>
    <style>
    <?php
    if(isset($men_costumer_menuData["data"]) && is_array($men_costumer_menuData["data"]) && !empty($men_costumer_menuData["data"]))
    {
        foreach($men_costumer_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($men_costumer_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
