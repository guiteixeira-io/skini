...
class men_move_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['men_move']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['men_move']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['men_move']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['men_move']['sc_apl_link'];
...
';
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['men_move'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="men_move"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "men_move")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'men_move', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['men_move']['sc_init'][$apl_menu];
...
$controle = new men_move_form_php();
$controle->init();
?>
