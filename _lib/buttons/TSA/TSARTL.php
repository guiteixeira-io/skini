<?php
  ...
  $this->arr_buttons['bcons_inicio']['fontawesomeicon']  = 'fas fa-step-forward';
  ...
  $this->arr_buttons['bcons_retorna']['fontawesomeicon']  = 'fas fa-arrow-right';
  ...
  $this->arr_buttons['bcons_avanca']['fontawesomeicon']  = 'fas fa-arrow-left';
  ...
  $this->arr_buttons['bcons_final']['fontawesomeicon']  = 'fas fa-step-backward';
  ...
  $this->arr_buttons['birpara']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bgraf']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bqtd_bytes']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['brot_resumo']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['gantt_chart']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bcons_cancel']['style'] = 'danger';
  ...
  $this->arr_buttons['bmultiselect']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['binicio']['fontawesomeicon']  = 'fas fa-step-forward';
  ...
  $this->arr_buttons['bretorna']['fontawesomeicon']  = 'fas fa-arrow-right';
  ...
  $this->arr_buttons['bavanca']['fontawesomeicon']  = 'fas fa-arrow-left';
  ...
  $this->arr_buttons['bfinal']['fontawesomeicon']  = 'fas fa-step-backward';
  ...
  $this->arr_buttons['bstepretorna']['display']          = 'only_fontawesomeicon';
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'scriptcase__NM__nm_scriptcase9_Rhino_left_enabled.png';
  ...
  $this->arr_buttons['bstepavanca']['display']          = 'only_fontawesomeicon';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'scriptcase__NM__nm_scriptcase9_Rhino_right_enabled.png';
  ...
  $this->arr_buttons['balterarsel']['display']          = 'only_fontawesomeicon';
  ...
  $this->arr_buttons['bform_captura']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bcalendario']['style'] = 'default';
  ...
  $this->arr_buttons['bcalculadora']['style'] = 'default';
  ...
  $this->arr_buttons['bajaxcapt']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bajaxclose']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bcaptchareload']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bchart_bar']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bchart_line']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bchart_area']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bchart_pizza']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bchart_combo']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bchart_stack']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bquick_search']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bquick_clean']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bquick_clean']['image'] = 'scriptcase__NM__nm_scriptcase9_BlueBerry_refresh.png.png';

  $this->arr_buttons['blimparsummaryfield']['hint']             = $Nm_lang['lang_btns_clean_summary_field_hint'];
  $this->arr_buttons['blimparsummaryfield']['type']             = 'button';
  $this->arr_buttons['blimparsummaryfield']['value']            = $Nm_lang['lang_btns_clean_summary_field'];
  $this->arr_buttons['blimparsummaryfield']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['blimparsummaryfield']['image'] = 'scriptcase__NM__nm_scriptcase9_Rhino_blimparsummaryfield.gif';
  ...
  $this->arr_buttons['blimparsummaryall']['style'] = 'danger';
  ...
  $this->arr_buttons['bfilref_apply']['display']          = 'text_fontawesomeicon';
  $this->arr_buttons['bfilref_apply']['display_position'] = 'text_right';
  $this->arr_buttons['bfilref_apply']['fontawesomeicon']  = 'fas fa-search';
  $this->arr_buttons['bfilref_apply']['style'] = 'default';
  $this->arr_buttons['bfilref_apply']['image'] = 'sys__NM__nm_teste_bpesquisa.gif';
  ...
  $this->arr_buttons['bfilref_limpar']['display']          = 'text_fontawesomeicon';
  $this->arr_buttons['bfilref_limpar']['display_position'] = 'text_right';
  $this->arr_buttons['bfilref_limpar']['fontawesomeicon']  = 'fas fa-broom';
  $this->arr_buttons['bfilref_limpar']['style'] = 'default';
  $this->arr_buttons['bfilref_limpar']['image'] = 'sys__NM__nm_teste_blimpar.gif';
  ...
  $this->arr_buttons['bfilref_close']['display']          = 'text_fontawesomeicon';
  $this->arr_buttons['bfilref_close']['display_position'] = 'text_right';
  $this->arr_buttons['bfilref_close']['fontawesomeicon']  = 'fas fa-times';
  $this->arr_buttons['bfilref_close']['style'] = 'default';
  $this->arr_buttons['bfilref_close']['image'] = 'scriptcase__NM__nm_scriptcase9_Rhino_close.png';
  ...
  $this->arr_buttons['bmenu']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bhelp']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bzipcode']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['blink']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['blanguage']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bfieldhelp']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bsrgb']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bemail']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bcapture']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bmessageclose']['style'] = 'danger';
  ...
  $this->arr_buttons['bpassfld_down']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bpassfld_down']['style'] = 'default';
  ...
  $this->arr_buttons['bpassfld_rightall']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bpassfld_rightall']['style'] = 'default';
  ...
  $this->arr_buttons['bpassfld_right']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bpassfld_right']['style'] = 'default';
  ...
  $this->arr_buttons['bpassfld_leftall']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bpassfld_leftall']['style'] = 'default';
  ...
  $this->arr_buttons['bpassfld_left']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bpassfld_left']['style'] = 'default';
  ...
  $this->arr_buttons['breload']['display']          = 'text_fontawesomeicon';
  ...
  $this->arr_buttons['bsweetalert_ok']['style'] = 'default';
  ...
  $this->arr_buttons['bsweetalert_cancel']['style'] = 'danger';
