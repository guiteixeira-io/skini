<?php  
  ...
  session_start() ;
  class das_home_form_teste
  {
   function das_home_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "das_home/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'das_home')
  {
...
<input type="submit" value="das_home"> 
</form> 
...
<?php
  ...
  $frm_teste = new das_home_form_teste();
  $frm_teste->das_home_teste();
?>
