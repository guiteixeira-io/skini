  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_sec_settings" == sTestField)
        {
...
?>
  ...
  function do_ajax_sec_settings_validate_session_expire()
  {
    ...
    x_ajax_sec_settings_validate_session_expire(var_session_expire, var_script_case_init, do_ajax_sec_settings_validate_session_expire_cb);
  } // do_ajax_sec_settings_validate_session_expire

  function do_ajax_sec_settings_validate_session_expire_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_session_expire_cb

  // ---------- Validate remember_me
  function do_ajax_sec_settings_validate_remember_me()
  {
    var nomeCampo_remember_me = "remember_me";
    var var_remember_me = scAjaxGetFieldCheckbox(nomeCampo_remember_me, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_remember_me(var_remember_me, var_script_case_init, do_ajax_sec_settings_validate_remember_me_cb);
  } // do_ajax_sec_settings_validate_remember_me

  function do_ajax_sec_settings_validate_remember_me_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_remember_me_cb

  // ---------- Validate cookie_expiration_time
  function do_ajax_sec_settings_validate_cookie_expiration_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_cookie_expiration_time(var_cookie_expiration_time, var_script_case_init, do_ajax_sec_settings_validate_cookie_expiration_time_cb);
  } // do_ajax_sec_settings_validate_cookie_expiration_time

  function do_ajax_sec_settings_validate_cookie_expiration_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_cookie_expiration_time_cb

  // ---------- Validate retrieve_password
  function do_ajax_sec_settings_validate_retrieve_password()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_retrieve_password(var_retrieve_password, var_script_case_init, do_ajax_sec_settings_validate_retrieve_password_cb);
  } // do_ajax_sec_settings_validate_retrieve_password

  function do_ajax_sec_settings_validate_retrieve_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_retrieve_password_cb

  // ---------- Validate new_users
  function do_ajax_sec_settings_validate_new_users()
  {
    var nomeCampo_new_users = "new_users";
    var var_new_users = scAjaxGetFieldCheckbox(nomeCampo_new_users, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_new_users(var_new_users, var_script_case_init, do_ajax_sec_settings_validate_new_users_cb);
  } // do_ajax_sec_settings_validate_new_users

  function do_ajax_sec_settings_validate_new_users_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_new_users_cb

  // ---------- Validate brute_force
  function do_ajax_sec_settings_validate_brute_force()
  {
    var nomeCampo_brute_force = "brute_force";
    var var_brute_force = scAjaxGetFieldCheckbox(nomeCampo_brute_force, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_brute_force(var_brute_force, var_script_case_init, do_ajax_sec_settings_validate_brute_force_cb);
  } // do_ajax_sec_settings_validate_brute_force

  function do_ajax_sec_settings_validate_brute_force_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_brute_force_cb

  // ---------- Validate brute_force_time_block
  function do_ajax_sec_settings_validate_brute_force_time_block()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_brute_force_time_block(var_brute_force_time_block, var_script_case_init, do_ajax_sec_settings_validate_brute_force_time_block_cb);
  } // do_ajax_sec_settings_validate_brute_force_time_block

  function do_ajax_sec_settings_validate_brute_force_time_block_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_brute_force_time_block_cb

  // ---------- Validate brute_force_attempts
  function do_ajax_sec_settings_validate_brute_force_attempts()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_brute_force_attempts(var_brute_force_attempts, var_script_case_init, do_ajax_sec_settings_validate_brute_force_attempts_cb);
  } // do_ajax_sec_settings_validate_brute_force_attempts

  function do_ajax_sec_settings_validate_brute_force_attempts_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_brute_force_attempts_cb

  // ---------- Validate enable_2fa
  function do_ajax_sec_settings_validate_enable_2fa()
  {
    var nomeCampo_enable_2fa = "enable_2fa";
    var var_enable_2fa = scAjaxGetFieldCheckbox(nomeCampo_enable_2fa, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_enable_2fa(var_enable_2fa, var_script_case_init, do_ajax_sec_settings_validate_enable_2fa_cb);
  } // do_ajax_sec_settings_validate_enable_2fa

  function do_ajax_sec_settings_validate_enable_2fa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_enable_2fa_cb

  // ---------- Validate enable_2fa_expiration_time
  function do_ajax_sec_settings_validate_enable_2fa_expiration_time()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_settings_validate_enable_2fa_expiration_time(var_enable_2fa_expiration_time, var_script_case_init, do_ajax_sec_settings_validate_enable_2fa_expiration_time_cb);
  } // do_ajax_sec_settings_validate_enable_2fa_expiration_time

  function do_ajax_sec_settings_validate_enable_2fa_expiration_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_settings_validate_enable_2fa_expiration_time_cb

  // ---------- Event onclick brute_force
  function do_ajax_sec_settings_event_brute_force_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_sec_settings_event_brute_force_onclick(var_brute_force, var_brute_force_time_block, var_brute_force_attempts, var_script_case_init, do_ajax_sec_settings_event_brute_force_onclick_cb);
  } // do_ajax_sec_settings_event_brute_force_onclick

  function do_ajax_sec_settings_event_brute_force_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "brute_force";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_settings_event_brute_force_onclick_cb_after_alert);
  } // do_ajax_sec_settings_event_brute_force_onclick_cb
  function do_ajax_sec_settings_event_brute_force_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_settings_event_brute_force_onclick_cb_after_alert

  // ---------- Event onclick enable_2fa
  function do_ajax_sec_settings_event_enable_2fa_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_settings_event_enable_2fa_onclick(var_enable_2fa, var_enable_2fa_expiration_time, var_script_case_init, do_ajax_sec_settings_event_enable_2fa_onclick_cb);
  } // do_ajax_sec_settings_event_enable_2fa_onclick

  function do_ajax_sec_settings_event_enable_2fa_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "enable_2fa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_settings_event_enable_2fa_onclick_cb_after_alert);
  } // do_ajax_sec_settings_event_enable_2fa_onclick_cb
  function do_ajax_sec_settings_event_enable_2fa_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_settings_event_enable_2fa_onclick_cb_after_alert

  // ---------- Event onclick remember_me
  function do_ajax_sec_settings_event_remember_me_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_settings_event_remember_me_onclick(var_remember_me, var_cookie_expiration_time, var_script_case_init, do_ajax_sec_settings_event_remember_me_onclick_cb);
  } // do_ajax_sec_settings_event_remember_me_onclick

  function do_ajax_sec_settings_event_remember_me_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "remember_me";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_settings_event_remember_me_onclick_cb_after_alert);
  } // do_ajax_sec_settings_event_remember_me_onclick_cb
  function do_ajax_sec_settings_event_remember_me_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_settings_event_remember_me_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_sec_settings_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_sec_settings_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_sec_settings_submit_form(var_session_expire, var_remember_me, var_cookie_expiration_time, var_retrieve_password, var_new_users, var_brute_force, var_brute_force_time_block, var_brute_force_attempts, var_enable_2fa, var_enable_2fa_expiration_time, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_settings_submit_form_cb);
  } // do_ajax_sec_settings_submit_form

  function do_ajax_sec_settings_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_sec_settings_submit_form_cb_after_alert);
  } // do_ajax_sec_settings_submit_form_cb
  function do_ajax_sec_settings_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_sec_settings_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_sec_settings_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_sec_settings_navigate_form, function() {});
    } else {
      perform_ajax_sec_settings_navigate_form();
    }
  }

  function perform_ajax_sec_settings_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_sec_settings_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_sec_settings_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_sec_settings_navigate_form_cb_after_alert);
  } // do_ajax_sec_settings_navigate_form_cb
  function do_ajax_sec_settings_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_sec_settings_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_sec_settings_navigate_form_cb_after_alert

  function sc_hide_sec_settings_form()
  {
