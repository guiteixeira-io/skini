<?php  
  ...
  session_start() ;
  class sec_settings_form_teste
  {
   function sec_settings_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_settings/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_settings</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="sec_settings"> 
</form> 
...
<?php
  ...
  $frm_teste = new sec_settings_form_teste();
  $frm_teste->sec_settings_teste();
?>
