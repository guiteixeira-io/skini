...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['sec_settings']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['sec_settings']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['sec_settings']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['sec_settings']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['sec_settings']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['sec_settings']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['sec_settings']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['sec_settings']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_settings']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['sec_settings']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['sec_settings']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new sec_settings_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['sec_settings']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['sec_settings']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['sec_settings'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_settings']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_settings']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('sec_settings') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_settings']['label'] = "" . $this->Ini->Nm_lang['lang_settings'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['sec_settings']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['sec_settings'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['sec_settings']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['sec_settings'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['sec_settings'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'sec_settings_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'sec_settings_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'sec_settings/sec_settings_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "sec_settings_erro.class.php"); 
      }
      $this->Erro      = new sec_settings_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['sec_settings']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['sec_settings']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['sec_settings']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      if (!isset($nm_form_submit) && $this->nmgp_opcao != "nada")
      {
          ...
          $this->brute_force = "" ;  
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_form']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_form']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_form'] as $NM_campo => $NM_valor)
              {
                  $$NM_campo = $NM_valor;
              }
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['recarga'] = $this->nmgp_opcao;
      }
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          ...
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos']))
              { 
                  $session_expire = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][0]; 
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][1]; 
                  $cookie_expiration_time = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][2]; 
                  $retrieve_password = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][3]; 
                  $new_users = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][4]; 
                  $brute_force = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][5]; 
                  $brute_force_time_block = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][6]; 
                  $brute_force_attempts = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][7]; 
                  $enable_2fa = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][8]; 
                  $enable_2fa_expiration_time = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][9]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'] = array(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][0] = $this->session_expire; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][1] = $this->remember_me; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][2] = $this->cookie_expiration_time; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][3] = $this->retrieve_password; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][4] = $this->new_users; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][5] = $this->brute_force; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][6] = $this->brute_force_time_block; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][7] = $this->brute_force_attempts; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][8] = $this->enable_2fa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['campos'][9] = $this->enable_2fa_expiration_time; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['redir'] == "redir")
          {
          ...
          {
              $contr_menu = "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['iframe_menu'])
              {
                  $contr_menu = "glo_menu";
              }
              if (isset($_SESSION['scriptcase']['sc_ult_apl_menu']) && in_array("sec_settings", $_SESSION['scriptcase']['sc_ult_apl_menu']))
              {
                  $this->NM_close_db(); 
                  $this->nmgp_redireciona_form("sec_settings_fim.php", $this->nm_location, $contr_menu); 
              }
              else
              {
                  $this->nm_gera_html();
                  if (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['embutida_proc'])
                  { 
                      $this->NM_close_db(); 
                  } 
              }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "sec_settings.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="sec_settings_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="sec_settings"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_sec_settings']) || !is_array($this->NM_ajax_info['errList']['geral_sec_settings']))
              {
                  $this->NM_ajax_info['errList']['geral_sec_settings'] = array();
              }
              $this->NM_ajax_info['errList']['geral_sec_settings'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      {
      $_SESSION['scriptcase']['sec_settings']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['sec_settings']['contr_erro'] = 'off'; 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dados_form'] = $this->nmgp_dados_form;
   }
...
$aLookup[] = array(sec_settings_pack_protect_string('N') => str_replace('<', '&lt;',sec_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_sess_no'] . "")));
$aLookup[] = array(sec_settings_pack_protect_string('R') => str_replace('<', '&lt;',sec_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_sess_redir'] . "")));
$aLookup[] = array(sec_settings_pack_protect_string('M') => str_replace('<', '&lt;',sec_settings_pack_protect_string("" . $this->Ini->Nm_lang['lang_sec_sess_msg'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_session_expire'][] = 'N';
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_session_expire'][] = 'R';
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_session_expire'][] = 'M';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['session_expire']['valList'][$i] = sec_settings_pack_protect_string($v);
          }
...
$aLookup[] = array(sec_settings_pack_protect_string('Y') => str_replace('<', '&lt;',sec_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_remember_me'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['remember_me']['valList'][$i] = sec_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(sec_settings_pack_protect_string('Y') => str_replace('<', '&lt;',sec_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_retrieve_password'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['retrieve_password']['valList'][$i] = sec_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(sec_settings_pack_protect_string('Y') => str_replace('<', '&lt;',sec_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_new_users'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['new_users']['valList'][$i] = sec_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(sec_settings_pack_protect_string('Y') => str_replace('<', '&lt;',sec_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_brute_force'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['brute_force']['valList'][$i] = sec_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(sec_settings_pack_protect_string('Y') => str_replace('<', '&lt;',sec_settings_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['Lookup_enable_2fa'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['enable_2fa']['valList'][$i] = sec_settings_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_enable_2fa_expiration_time($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
$_SESSION['scriptcase']['sec_settings']['contr_erro'] = 'off'; 
    ...
    $this->nm_formatar_campos();
        $this->initFormPages();
    include_once("sec_settings_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "sec_settings_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['nm_run_menu'] = 2;
       $nmgp_saida_form = "sec_settings_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_settings']['ordem_ord'] == " desc") {
