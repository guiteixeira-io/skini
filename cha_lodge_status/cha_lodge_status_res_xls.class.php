...
class cha_lodge_status_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Tit_doc    = "cha_lodge_status" . $this->Xls_tp;
      $this->Tit_zip    = "cha_lodge_status.zip";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'] .= $this->Xls_tp ;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_name']);
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_return']);
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['pivot_group_by'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_res_sheet'] = $this->Xls_f;
      }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_title'] ?> cad_lodge :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cha_lodge_status']['xls_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
