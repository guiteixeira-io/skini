<?php
@session_start() ;
$_SESSION['scriptcase']['cha_lodge_status']['sc_process_barr'] = true;
require_once('../cha_lodge_status/index.php');
unset($_SESSION['scriptcase']['cha_lodge_status']['sc_process_barr']);
$ExportCtrl = new cha_lodge_status_export_control;
$ExportCtrl->Export_barr();

class cha_lodge_status_export_control
{
