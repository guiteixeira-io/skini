...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["skini_____cha_lodge_status"]))
   {
      unset($_SESSION['session_sec_aplicacao']["skini_____cha_lodge_status"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['cha_lodge_status']['embutida_filho'] as $ind => $sc_init)
          {
