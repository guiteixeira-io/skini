<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['cha_lodge_status']['glo_nm_path_imag_temp'] . "/sc_apl_default_skini.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new cha_lodge_status_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class cha_lodge_status_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   {
       $opc_ret  = (isset($_POST['opc_ret'])) ? strip_tags($_POST['opc_ret']) : "";
       $path_img = (isset($_POST['path_img'])) ? strip_tags($_POST['path_img']) : "";
       $path_btn = (isset($_POST['path_btn'])) ? strip_tags($_POST['path_btn']) : "";
       $tbar_pos = (isset($_POST['toolbar_pos'])) ? strip_tags($_POST['toolbar_pos']) : "";
   ...
   {
       $opc_ret  = (isset($_GET['opc_ret'])) ? strip_tags($_GET['opc_ret']) : "";
       $path_img = (isset($_GET['path_img'])) ? strip_tags($_GET['path_img']) : "";
       $path_btn = (isset($_GET['path_btn'])) ? strip_tags($_GET['path_btn']) : "";
       $tbar_pos = (isset($_GET['toolbar_pos'])) ? strip_tags($_GET['toolbar_pos']) : "";
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['status'] = array('cmp' => "status", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "status", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> cad_lodge</TITLE>
 ...
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    ...
    if (typeof ratingBreakdownDisplay == "function") {
     setTimeout(function() { ratingBreakdownDisplay() }, 2000);
    }
   });
  }
  </script>
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['cha_lodge_status']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['cha_lodge_status'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['cha_lodge_status']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['cha_lodge_status'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['cha_lodge_status'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
