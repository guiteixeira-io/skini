...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_cad_costumers_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_cad_costumers_submit_form(var_docnumber, var_name, var_rg, var_nationality, var_frequencytype, var_holdertype, var_phonenumber, var_email, var_zipcode, var_zipcity, var_zipstate, var_zipdistrict, var_zipstreet, var_zipnumber, var_observation, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_costumers_submit_form_cb);
