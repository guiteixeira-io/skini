  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cad_costumers" == sTestField)
        {
...
?>
  ...
  // ---------- Validate facephoto
  function do_ajax_cad_costumers_validate_facephoto()
  {
    var nomeCampo_facephoto = "facephoto";
    var var_facephoto = scAjaxGetFieldText(nomeCampo_facephoto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_facephoto(var_facephoto, var_script_case_init, do_ajax_cad_costumers_validate_facephoto_cb);
  } // do_ajax_cad_costumers_validate_facephoto

  function do_ajax_cad_costumers_validate_facephoto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_facephoto_cb

  // ---------- Validate docnumber
  function do_ajax_cad_costumers_validate_docnumber()
  {
    var nomeCampo_docnumber = "docnumber";
    var var_docnumber = scAjaxGetFieldText(nomeCampo_docnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_docnumber(var_docnumber, var_script_case_init, do_ajax_cad_costumers_validate_docnumber_cb);
  } // do_ajax_cad_costumers_validate_docnumber

  function do_ajax_cad_costumers_validate_docnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_docnumber_cb

  // ---------- Validate name
  function do_ajax_cad_costumers_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_name(var_name, var_script_case_init, do_ajax_cad_costumers_validate_name_cb);
  } // do_ajax_cad_costumers_validate_name

  function do_ajax_cad_costumers_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_name_cb

  // ---------- Validate frequencytype
  function do_ajax_cad_costumers_validate_frequencytype()
  {
    var nomeCampo_frequencytype = "frequencytype";
    var var_frequencytype = scAjaxGetFieldRadio(nomeCampo_frequencytype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_frequencytype(var_frequencytype, var_script_case_init, do_ajax_cad_costumers_validate_frequencytype_cb);
  } // do_ajax_cad_costumers_validate_frequencytype

  function do_ajax_cad_costumers_validate_frequencytype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_frequencytype_cb

  // ---------- Validate rg
  function do_ajax_cad_costumers_validate_rg()
  {
    var nomeCampo_rg = "rg";
    var var_rg = scAjaxGetFieldText(nomeCampo_rg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_rg(var_rg, var_script_case_init, do_ajax_cad_costumers_validate_rg_cb);
  } // do_ajax_cad_costumers_validate_rg

  function do_ajax_cad_costumers_validate_rg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rg";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_rg_cb

  // ---------- Validate nationality
  function do_ajax_cad_costumers_validate_nationality()
  {
    var nomeCampo_nationality = "nationality";
    var var_nationality = scAjaxGetFieldText(nomeCampo_nationality);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_nationality(var_nationality, var_script_case_init, do_ajax_cad_costumers_validate_nationality_cb);
  } // do_ajax_cad_costumers_validate_nationality

  function do_ajax_cad_costumers_validate_nationality_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_nationality_cb

  // ---------- Validate holdertype
  function do_ajax_cad_costumers_validate_holdertype()
  {
    var nomeCampo_holdertype = "holdertype";
    var var_holdertype = scAjaxGetFieldRadio(nomeCampo_holdertype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_holdertype(var_holdertype, var_script_case_init, do_ajax_cad_costumers_validate_holdertype_cb);
  } // do_ajax_cad_costumers_validate_holdertype

  function do_ajax_cad_costumers_validate_holdertype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_holdertype_cb

  // ---------- Validate phonenumber
  function do_ajax_cad_costumers_validate_phonenumber()
  {
    var nomeCampo_phonenumber = "phonenumber";
    var var_phonenumber = scAjaxGetFieldText(nomeCampo_phonenumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_phonenumber(var_phonenumber, var_script_case_init, do_ajax_cad_costumers_validate_phonenumber_cb);
  } // do_ajax_cad_costumers_validate_phonenumber

  function do_ajax_cad_costumers_validate_phonenumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_phonenumber_cb

  // ---------- Validate email
  function do_ajax_cad_costumers_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_email(var_email, var_script_case_init, do_ajax_cad_costumers_validate_email_cb);
  } // do_ajax_cad_costumers_validate_email

  function do_ajax_cad_costumers_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_email_cb

  // ---------- Validate mobilephone
  function do_ajax_cad_costumers_validate_mobilephone()
  {
    var nomeCampo_mobilephone = "mobilephone";
    var var_mobilephone = scAjaxGetFieldText(nomeCampo_mobilephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_mobilephone(var_mobilephone, var_script_case_init, do_ajax_cad_costumers_validate_mobilephone_cb);
  } // do_ajax_cad_costumers_validate_mobilephone

  function do_ajax_cad_costumers_validate_mobilephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_mobilephone_cb

  // ---------- Validate zipcode
  function do_ajax_cad_costumers_validate_zipcode()
  {
    var nomeCampo_zipcode = "zipcode";
    var var_zipcode = scAjaxGetFieldText(nomeCampo_zipcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_zipcode(var_zipcode, var_script_case_init, do_ajax_cad_costumers_validate_zipcode_cb);
  } // do_ajax_cad_costumers_validate_zipcode

  function do_ajax_cad_costumers_validate_zipcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_zipcode_cb

  // ---------- Validate zipcity
  function do_ajax_cad_costumers_validate_zipcity()
  {
    var nomeCampo_zipcity = "zipcity";
    var var_zipcity = scAjaxGetFieldText(nomeCampo_zipcity);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_zipcity(var_zipcity, var_script_case_init, do_ajax_cad_costumers_validate_zipcity_cb);
  } // do_ajax_cad_costumers_validate_zipcity

  function do_ajax_cad_costumers_validate_zipcity_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcity";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_zipcity_cb

  // ---------- Validate zipstate
  function do_ajax_cad_costumers_validate_zipstate()
  {
    var nomeCampo_zipstate = "zipstate";
    var var_zipstate = scAjaxGetFieldText(nomeCampo_zipstate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_zipstate(var_zipstate, var_script_case_init, do_ajax_cad_costumers_validate_zipstate_cb);
  } // do_ajax_cad_costumers_validate_zipstate

  function do_ajax_cad_costumers_validate_zipstate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_zipstate_cb

  // ---------- Validate zipdistrict
  function do_ajax_cad_costumers_validate_zipdistrict()
  {
    var nomeCampo_zipdistrict = "zipdistrict";
    var var_zipdistrict = scAjaxGetFieldText(nomeCampo_zipdistrict);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_zipdistrict(var_zipdistrict, var_script_case_init, do_ajax_cad_costumers_validate_zipdistrict_cb);
  } // do_ajax_cad_costumers_validate_zipdistrict

  function do_ajax_cad_costumers_validate_zipdistrict_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_zipdistrict_cb

  // ---------- Validate zipstreet
  function do_ajax_cad_costumers_validate_zipstreet()
  {
    var nomeCampo_zipstreet = "zipstreet";
    var var_zipstreet = scAjaxGetFieldText(nomeCampo_zipstreet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_zipstreet(var_zipstreet, var_script_case_init, do_ajax_cad_costumers_validate_zipstreet_cb);
  } // do_ajax_cad_costumers_validate_zipstreet

  function do_ajax_cad_costumers_validate_zipstreet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_zipstreet_cb

  // ---------- Validate zipnumber
  function do_ajax_cad_costumers_validate_zipnumber()
  {
    var nomeCampo_zipnumber = "zipnumber";
    var var_zipnumber = scAjaxGetFieldText(nomeCampo_zipnumber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_zipnumber(var_zipnumber, var_script_case_init, do_ajax_cad_costumers_validate_zipnumber_cb);
  } // do_ajax_cad_costumers_validate_zipnumber

  function do_ajax_cad_costumers_validate_zipnumber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_zipnumber_cb

  // ---------- Validate aggregate
  function do_ajax_cad_costumers_validate_aggregate()
  {
    var nomeCampo_aggregate = "aggregate";
    var var_aggregate = scAjaxGetFieldText(nomeCampo_aggregate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_aggregate(var_aggregate, var_script_case_init, do_ajax_cad_costumers_validate_aggregate_cb);
  } // do_ajax_cad_costumers_validate_aggregate

  function do_ajax_cad_costumers_validate_aggregate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cad_costumers_validate_aggregate_cb

  // ---------- Validate observation
  function do_ajax_cad_costumers_validate_observation()
  {
    var nomeCampo_observation = "observation";
    var var_observation = scAjaxGetFieldText(nomeCampo_observation);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cad_costumers_validate_observation(var_observation, var_script_case_init, do_ajax_cad_costumers_validate_observation_cb);
  } // do_ajax_cad_costumers_validate_observation

  function do_ajax_cad_costumers_validate_observation_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observation";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cad_costumers_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cad_costumers_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cad_costumers_submit_form(var_facephoto, var_docnumber, var_name, var_frequencytype, var_rg, var_nationality, var_holdertype, var_phonenumber, var_email, var_mobilephone, var_zipcode, var_zipcity, var_zipstate, var_zipdistrict, var_zipstreet, var_zipnumber, var_observation, var_facephoto_ul_name, var_facephoto_ul_type, var_facephoto_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cad_costumers_submit_form_cb);
  } // do_ajax_cad_costumers_submit_form

  function do_ajax_cad_costumers_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cad_costumers_submit_form_cb_after_alert);
  } // do_ajax_cad_costumers_submit_form_cb
  function do_ajax_cad_costumers_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cad_costumers_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["sub_aggregate"] = "off";

  function do_ajax_cad_costumers_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cad_costumers_navigate_form, function() {});
    } else {
      perform_ajax_cad_costumers_navigate_form();
    }
  }

  function perform_ajax_cad_costumers_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["sub_aggregate"] = "on";
    x_ajax_cad_costumers_navigate_form(var_idcostumer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cad_costumers_navigate_form_cb);
  } // do_ajax_cad_costumers_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cad_costumers_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_sub_aggregate"] && "nmsc_iframe_liga_sub_aggregate" != scMasterDetailIframe["nmsc_iframe_liga_sub_aggregate"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_sub_aggregate"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_sub_aggregate').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_sub_aggregate').style.height = "1";
        document.getElementById('nmsc_iframe_liga_sub_aggregate').style.display = "none";
    }
    document.F1.facephoto_ul_name.value = '';
    document.F1.facephoto_ul_type.value = '';
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cad_costumers_navigate_form_cb_after_alert);
  } // do_ajax_cad_costumers_navigate_form_cb
  function do_ajax_cad_costumers_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_cad_costumers_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cad_costumers_navigate_form_cb_after_alert

  function sc_hide_cad_costumers_form()
  {
  ...
  {
    if ("off" == scStatusDetail["sub_aggregate"])
    {
      return true;
    }
    return false;
