<?php  
  ...
  session_start() ;
  class cad_costumers_form_teste
  {
   function cad_costumers_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "cad_costumers/img";
...
?> 
<br> 
<B><FONT SIZE="4">cad_costumers</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="cad_costumers"> 
</form> 
...
<?php
  ...
  $frm_teste = new cad_costumers_form_teste();
  $frm_teste->cad_costumers_teste();
?>
