...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['cad_costumers']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['cad_costumers']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['cad_costumers']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['cad_costumers']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['cad_costumers']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['cad_costumers']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['cad_costumers']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['cad_costumers']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['cad_costumers']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cad_costumers']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['cad_costumers']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['cad_costumers']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new cad_costumers_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['cad_costumers']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['cad_costumers']['upload_field_info']['facephoto'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'cad_costumers',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cad_costumers']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cad_costumers'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cad_costumers']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cad_costumers']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('cad_costumers') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cad_costumers']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " cad_costumers";
      ...
      $_SESSION['scriptcase']['error_icon']['cad_costumers']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['cad_costumers'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_call'] : $this->Embutida_call;

      $this->form_3versions_single = false;

       $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_field_ul_name'][$this->facephoto_ul_name]))
          {
              $this->NM_ajax_info['param']['facephoto_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_field_ul_name'][$this->facephoto_ul_name];
          }
      ...
      elseif (isset($this->facephoto_ul_name) && '' != $this->facephoto_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_field_ul_name'][$this->facephoto_ul_name]))
          {
              $this->facephoto_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_field_ul_name'][$this->facephoto_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['cad_costumers']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cad_costumers'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['cad_costumers'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'cad_costumers_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'cad_costumers_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'cad_costumers/cad_costumers_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "cad_costumers_erro.class.php"); 
      }
      $this->Erro      = new cad_costumers_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao']))
         { 
             if ($this->idcostumer != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['cad_costumers']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['total']);
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['cad_costumers']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['cad_costumers']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "cad_costumers.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="cad_costumers_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="cad_costumers"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_cad_costumers']) || !is_array($this->NM_ajax_info['errList']['geral_cad_costumers']))
              {
                  $this->NM_ajax_info['errList']['geral_cad_costumers'] = array();
              }
              $this->NM_ajax_info['errList']['geral_cad_costumers'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
   ...
   if (isset($this->Field_no_validate['frequencytype'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Lookup_frequencytype']) && !in_array($this->frequencytype, $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Lookup_frequencytype']))
          {
              $hasError = true;
   ...
   if (isset($this->Field_no_validate['holdertype'])) {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Lookup_holdertype']) && !in_array($this->holdertype, $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Lookup_holdertype']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_phonenumber(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->phonenumber, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_mobilephone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->mobilephone, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Celular; " ; 
                  if (!isset($Campos_Erros['mobilephone']))
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'cad_costumers_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_form']['facephoto']) && $this->facephoto_limpa != "S")
          {
              $this->facephoto = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_form']['facephoto'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcostumer']['keyVal'] = cad_costumers_pack_protect_string($this->nmgp_dados_form['idcostumer']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['foreign_key']['idholder'] = $this->nmgp_dados_form['idcostumer'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['where_filter'] = "idHolder = " . $this->nmgp_dados_form['idcostumer'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['where_detal']  = "idHolder = " . $this->nmgp_dados_form['idcostumer'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sub_aggregate_script_case_init'] ]['sub_aggregate']['total']);
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Lookup_frequencytype'][] = 'D';
          ...
          {
              $this->NM_ajax_info['fldList']['frequencytype']['valList'][$i] = cad_costumers_pack_protect_string($v);
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Lookup_holdertype'][] = 'A';
          ...
          {
              $this->NM_ajax_info['fldList']['holdertype']['valList'][$i] = cad_costumers_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_observation($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   { 
    ...
    if ("incluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['cad_costumers']['contr_erro'] = 'on';
 $this->locate  = 'out';
$_SESSION['scriptcase']['cad_costumers']['contr_erro'] = 'off'; 
    }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['facephoto_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('docnumber', 'name', 'frequencytype', 'rg', 'nationality', 'holdertype', 'phonenumber', 'email', 'mobilephone', 'zipcode', 'zipcity', 'zipstate', 'zipdistrict', 'zipstreet', 'zipnumber', 'aggregate', 'observation'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['parms'] = "idcostumer?#?$this->idcostumer?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_cad_costumers = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'] = $qt_geral_reg_cad_costumers;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idcostumer))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_cad_costumers = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] > $qt_geral_reg_cad_costumers)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] = $qt_geral_reg_cad_costumers; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_cad_costumers) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] < $qt_geral_reg_cad_costumers;
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_facephoto))
       {
        ...
        $this->initFormPages();
    include_once("cad_costumers_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_cad_costumers = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['total'] = $qt_geral_reg_cad_costumers;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          cad_costumers_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "cad_costumers_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['nm_run_menu'] = 2;
       $nmgp_saida_form = "cad_costumers_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['cad_costumers']['ordem_ord'] == " desc") {
