<?php  
  ...
  session_start() ;
  class sec_form_sec_groups_form_teste
  {
   function sec_form_sec_groups_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "sec_form_sec_groups/img";
...
?> 
<br> 
<B><FONT SIZE="4">sec_form_sec_groups</FONT></B> 
<br> 
<br> 
...
group_id&nbsp;&nbsp;<input type=text name=group_id size=20><br> 
<input type="submit" value="sec_form_sec_groups"> 
</form> 
<script language=javascript> 
 document.Fedit.group_id.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new sec_form_sec_groups_form_teste();
  $frm_teste->sec_form_sec_groups_teste();
?>
